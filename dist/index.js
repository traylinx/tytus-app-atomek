...
import { jsx as a, jsxs as d, Fragment as Re } from "react/jsx-runtime";
import { forwardRef as Sa, createElement as Cn, useState as z, useRef as it, useCallback as N, useEffect as re, lazy as ss, useMemo as de, Suspense as is } from "react";
/**
...
}, Ha = (...e) => e.filter((t, n, r) => !!t && t.trim() !== "" && r.indexOf(t) === n).join(" ").trim(), cs = (e) => {
  for (const t in e)
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const ms = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], ps = ie("check", ms);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const bs = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], sn = ie("chevron-down", bs);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Zs = /* @__PURE__ */ new Set([".git", "node_modules", "dist", "build", ".next", ".turbo", "coverage", ".cache"]);
function Ks() {
  const e = Yn();
  return !!(e?.showOpenFilePicker && e.showDirectoryPicker);
}
async function Us() {
  const e = Yn()?.showOpenFilePicker;
  if (!e) return qa(!1);
  const t = await e({ multiple: !0 }), n = await Promise.all(t.map((r) => Jn(r, r.name, "local-file")));
  return Wt(n.filter(Boolean));
}
async function Bs() {
  const e = Yn()?.showDirectoryPicker;
  if (!e)
    return { name: "Browser fallback folder", files: await qa(!0) };
  const t = await e({ mode: "readwrite" }), n = [];
  return await Zn(t, t.name, n, 0, 320), { name: t.name, handle: t, files: Wt(n) };
}
async function Gs(e) {
  const t = await Promise.all(e.map((n) => Jn(n, n.name, "local-file")));
  return Wt(t.filter(Boolean));
}
async function fa(e) {
  const t = [];
  return await Zn(e, e.name, t, 0, 320), { name: e.name, handle: e, files: Wt(t) };
}
async function kn(e, t = "readwrite") {
  try {
...
async function Zn(e, t, n, r, s) {
  if (!(n.length >= s || r > 8))
    for await (const i of e.values()) {
      if (n.length >= s) break;
      if (i.kind === "directory") {
        if (Zs.has(i.name)) continue;
        await Zn(i, `${t}/${i.name}`, n, r + 1, s);
        continue;
      }
      const o = i, c = await Jn(o, `${t}/${o.name}`, "local-folder");
      c && n.push(c);
    }
}
function qa(e) {
...
`).map(
    ...
    const i = r.split("|").filter(Boolean).map((c) => `<th style="padding:8px 12px;background:var(--bg-titlebar);font-weight:600;font-size:13px;border:1px solid var(--border-default)">${c.trim()}</th>`).join(""), o = s.trim().split(`
...
const Ue = {
  ...
  available: !0
}, $s = "atomek:selected-chat-target", ln = {
  openclaw: "OpenClaw",
  hermes: "Hermes"
}, Bt = /https?:\/\/(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})(?::\d+)?\S*/gi, Gt = /\b(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})\b/g, Qt = /\b(?:MiniMax(?:-M[\w.-]+)?|Moonshot|Kimi|DeepSeek|Qwen|Alibaba|Xiaomi|Nous|OpenRouter|Strato|Scalesys|ail-compound|switchAILocal|OpenAI-compatible|vLLM|llama\.cpp)\b/gi, $t = /\b(?:route[_-]?id|pod[_-]?id|droplet[_-]?id|provider[_-]?id|publicUrl|gatewayUrl|privateUrl)\b\s*[:=]\s*[^\s,;]+/gi, _t = /\b(?:pod-agent|ail-route|strato-eu|wannolot|scalesys)[._:-][a-z0-9._:-]{4,}\b/gi, en = /https?:\/\/[^\s)]*(?:tytus\.traylinx\.com|strato|scalesys|wannolot|droplet|gateway|route|\.internal|\.local|digitalocean|do\.com|hetzner)[^\s)]*/gi, tn = /\b(?:fe80|fc00|fd[0-9a-f]{2}):[0-9a-f:]+(?:%[a-z0-9]+)?\b/gi;
function Kn(e) {
  return e.replace(Bt, "private gateway").replace(en, "private gateway").replace(tn, "private gateway").replace(Gt, "private gateway").replace($t, "agent runtime").replace(_t, "your Tytus pod").replace(Qt, "agent runtime").replace(/\s{3,}/g, "  ");
}
function ha(e) {
  const t = e.toLowerCase();
  return /\b(503|502|504|warm|warming|boot|starting|not ready|temporarily unavailable)\b/.test(t) ? { message: "Agent is warming up. Try again in a moment.", retryable: !0 } : /\b(timeout|timed out|aborted)\b/.test(t) ? { message: "Connection timed out. The agent may still be working. Try again.", retryable: !0 } : /\b(offline|stopped|unreachable|not found|404)\b/.test(t) ? { message: "Agent is offline. Restart the pod or pick another agent.", retryable: !0 } : { message: Kn(e).trim() || "Agent chat failed. Try again or pick another agent.", retryable: !1 };
}
function Za(e) {
  return `${$s}:${e}`;
}
function _s(e) {
  try {
    return localStorage.getItem(Za(e))?.trim() || Ue.id;
  } catch {
    return Ue.id;
  }
}
function ma(e, t) {
  try {
    localStorage.setItem(Za(e), t || Ue.id);
  } catch {
  }
}
function gt(e, ...t) {
...
function ni(e) {
  return e.kind !== "pod-agent" ? null : Ka([
    e.label,
    e.id,
...
function ri(e) {
  const t = e.trim();
  return t.length < 2 || t.length > 44 ? !1 : Bt.test(t) || en.test(t) || tn.test(t) || Gt.test(t) || $t.test(t) || _t.test(t) || Qt.test(t) ? (Bt.lastIndex = 0, en.lastIndex = 0, tn.lastIndex = 0, Gt.lastIndex = 0, $t.lastIndex = 0, _t.lastIndex = 0, Qt.lastIndex = 0, !1) : (Bt.lastIndex = 0, en.lastIndex = 0, tn.lastIndex = 0, Gt.lastIndex = 0, $t.lastIndex = 0, _t.lastIndex = 0, Qt.lastIndex = 0, /^[\p{L}\p{N}][\p{L}\p{N} ._()'&+-]*$/u.test(t));
}
function si(e, t) {
  const n = gt(e.metadata, "displayName", "display_name", "customName", "custom_name", "podDisplayName", "pod_display_name", "name");
  if (n) {
    const r = Kn(n).replace(/\bNemoClaw\b/gi, "OpenClaw").replace(/\s+/g, " ").trim();
    if (ri(r)) return r;
  }
  return ln[t];
}
...
function oi(e) {
  ...
  return e.map((i) => {
    ...
    const o = i.label, c = ln[i.agentFamily];
    s[i.agentFamily] += 1;
    const h = o.toLowerCase();
    r[h] = (r[h] ?? 0) + 1;
    const p = t.filter((w) => w.label.toLowerCase() === h).length > 1, v = o === c && n[i.agentFamily] > 1;
    if (!p && !v) return i;
    const y = v ? s[i.agentFamily] : r[h];
    return { ...i, label: `${o} ${y}` };
  });
}
function li(e) {
  const t = e.daemon?.state, n = t?.included ?? [], r = t?.agents ?? [], s = new Map(r.map((o) => [o.id, o])), i = n.flatMap((o) => {
    const c = o.id ?? "", p = { ...(o.agentId ? s.get(o.agentId) : void 0)?.meta ?? {}, ...o.meta ?? {} }, v = Ka([c, o.kind, gt(p, "displayName", "display_name", "agentFamily", "agentType", "brand")].join(" "));
    return !c || !v ? [] : [{
      id: `pod-agent.${c}`,
      kind: "pod-agent",
      label: ln[v],
  ...
  return Ua({ generatedAt: (/* @__PURE__ */ new Date()).toISOString(), resources: i });
}
async function ci(e, t) {
  ...
  const r = Ua(n), s = r.length > 0 ? [] : li(e), i = /* @__PURE__ */ new Map();
  for (const o of [Ue, ...r, ...s]) i.set(o.id, o);
  return [...i.values()];
}
const et = "atomek:default", di = 3e3, Un = "tytus.atomek.threadTitleOverrides", Ba = "tytus.atomek.selectedThreadId", pa = {
  available: !1,
  source: "none",
...
}, ui = (e, t = di) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, ba = (e, t) => {
  const n = e.split(`
`).map((r) => r.replace(/^#+\s*/, "").trim()).find(Boolean);
  return n ? n.length > 80 ? `${n.slice(0, 77)}...` : n : t;
}, fi = (e) => ["briefing", "action-list", "quiz", "plan", "storyboard", "report", "local-draft", "markdown", "memory"].includes(e) ? e : "report", va = (e) => ({
  id: e.id,
  title: e.title,
  kind: fi(e.kind),
  body: e.body,
...
`)
  ...
  try {
    const n = Bn();
    n[e] = t, localStorage.setItem(Un, JSON.stringify(n));
  } catch {
  }
}, pi = (e) => {
  try {
    const t = Bn();
    delete t[e], localStorage.setItem(Un, JSON.stringify(t));
  } catch {
  }
}, ya = (e) => {
  const t = Bn();
  ...
  try {
    return localStorage.getItem(Ba)?.trim() || null;
  } catch {
    return null;
  }
}, at = (e) => {
...
}, Ht = (e) => `${et}:agent-session:${e}`, wt = (e) => `${et}:agent-transcript:${e}`, Ga = 100, vi = (e, t) => {
  try {
    const n = localStorage.getItem(Ht(e))?.trim();
    return n || t && t !== e && localStorage.getItem(Ht(t))?.trim() || null;
  } catch {
    return null;
  }
}, yi = (e, t) => {
  try {
    localStorage.setItem(Ht(e), t);
  } catch {
  }
}, Et = (e, t) => {
  try {
    const n = localStorage.getItem(wt(e)), r = n ? JSON.parse(n) : [], s = /* @__PURE__ */ new Map();
    for (const i of [...r, ...t]) s.set(i.id, i);
    localStorage.setItem(wt(e), JSON.stringify([...s.values()].slice(-Ga)));
  } catch {
  }
}, ga = (e) => {
  if (!e) return [];
  ...
  try {
    const n = ga(localStorage.getItem(wt(e)));
    return n.length > 0 || !t || t === e ? n : ga(localStorage.getItem(wt(t)));
  } catch {
    return [];
  }
}, wi = (e, t) => {
  try {
    localStorage.removeItem(wt(e)), localStorage.removeItem(Ht(e)), t && t !== e && (localStorage.removeItem(wt(t)), localStorage.removeItem(Ht(t)));
  } catch {
  }
}, ki = (e) => {
  const t = e.daemon;
...
function Ni({ host: e, requestContext: t, chatSettings: n, selectedTarget: r = Ue, setStatus: s }) {
  const i = e.ai, [o, c] = z(null), [h, p] = z([]), [v, y] = z([]), [w, m] = z([]), [A, R] = z([]), [Z, F] = z(pa), [ge, we] = z(!1), j = it(!0), _ = it(null), q = N(async () => {
    if (!i) {
      F(pa);
      return;
    }
    ...
    if (i)
      try {
        const x = ya(await i.listThreads({ workspaceKey: et, status: "active" })), L = bi(), V = x.find((ee) => ee.id === L) ?? x[0] ?? await i.createThread({ workspaceKey: et, title: "Atomek chat" });
        if (!j.current) return;
  ...
  const ve = r.kind === "pod-agent" ? r.podId : null;
  re(() => {
    if (r.kind === "pod-agent") {
      y(gi(r.id, r.podId)), R([]);
      return;
  ...
  const ue = N(async () => {
    if (!i) return null;
    if (o) return o;
    const x = await i.createThread({ workspaceKey: et, title: "Atomek chat" });
    return j.current && (c(x), at(x.id), p((L) => [x, ...L.filter((V) => V.id !== x.id)])), x;
  }, [i, o]), He = N(async () => {
    if (r.kind === "pod-agent") {
      wi(r.id, r.podId), y([]), R([]), s(`Cleared ${r.label} chat`);
      return;
    }
    if (!i) return;
    const x = await i.createThread({ workspaceKey: et, title: "Atomek chat" });
    c(x), at(x.id), p((L) => [x, ...L.filter((V) => V.id !== x.id)]), y([]), m([]), R([]), s("New AI chat created");
  }, [i, r, s]), We = N(async (x, L) => {
    if (!i) return;
    const V = L.trim();
    if (V)
      try {
        const X = i.updateThread, ee = h.find((le) => le.id === x) ?? o, ae = typeof X == "function" ? await X({ threadId: x, title: V }) : { ...ee ?? await ue(), id: x, title: V, updatedAt: Date.now() };
        typeof X != "function" && mi(x, V), p((le) => le.map((xe) => xe.id === ae.id ? ae : xe)), c((le) => le?.id === ae.id ? ae : le), s(typeof X == "function" ? `Renamed chat: ${ae.title}` : `Renamed chat locally: ${ae.title}`);
      } catch (X) {
        s(`Rename chat failed: ${X instanceof Error ? X.message : String(X)}`);
      }
  }, [i, ue, s, o, h]), je = N(async (x) => {
    if (i)
      try {
        await i.deleteThread(x), pi(x);
        const L = h.filter((V) => V.id !== x);
        if (p(L), o?.id === x) {
          const V = L[0] ?? await i.createThread({ workspaceKey: et, title: "Atomek chat" });
          c(V), at(V.id), p((ee) => ee.some((ae) => ae.id === V.id) ? ee : [V, ...ee]);
          const X = await i.listMessages(V.id);
          y(X.map(ft).filter(Boolean)), await M(V.id);
        }
        s("Deleted AI chat");
    ...
    try {
      ...
      const V = await i.createArtifact({
        ...
        title: x.title?.trim() || ba(x.body, "Atomek artifact"),
        kind: x.kind ?? "markdown",
        body: x.body
      }), X = va(V);
      return m((ee) => [X, ...ee.filter((ae) => ae.id !== X.id)]), s(`Saved AI artifact: ${X.title}`), X;
    } catch (L) {
    ...
    try {
      const L = await i.writeMemory({
        title: x.title?.trim() || ba(x.body, "Atomek memory"),
        body: x.body,
        metadata: {
          source: "atomek",
          messageId: x.messageId ?? null
    ...
    try {
      ...
      if (X.kind === "pod-agent") {
        const K = ki(e), G = Date.now(), he = {
          id: `agent-user-${G}`,
          role: "user",
          body: V,
          status: "complete",
          createdAt: G
        }, te = `agent-assistant-${G}`, Ne = {
          id: te,
          role: "assistant",
          body: "",
          status: "streaming",
        ...
        if (y((ne) => [...ne, he, Ne]), Et(X.id, [he, Ne]), !X.available) {
          const ne = ha(X.description), me = { ...Ne, body: ne.message, status: "error", error: ne.message };
          return y((u) => u.map((k) => k.id === te ? me : k)), Et(X.id, [me]), s(ne.message), me;
        }
        if (!K) {
          const ne = "Agent chat bridge unavailable in this Tytus host build. Update TytusOS host API/runtime to enable OpenClaw and Hermes chat.", me = { ...Ne, body: ne, status: "error", error: ne };
          return y((u) => u.map((k) => k.id === te ? me : k)), Et(X.id, [me]), s("Agent chat bridge unavailable"), me;
        }
        let Ie = "";
        const De = (ne, me) => (y((u) => u.map((k) => k.id === te ? ne : k)), Et(X.id, [he, ne]), s(me), ne);
        try {
          for await (const ne of K.chatAgent({
            podId: X.podId,
            routeId: X.routeId ?? null,
            sessionId: vi(X.id, X.podId),
            message: xi(V, le),
            mode: "operator",
            target: "agent",
            ...
            if (ne.type === "session" && yi(X.id, ne.sessionId), ne.type === "token" && (Ie = Kn(`${Ie}${ne.text}`), y((me) => me.map((u) => u.id === te ? { ...u, body: Ie, status: "streaming" } : u))), ne.type === "error") {
              const me = ha(ne.message), u = { ...Ne, body: me.message, status: "error", error: me.message };
              return De(u, me.message);
            }
            if (ne.type === "done")
              return ee = { ...Ne, body: Ie || "Agent finished without visible output.", status: "complete" }, De(ee, `${X.label} answered`);
          }
        } catch (ne) {
          if (ae.signal.aborted || ne instanceof DOMException && ne.name === "AbortError")
            return ee = { ...Ne, body: Ie || "Stopped by user.", status: "complete" }, De(ee, `${X.label} response stopped`);
          throw ne;
        }
        return ae.signal.aborted ? (ee = { ...Ne, body: Ie || "Stopped by user.", status: "complete" }, De(ee, `${X.label} response stopped`)) : ee || (ee = { ...Ne, body: Ie || "Agent finished without visible output.", status: "complete" }, De(ee, `${X.label} answered`));
      }
      const xe = await ue();
      if (!xe || !i) return null;
      at(xe.id);
      const Ve = await fe(V).catch(() => []), ze = hi(Ve), Ee = ze ? [...le, ze] : [...le];
      let Je = null;
      for await (const K of i.sendMessage({
        ...
        if (K.type === "message_created") {
          ...
          if (!G) continue;
          G.role === "assistant" && (Je = G.id), y((he) => [...he.filter((te) => te.id !== G.id), G]);
        }
        if (K.type === "token" && (Je = K.messageId, y((G) => G.some((he) => he.id === K.messageId) ? G.map(
          (he) => he.id === K.messageId ? { ...he, body: K.body, status: "streaming", sourceLabel: "Atomek" } : he
        ) : [...G, {
          id: K.messageId,
          role: "assistant",
          body: K.body,
          ...
          const G = ft(K.message);
          if (!G) continue;
          G.role === "assistant" && (ee = G), y((he) => he.map((te) => te.id === G.id ? G : te)), G.gatewayLabel && s(`AI answered via ${G.gatewayLabel}`);
        }
        if (K.type === "run_failed") {
          const G = ae.signal.aborted;
          s(G ? "AI response stopped" : `AI failed: ${K.error}`), Je && y((he) => he.map((te) => te.id !== Je ? te : G ? { ...te, status: "complete", error: void 0, body: te.body || "Stopped by user." } : { ...te, status: "error", error: K.error, body: K.error }));
        }
      }
      const ye = ya(await i.listThreads({ workspaceKey: et, status: "active" }).catch(() => []));
      return j.current && ye.length > 0 && p(ye), q(), ee;
    } catch (le) {
      return le instanceof DOMException && le.name === "AbortError" ? (s("AI response stopped"), ee) : (s(`AI failed: ${le instanceof Error ? le.message : String(le)}`), null);
    } finally {
      _.current === ae && (_.current = null), we(!1);
    }
  }, [i, n.gatewayPreference, n.model, ue, e, fe, q, t, r, s]), W = N(() => {
...
const Ti = (e) => `tytus-workbench:///${encodeURI(e.path)}`, zi = (e) => {
  let t = 2166136261;
  for (let n = 0; n < e.length; n += 1)
    t ^= e.charCodeAt(n), t = Math.imul(t, 16777619);
  return (t >>> 0).toString(16).padStart(8, "0");
}, Xi = ({ files: e, openEditorIds: t, activeFileId: n, versions: r, activeSelection: s }) => {
...
}, Li = "active-file", Ai = (e) => e === "none" ? "No context" : e === "active-selection" ? "Active selection" : e === "active-file" ? "Active file" : e === "open-editors" ? "Open editors" : e === "selected-files" ? "Selected files" : "Indexed project", Oi = (e, t = "file") => `${t}:${e.id}`, Ci = (e, t) => [
  "selection",
  e.id,
  t.startLineNumber,
  t.startColumn,
  ...
  let s = [];
  return t.scope === "active-selection" ? r?.selection ? s = [Si(r, r.selection, !0)] : r && (s = [qt(r, !0, "Active file")]) : t.scope === "active-file" ? r && (s = [qt(r, !0, "Active file")]) : t.scope === "open-editors" ? s = e.openDocumentIds.map((i) => e.byId.get(i)).filter(Boolean).map((i) => qt(i, !0, "Open editor")) : t.scope === "selected-files" && (s = t.selectedFileIds.map((i) => e.byId.get(i)).filter(Boolean).map((i) => qt(i, !1, "Selected file"))), ji(s).filter((i) => !n.has(i.id));
}, ji = (e) => {
  const t = /* @__PURE__ */ new Set();
  return e.filter((n) => t.has(n.id) ? !1 : (t.add(n.id), !0));
}, Mi = 4e3, Wi = 8e3, Vi = 4e3, Ii = (e, t) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, Di = (e, t, n) => {
  const r = Hi(e, n), s = [], i = new Map(t.map((o) => [o.id, o]));
  for (const o of r) {
    ...
    const p = [
      ...
      o.range ? `Range: ${wa(o.range)}` : null
    ].filter(Boolean).join(`
`), v = o.kind === "selection" && o.range ? Fi(c.content, o.range) : c.content, y = o.kind === "selection" ? Mi : o.label.startsWith("Open editor") ? Vi : Wi;
    s.push({
...
`));
}, wa = (e) => `${e.startLineNumber}:${e.startColumn}-${e.endLineNumber}:${e.endColumn}`, ka = 75e4, Ri = 2800, Ei = 240, qi = 80, Yi = /* @__PURE__ */ new Set([
  ".git",
  ".hg",
  ".svn",
  ".next",
  ...
  return n === 0 || e.content.length === 0 ? "empty" : n > (t.maxFileBytes ?? ka) || e.content.length > (t.maxFileBytes ?? ka) ? "huge" : !t.includeDirty && e.dirty ? null : Qi(e.path) ? "vendor" : $i(e) ? "binary" : null;
}, Pa = (e, t = {}) => {
  const n = Date.now(), r = [], s = [], i = [];
  for (const o of e) {
    const c = o.size ?? o.content.length, h = Hn(o, t);
    if (h) {
      s.push({ fileId: o.id, name: o.name, path: o.path, language: o.language, reason: h, size: c });
      continue;
    }
    const p = st(o.content), v = Zi(o, p, n, t);
    i.push(...v), r.push({
      fileId: o.id,
      name: o.name,
      path: o.path,
...
}, Zi = (e, t = st(e.content), n = Date.now(), r = {}) => {
  const s = Math.max(500, r.maxChunkChars ?? Ri), i = Math.min(Math.max(0, r.chunkOverlapChars ?? Ei), Math.floor(s / 2)), o = Math.max(1, r.maxChunksPerFile ?? qi), c = Bi(e.content), h = [];
  let p = 0, v = 0;
  for (; p < e.content.length && h.length < o; ) {
    const y = Ui(e.content, p, Math.min(e.content.length, p + s)), w = e.content.slice(p, y).trim();
    if (w.length > 0) {
      const m = Gi(c, p, y);
      h.push({
...
` && t.push(n + 1);
  ...
  const r = xa(e, t), s = xa(e, Math.max(t, n - 1));
  return {
    startLineNumber: r + 1,
    startColumn: t - e[r] + 1,
    endLineNumber: s + 1,
  ...
  return 0;
}, Qi = (e) => e.split(/[\\/]+/).filter(Boolean).some((t) => Yi.has(t)), $i = (e) => {
  const t = e.name.includes(".") ? e.name.split(".").pop()?.toLowerCase() : void 0;
  if (t && Ji.has(t) || e.content.includes("\0")) return !0;
...
class _i {
  ...
  options;
  constructor(t = [], n = {}) {
    this.options = { ...n }, this.snapshot = Pa(t, this.options);
  }
  getSnapshot() {
  ...
  refresh(t, n = this.options) {
    return this.options = { ...n }, this.snapshot = Pa(t, this.options), this.snapshot;
  }
...
const ht = (e = [], t = {}) => new _i(e, t), eo = (e, t, n = {}) => {
  const r = new Map(t.map((c) => [c.id, c])), s = e.byFileId, i = [];
  for (const c of e.files) {
    const h = r.get(c.fileId);
    if (!h) {
  ...
  for (const c of t)
    !s.has(c.id) && !Hn(c, n) && i.push({ fileId: c.id, path: c.path, status: "new", currentHash: st(c.content) });
  const o = e.signature !== Qa(t);
  return { stale: i.length > 0, signatureChanged: o, files: i };
}, to = 8, no = 12e3, $a = (e, t, n = {}, r) => {
  const s = so(t);
  if (s.length === 0) return [];
  const i = new Set(r?.files.map((v) => v.fileId) ?? []), o = e.chunks.filter((v) => n.includeDirty !== !1 || !v.dirty).map((v) => io(v, s)).filter((v) => v.score >= (n.minScore ?? 1)).sort((v, y) => y.score - v.score || v.chunk.path.localeCompare(y.chunk.path) || v.chunk.ordinal - y.chunk.ordinal), c = [], h = /* @__PURE__ */ new Set();
  let p = n.maxChars ?? no;
  for (const v of o) {
    if (c.length >= (n.limit ?? to) || p <= 0) break;
    const y = `${v.chunk.fileId}:${v.chunk.ordinal}`;
    if (h.has(y)) continue;
    h.add(y);
    const w = v.chunk.text.length > p ? `${v.chunk.text.slice(0, Math.max(0, p - 28))}
[...context clipped...]` : v.chunk.text;
    c.push(ao(v, w, i.has(v.chunk.fileId))), p -= w.length;
  }
  return c;
}, ao = (e, t = e.chunk.text, n = !1) => {
...
`), so = (e) => Array.from(new Set(
  ...
  const c = [];
  for (const h of t) {
    const p = xn(n, h), v = xn(r, h), y = xn(s, h), w = i === h ? 1 : 0;
    p + v + y + w !== 0 && (c.push(h), o += Math.min(p, 12), o += v * 4, o += y * 6, o += w * 3, (n.includes(`function ${h}`) || n.includes(`const ${h}`) || n.includes(`class ${h}`) || n.includes(`type ${h}`)) && (o += 3));
  }
  ...
  const n = e.toLowerCase(), r = t.map((h) => n.indexOf(h)).filter((h) => h >= 0).sort((h, p) => h - p)[0] ?? 0, s = Math.max(0, r - 120), i = Math.min(e.length, r + 260), o = s > 0 ? "…" : "", c = i < e.length ? "…" : "";
  return `${o}${e.slice(s, i).replace(/\s+/g, " ").trim()}${c}`;
}, lo = (e, t = {}) => {
  const { autoRefresh: n = !1, ...r } = t, s = it(e), i = it(null);
  i.current || (i.current = ht(e, r));
  const [o, c] = z(() => i.current?.getSnapshot() ?? ht(e, r).getSnapshot());
  s.current = e;
  const h = N((w = s.current) => {
    const m = (i.current ?? ht([], r)).refresh(w, r);
    return c(m), m;
  }, [r.maxFileBytes, r.maxChunkChars, r.chunkOverlapChars, r.maxChunksPerFile, r.includeDirty]), p = N((w = s.current) => {
    const m = (i.current ?? ht([], r)).update(w, r);
    return c(m), m;
  }, [h]);
  re(() => {
    n && h(e);
  }, [n, e, h]);
  const v = (i.current ?? ht([], r)).staleReport(e), y = N((w, m = {}) => {
    const A = i.current ?? ht([], r);
    return $a(A.getSnapshot(), w, m, A.staleReport(s.current));
  }, []);
  return { snapshot: o, staleReport: v, isStale: v.stale, refresh: h, update: p, retrieve: y };
}, co = "tytus.atomek.semanticVector:v1", _a = "__gateway_default__", er = (e) => e?.trim() || _a, uo = (e) => {
  const t = er(e);
  return t === _a ? "gateway default" : t;
}, tr = (e, t, n) => [
  co,
  ...
  if (!nr()) return null;
  try {
    const r = tr(e, t, n), s = window.localStorage.getItem(r);
    if (!s) return null;
  ...
  if (!nr()) return null;
  try {
    const t = tr(e.appId, e.modelAlias, { id: e.chunkId, hash: e.contentHash }), n = { ...e, key: t };
    return window.localStorage.setItem(t, JSON.stringify(n)), n;
  } catch {
    return null;
  }
}, Ot = 8, mo = 12e3, po = 180, bo = async (e, t, n, r, s = {}, i, o) => {
  const c = $a(t, n, { ...s, limit: Math.max(s.limit ?? Ot, 16) }, i), h = e.ai;
  if (typeof h?.embedText != "function")
    return { hits: c.slice(0, s.limit ?? Ot), mode: "keyword", reason: "Semantic index unavailable — using keyword retrieval.", embeddedChunks: 0 };
  try {
    const p = er(r.embeddingModel), v = await h.embedText({
      input: n,
    ...
    const w = new Map(c.map((j) => [j.chunkId, j])), m = xo(n), A = /* @__PURE__ */ new Map();
    t.chunks.filter((j) => s.includeDirty !== !1 || !j.dirty).slice(0, po).forEach((j) => A.set(j.id, j)), c.forEach((j) => {
    ...
    for (const j of R) {
      o?.aborted;
      const _ = fo(e.appId, p, j) ?? await yo(h, e.appId, p, j, r, o);
      if (!_) continue;
      _.updatedAt > Date.now() - 1e3 && (F += 1);
      const q = ko(y, _.vector);
      if (!Number.isFinite(q)) continue;
      const be = w.get(j.id)?.score ?? No(j, m), Y = Po(be) * 0.42 + Math.max(0, q) * 0.58;
      Z.push({ chunk: j, keywordScore: be, vectorScore: q, score: Y, matchedTerms: m.filter((ve) => j.text.toLowerCase().includes(ve)) });
    }
    if (Z.length === 0) return { hits: c.slice(0, s.limit ?? Ot), mode: "vector-fallback", reason: "Semantic retrieval produced no vectors — using keyword retrieval.", embeddedChunks: F };
    const ge = new Set(i?.files.map((j) => j.fileId) ?? []), we = Z.sort((j, _) => _.score - j.score || _.keywordScore - j.keywordScore || j.chunk.path.localeCompare(_.chunk.path) || j.chunk.ordinal - _.chunk.ordinal).slice(0, Math.max(s.limit ?? Ot, 1)).map((j) => go(j, ge.has(j.chunk.fileId)));
    return {
      hits: wo(we, s.maxChars ?? mo),
      mode: "hybrid",
      reason: `Hybrid retrieval used ${uo(r.embeddingModel)} embeddings + keyword ranking.`,
      embeddedChunks: F
    };
  } catch (p) {
    return {
      hits: c.slice(0, s.limit ?? Ot),
  ...
  return {
    ...
    text: e.chunk.text,
    snippet: To(e.chunk.text, e.matchedTerms),
    score: e.score,
...
}, Po = (e) => Math.min(1, Math.max(0, e / 24)), xo = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), No = (e, t) => {
  const n = `${e.path}
${e.name}
...
${e.text}`.toLowerCase();
  ...
  const n = e.toLowerCase(), r = t.map((o) => n.indexOf(o)).filter((o) => o >= 0).sort((o, c) => o - c)[0] ?? 0, s = Math.max(0, r - 120), i = Math.min(e.length, r + 260);
  return `${s > 0 ? "…" : ""}${e.slice(s, i).replace(/\s+/g, " ").trim()}${i < e.length ? "…" : ""}`;
}, zo = /```([^\n`]*)\n([\s\S]*?)```/g, Xo = /^@@\s+-(\d+)(?:,\d+)?\s+\+(\d+)(?:,\d+)?\s+@@/;
function Gn(e) {
  return Array.from(e.matchAll(zo)).map((t) => rr(t[1] ?? "", So(t[2] ?? ""))).filter((t) => t.content.trim().length > 0);
}
function rr(e, t) {
  const n = e.trim().split(/[\s,]+/).filter(Boolean), r = {}, s = [];
  for (const i of n) {
    const o = i.match(/^([a-z0-9_-]+)=(.+)$/i);
    o ? r[o[1].toLowerCase()] = jo(o[2]) : s.push(i.toLowerCase());
  }
  return { lang: e.trim().toLowerCase(), flags: s, attrs: r, content: t };
}
function Me(e, t) {
  return (typeof e == "string" ? rr(e, "").flags : e.flags).includes(t.toLowerCase());
}
function sr(e) {
  return [...Gn(e).filter((r) => Me(r, "diff") || Me(r, "patch")).map((r) => r.content), e].filter((r, s, i) => Lo(r) && i.findIndex((o) => o === r) === s);
}
function Lo(e) {
...
`), r = [];
  ...
  }), r.length === 0) return [{ raw: t, ...Nn(t) }];
  const s = Array.from(new Set(r)).sort((o, c) => o - c), i = [];
  for (let o = 0; o < s.length; o += 1) {
    const c = s[o], p = s.find((y) => y > c && n[y].startsWith("diff --git ")) ?? n.length, v = n.slice(c, p).join(`
`);
    /^@@\s+-\d+/m.test(v) && i.push({ raw: v, ...Nn(v) });
  }
  return i.length > 0 ? i : [{ raw: t, ...Nn(t) }];
}
function Nn(e) {
  const t = e.match(/^diff --git\s+(?:"?a\/(.+?)"?|(\S+))\s+(?:"?b\/(.+?)"?|(\S+))/m), n = e.match(/^---\s+(?:"?a\/(.+?)"?|(\S+))/m), r = e.match(/^\+\+\+\s+(?:"?b\/(.+?)"?|(\S+))/m), s = Be(t?.[1] || t?.[2] || n?.[1] || n?.[2] || "") || null, i = Be(t?.[3] || t?.[4] || r?.[1] || r?.[2] || "") || null, o = i && i !== "/dev/null" ? i : s;
...
function jn(e) {
  return Gn(e).filter((t) => Oo(t)).map((t) => ({
    content: Ho(t.content),
...
`), s = [];
  ...
  for (let c = 0; c < r.length; c += 1) {
    const h = r[c].match(Xo);
    if (!h) continue;
    o = !0;
    const p = Number(h[1]), v = Math.max(0, p - 1);
    if (v < i) return null;
    for (s.push(...n.slice(i, v)), i = v, c += 1; c < r.length; c += 1) {
      const y = r[c];
      if (y.startsWith("@@ ")) {
        c -= 1;
        break;
...
function Mo(e) {
  const { body: t, files: n, sourceTitle: r, activeFile: s = null, versions: i = {} } = e, o = /* @__PURE__ */ new Map(), c = [];
  for (const v of sr(t))
    for (const y of Ao(v)) {
      if (!y.path) {
        if (s) {
          const A = Mn(s.content, y.raw);
          A && A !== s.content && o.set(s.id, Yt({
            file: s,
            proposedContent: A,
            sourceTitle: r,
      ...
      const m = Mn(w.file.content, y.raw);
      if (!m || m === w.file.content) {
  ...
  for (const v of jn(t)) {
    const y = v.path ? Na(n, v.path) : s ? { file: s, normalizedPatchPath: Be(s.path), confidence: "exact" } : null;
    if (!y) {
  ...
  const h = jn(t).some((v) => v.path);
  if (o.size === 0 && s && !h) {
    const v = Wo(t, s);
    v && v.content !== s.content && o.set(s.id, Yt({
      file: s,
      proposedContent: v.content,
      sourceTitle: r,
      extractionLabel: v.label,
...
function Na(e, t) {
  const n = Be(t), r = n.split("/").at(-1) ?? n, s = e.find((c) => Be(c.path) === n);
  if (s) return { file: s, normalizedPatchPath: n, confidence: "exact" };
  const i = e.find((c) => Be(c.path).endsWith(`/${n}`));
  if (i) return { file: i, normalizedPatchPath: n, confidence: "suffix" };
  const o = e.find((c) => c.name === r || Be(c.path).endsWith(`/${r}`));
...
`), s = Math.max(n.length, r.length);
  let i = 0, o = 0, c = 0;
  for (let h = 0; h < s; h += 1)
    n[h] !== r[h] && (n[h] === void 0 ? i += 1 : r[h] === void 0 ? o += 1 : c += 1);
...
function Yt(e) {
  ...
  return {
    ...
    stats: Vo(e.file.content, e.proposedContent),
    base: {
...
const cn = (e) => typeof e == "object" && e !== null, Ro = (e) => cn(e.ai) ? e.ai : null, Eo = (e) => {
  if (!cn(e)) return null;
  const t = e.id;
  return typeof t == "string" && t.trim() ? t : null;
}, qo = (e) => {
  const t = Eo(e);
  return !t || !cn(e) ? null : { ...e, id: t };
}, qe = (e) => typeof e == "string" ? /\bembeddings?\b|text-embedding/i.test(e) : Array.isArray(e) ? e.some(qe) : cn(e) ? Object.values(e).some(qe) : !1, Yo = async (e, t) => {
  const n = Ro(e);
  if (typeof n?.listModels != "function") return [];
  const r = await n.listModels(t);
  return Array.isArray(r) ? r.map(qo).filter((s) => !!s) : [];
}, Jo = (e) => (e.embedding ?? e.embeddings ?? e.supportsEmbedding ?? e.supportsEmbeddings) === !0 ? !0 : qe(e.capability) || qe(e.capabilities) || qe(e.modality) || qe(e.modalities) || qe(e.task) || qe(e.tasks) || qe(e.type) || qe(e.kind), or = (e) => typeof e == "object" && e !== null, Zo = (e) => or(e.ai) ? e.ai : null, lr = (e) => typeof Zo(e)?.embedText == "function", Ko = async (e, t) => lr(e) ? (await Yo(e, t)).filter(Jo) : [], Uo = (e) => or(e.ai) ? lr(e) ? null : "host.ai.embedText is not exposed by this Tytus build." : "host.ai is not available in this Tytus build.", Bo = ["typecheck", "test", "lint", "build", "release:check", "verify", "verify:cortex"], Go = [
...
function el(e) {
  const t = e.results.length > 0 ? e.results.map((r, s) => [
    ...
    `Status: ${r.status}`,
    "Output:",
    ll(r.output || "(no output pasted)", "text")
  ].join(`
`)).join(`
...
function nl(e) {
  ...
  for (const r of t) {
    const s = al(r.content);
    if (!s?.scripts) continue;
    const i = dr(r.path), o = rl(e, i, s);
    if (!o) continue;
    const c = Object.keys(s.scripts).filter((p) => typeof s.scripts?.[p] == "string"), h = sl(c);
    for (const p of h) {
      const v = `${o} run ${p}`;
      n.push({
        id: ur(`${i}:${v}`),
...
function rl(e, t, n) {
  ...
  for (const [r, s] of Go)
    if (e.some((i) => ol(i.path) === r && dr(i.path) === t)) return s;
  return null;
}
function sl(e) {
  const t = Bo.filter((r) => e.includes(r)), n = e.filter((r) => !t.includes(r)).filter((r) => /(^|:)(check|typecheck|test|lint|verify|build)(:|$)/i.test(r)).sort((r, s) => r.localeCompare(s));
  return [...t, ...n];
}
function il(e) {
  const t = /* @__PURE__ */ new Set();
...
function hl({ className: e }) {
  return /* @__PURE__ */ a("img", { src: fl, alt: "ATOMEK", className: e, draggable: !1 });
}
const ml = `# Tytus Resource Fabric
...
], wl = "tytus-atomek-handles", kt = "handles", kl = 1, hr = () => new Promise((e, t) => {
  const n = indexedDB.open(wl, kl);
  n.onupgradeneeded = () => {
    const r = n.result;
...
async function Ta(e, t) {
  ...
  await new Promise((r, s) => {
    const i = n.transaction(kt, "readwrite");
    i.objectStore(kt).put(t, e), i.oncomplete = () => r(), i.onerror = () => s(i.error ?? new Error("Failed to persist file handle"));
  }), n.close();
}
async function Tn(e) {
  const t = await hr(), n = await new Promise((r, s) => {
    const o = t.transaction(kt, "readonly").objectStore(kt).get(e);
    o.onsuccess = () => r(o.result ?? null), o.onerror = () => s(o.error ?? new Error("Failed to read file handle"));
  });
  return t.close(), n;
}
const Pl = ss(() => import("./WorkbenchMonacoEditor-CJhaNTZX.js").then((e) => e.W).then((e) => ({ default: e.WorkbenchMonacoEditor }))), xl = {
  id: "welcome",
  name: "Agent Team",
  path: "Agent Team",
  language: "text",
  ...
  dirty: !1,
  source: "sample"
}, mr = "tytus.workspace.recent", pr = "tytus.workspace.layout", br = "tytus.atomek.session.v2", vr = "tytus.atomek.chatAiSettings", zn = "atomek:default", yr = "tytus.atomek.currentMission", Wn = "tytus.atomek.currentMissionChanged", za = "0.4.27", nn = {
...
function Xn(e) {
  const t = Math.max(e || 1400, 760), n = Math.max(0, t - Nl), r = n < 1180, s = r ? 200 : 240, i = r ? 300 : 340, o = r ? 420 : 560, c = Math.max(s, Math.min(r ? 340 : 420, Math.floor(n * 0.28))), h = Math.min(300, c), p = Math.floor(n * (r ? 0.34 : 0.36)), v = n - h - o, y = Math.max(i, Math.min(r ? 500 : 640, p, v));
...
function Ll(e) {
  const t = e?.resources ?? [], n = (c) => c.status === "ready" || c.status === "available", r = t.filter((c) => c.kind === "pod-agent" && xt(c) === "openclaw"), s = t.filter((c) => c.kind === "pod-agent" && xt(c) === "hermes"), i = t.filter((c) => c.kind === "local-cli" && n(c)), o = t.filter((c) => c.kind === "shared-folder" && n(c));
  return [
...
function Ct(e, t, n, r, s) {
  return {
    ...
    resourceLabel: r ? Oe(r) : s,
    status: r?.status ?? "needs-setup",
    trustTier: r?.trustTier ?? "not-available",
    sandbox: r?.sandbox ?? "none"
  };
}
function Nt(e, t = "repo-repair") {
  const n = jt.find((Y) => Y.id === t) ?? jt[0], r = e?.resources ?? [], s = rt(r, (Y) => Y.kind === "pod-agent" && xt(Y) === "openclaw"), i = rt(r, (Y) => Y.kind === "pod-agent" && xt(Y) === "hermes"), o = rt(r, (Y) => Y.kind === "ail-route"), c = rt(r, (Y) => Y.kind === "shared-folder"), h = Ke(r, "local-cli", ["claude"]), p = Ke(r, "local-cli", ["opencode", "open code"]), v = Ke(r, "local-cli", ["codex"]), y = Ke(r, "local-cli", ["pi"]), w = Ke(r, "local-cli", ["kimi"]), m = rt(r, (Y) => Y.kind === "local-cli"), A = Ke(r, "app-skill", ["juli3ta", "music", "song"]), R = Ke(r, "app-skill", ["blender", "3d"]), Z = Ke(r, "app-skill", ["remotion", "video", "render"]), F = rt(r, (Y) => Y.kind === "app-skill"), ge = t === "pod-local" ? s ?? i ?? o ?? h ?? m : t === "creative-production" ? i ?? o ?? h ?? m : t === "research-watch" ? s ?? o ?? i ?? h ?? m : h ?? p ?? o ?? m, we = t === "creative-production" ? A ?? R ?? Z ?? F ?? p ?? h ?? m : p ?? h ?? v ?? m, j = t === "pod-local" ? v ?? y ?? w ?? s ?? h ?? m : t === "research-watch" ? y ?? w ?? v ?? s ?? m : v ?? y ?? s ?? w ?? m, _ = t === "creative-production" ? A ?? R ?? Z ?? F : t === "research-watch" ? Ke(r, "app-skill", ["browser", "channel", "telegram"]) ?? F : F, q = [
    Ct("planner", "Planner", "Break goal into tasks, risks, and required context.", ge, "No planner agent ready"),
    Ct("implementer", "Implementer", "Execute local/app work and return transcript or patch proposal.", we, "No local/app implementer ready"),
    Ct("reviewer", "Reviewer", "Independent critique before approval or handoff.", j, "No reviewer agent ready"),
    Ct("team-desk", "Team Desk", "Shared mission folder for transcripts, outputs, proposals, and handoff.", c, "Mission folder only until shared folder is bound")
  ];
  (t === "creative-production" || _) && q.push(Ct("app-tool", "App Tool", "Drive installed local app skill through mission context.", _, "No configured app skill"));
...
function ot(e, t, n) {
  if (n && jt.some((s) => s.id === n)) return n;
  const r = e.toLowerCase();
  return /(music|song|audio|video|render|blender|remotion|juli3ta|creative)/.test(r) ? "creative-production" : /(research|watch|monitor|news|summar|scan)/.test(r) ? "research-watch" : (t?.resources ?? []).some((s) => s.kind === "pod-agent" && wr(s)) ? "pod-local" : "repo-repair";
}
function Cl(e) {
  return jt.map((t) => Nt(e, t.id));
}
function Kt(e) {
...
function St(e) {
  ...
  try {
    localStorage.setItem(yr, JSON.stringify(t)), window.dispatchEvent(new CustomEvent(Wn, { detail: t }));
  } catch {
  }
}
function Hl() {
  try {
    ...
    return !t.missionId || !t.title ? null : {
      ...
      teamPresetId: jt.some((n) => n.id === t.teamPresetId) ? t.teamPresetId : void 0
    };
  } catch {
    return null;
  }
...
function Mt(e, t, n) {
  const r = e.trim() || "Coordinate a Tytus mission.", s = Nt(t, ot(r, t, n)), i = (y) => s.assignments.find((w) => w.role === y), o = i("planner"), c = i("implementer"), h = i("reviewer"), p = i("team-desk"), v = i("app-tool");
  return [
    {
      id: "task-scope",
      ...
      resourceHint: o ? Kt(o) : "Planner agent",
      role: "planner",
    ...
    },
    {
      ...
      resourceHint: c ? Kt(c) : "Local/app implementer",
      role: "implementer",
    ...
    } : null,
    {
      ...
      resourceHint: h ? `${Kt(h)} · ${p?.resourceLabel ?? "mission folder"}` : "Reviewer + mission folder",
      role: "reviewer",
...
function an(e, t, n, r, s, i) {
  const o = Nt(t, ot(s || e.goal, t, i ?? e.teamPresetId));
  return [
    `# ${e.title}`,
    "",
    `- Mission ID: \`${e.missionId}\``,
...
function xr(e, t, n, r) {
  const s = ot(n || e.goal, t, r ?? e.teamPresetId), i = Nt(t, s), o = Mt(n || e.goal, t, s);
...
function Ml({ host: e }) {
  const t = it(null), [n, r] = z(0), s = de(() => Pc(), []), i = de(() => vc(), []), o = de(() => bc(pc(), i.recent), [i.recent]), [c, h] = z(i.activity ?? "computer"), [p, v] = z(s.primaryVisible), [y, w] = z(s.primaryWidth), [m, A] = z(i.secondaryTab ?? "chat"), [R, Z] = z(s.secondaryVisible), [F, ge] = z(s.secondaryWidth), [we, j] = z(!!i.bottomPanelVisible), [_, q] = z(i.bottomPanelTab ?? "problems"), [M, be] = z(s.markdownPreviewVisible), [Y, ve] = z(!!i.welcomeClosed), [ue, He] = z(i.folder ? { name: i.folder.name, files: [] } : null), [We, je] = z(i.folder?.handleKey ?? null), [O, oe] = z(() => yc(i.files)), [Pe, fe] = z(() => (i.openEditorIds ?? []).filter((l) => (i.files ?? []).some((f) => f.id === l))), [g, W] = z(() => i.activeFileId && (i.files ?? []).some((l) => l.id === i.activeFileId) ? i.activeFileId : null), [x, L] = z(i.query ?? ""), [V, X] = z({ lineNumber: 1, column: 1 }), [ee, ae] = z(null), [le, xe] = z({}), [Ve, ze] = z(Li), [Ee, Je] = z([]), [ye, K] = z([]), [G, he] = z(null), [te, Ne] = z(i.chatInput ?? ""), [Ie, De] = z(!1), [ne, me] = z(""), [u, k] = z([]), [T, H] = z(null), [C, E] = z(null), [$, U] = z(!1), [ke, Ze] = z(() => xc()), [B, I] = z([Ue]), [se, Le] = z(() => _s(zn)), [Te, Ae] = z(null), [Fe, lt] = z(null), [ct, Tt] = z(""), [Ge, dn] = z(""), [Vt, It] = z(""), [Dt, _n] = z("failed"), [Cr, ea] = z(null), [Sr, S] = z("Ready"), [zt, Hr] = z(() => o), Ce = Pe.map((l) => O.find((f) => f.id === l)).filter(Boolean), D = g ? O.find((l) => l.id === g) ?? null : null, ta = de(() => Xi({ files: O, openEditorIds: Pe, activeFileId: g, versions: le, activeSelection: ee }), [g, ee, le, O, Pe]), na = de(() => ({
    scope: Ve,
    removedAttachmentIds: Ee,
    selectedFileIds: []
  }), [Ve, Ee]), Xt = de(() => Di(ta, O, na), [na, ta, O]), Qe = lo(O, { autoRefresh: !0, includeDirty: !0 }), aa = de(() => ye.map((l) => ({
    id: l.id,
    kind: "index-hit",
    label: l.label,
    path: l.path,
    ...
    snippet: l.snippet
  })), [ye]), jr = de(() => [...Xt.attachments, ...aa], [Xt.attachments, aa]), ra = de(() => B.find((l) => l.id === se) ?? Ue, [B, se]), Q = Ni({ host: e, requestContext: Xt.parts, chatSettings: ke, selectedTarget: ra, setStatus: S }), tt = de(
    () => [...Q.artifacts, ...u].sort((l, f) => f.createdAt - l.createdAt),
    [Q.artifacts, u]
  ), Ft = $ && !D, un = !D && !Ft && !Y, Xe = de(() => O.filter((l) => l.dirty), [O]), Mr = de(() => {
  ...
  re(() => {
    ...
    const f = async () => {
      const P = await ci(e);
      l && (I(P), Le((J) => {
        const ce = P.some((nt) => nt.id === J) ? J : Ue.id;
        return ce !== J && ma(zn, ce), ce;
      }));
    };
    f();
  ...
  const Wr = N((l) => {
    const f = B.find((b) => b.id === l) ?? Ue;
    Le(f.id), ma(zn, f.id), S(`Chat target: ${f.label}`);
  }, [B, S]), Vr = N((l) => {
    if (l.kind === "index-hit") {
      K((f) => f.filter((b) => b.id !== l.id)), S(`Removed project context: ${l.label}`);
      return;
    }
    Je((f) => f.includes(l.id) ? f : [...f, l.id]), S(`Removed chat context: ${l.label}`);
  }, []), Rt = N(() => {
    U(!0), W(null), ve(!0), S("Atomek settings opened");
  }, []), sa = N(() => {
    U(!1), W((l) => l ?? Pe.at(-1) ?? null), Pe.length === 0 && ve(!1), S("Atomek settings closed");
  }, [Pe]), dt = N((l) => {
    xe((f) => ({ ...f, [l]: (f[l] ?? 1) + 1 }));
  }, []), Ir = N((l) => {
    l.preventDefault(), l.currentTarget.setPointerCapture?.(l.pointerId);
    const f = Xn(n), b = l.clientX, P = F, J = (nt) => {
      const wn = P + (b - nt.clientX);
      ge(Zt(wn, f.secondaryMin, f.secondaryMax));
    }, ce = () => {
    ...
    l.preventDefault(), l.currentTarget.setPointerCapture?.(l.pointerId);
    const f = Xn(n), b = l.clientX, P = y, J = (nt) => {
      const wn = P + (nt.clientX - b);
      w(Zt(wn, f.primaryMin, f.primaryMax));
    }, ce = () => {
      window.removeEventListener("pointermove", J), window.removeEventListener("pointerup", ce);
    };
    window.addEventListener("pointermove", J), window.addEventListener("pointerup", ce);
    ...
    Hr((f) => {
      ...
      return localStorage.setItem(mr, JSON.stringify(b)), b;
    });
  }, []), pe = N((l, f) => {
    fe((b) => b.includes(l.id) ? b : [...b, l.id]), W(l.id), ve(!1), ea(f ?? null), X({ lineNumber: f ?? 1, column: 1 });
  }, []), Fr = N((l) => {
    const f = {
      id: `atomek-doc:${l.id}`,
      name: l.fileName,
    ...
    oe((b) => Ut(b, [f])), pe(f), A("chat"), Z(!0), be(!0), S(`Opened Atomek guide: ${l.title}`);
  }, [pe]), Rr = N((l) => {
    if (!l.fileId) return;
    const f = O.find((b) => b.id === l.fileId);
    f && (pe(f, l.range?.startLineNumber ?? 1), S(`Revealed context: ${l.label}`));
  }, [O, pe]), Lt = N(async () => {
    if (Ln(Xe, "open new files"))
      try {
        const l = await Us();
        if (l.length === 0) return;
        oe((f) => Ut(f, l)), await Promise.all(l.map(async (f) => {
          const b = f.handle ? `file:${f.path}` : void 0;
          f.handle && b && await Ta(b, f.handle), $e({ name: f.name, path: f.path, kind: "file", handleKey: b, at: Date.now() });
        })), pe(l[0]), S(`Opened ${l.length} local file${l.length === 1 ? "" : "s"}`);
      } catch (l) {
        l.name !== "AbortError" && S(`Open file failed: ${l.message}`);
      }
  }, [Xe, pe, $e]), fn = N(async () => {
    if (Ln(Xe, "open another folder"))
      try {
        const l = await Bs(), f = l.handle ? `folder:${l.name}:${Date.now()}` : null;
        l.handle && f && await Ta(f, l.handle), je(f), He(l), oe(l.files), fe([]), W(null), ve(!1), $e({ name: l.name, path: l.name, kind: "folder", handleKey: f ?? void 0, at: Date.now() }), S(`${l.handle ? "Opened local folder" : "Opened browser fallback folder"} ${l.name} (${l.files.length} text files indexed)`);
      } catch (l) {
        l.name !== "AbortError" && S(`Open folder failed: ${l.message}`);
      }
  }, [Xe, $e]), Er = N((l) => {
    if (!g) return;
    let f = !1;
    ...
    if (D)
      try {
        const l = await Pn(D);
        oe((f) => f.map((b) => b.id === l.id ? l : b)), S(`Saved ${l.name}`);
      } catch (l) {
        S(`Save failed: ${l.message}`);
      }
  }, [D]), qr = N(async (l) => {
    ...
    if (l.length === 0) {
      S("No dirty files to save");
      return;
    }
    try {
      const f = await Promise.all(l.map((P) => Pn(P))), b = new Map(f.map((P) => [P.id, P]));
      oe((P) => P.map((J) => b.get(J.id) ?? J)), Ae(null), S(`Saved ${f.length} dirty file${f.length === 1 ? "" : "s"}`);
    } catch (f) {
      S(`Save all failed: ${f.message}`);
    }
  }, [O]), mn = N((l) => {
    const f = O.find((b) => b.id === l);
    if (f?.dirty && !window.confirm(`${f.name} has unsaved changes. Close without saving?`)) {
      S(`Close canceled — ${f.name} has unsaved changes`);
      return;
    }
    fe((b) => {
    ...
    Ln(Xe, "close all editors") && (fe([]), W(null), ea(null), ve(!1), S("Closed all editors"));
  }, [Xe]), pn = N(() => {
...
`,
    ...
    return K(P), P.length === 0 ? (S(Qe.snapshot.chunks.length === 0 ? "Project index is empty — open a folder with readable files first" : "Project index found no matching context for this prompt"), f) : (b.mode !== "hybrid" && b.reason ? S(b.reason) : S(`${P.length} project context hit${P.length === 1 ? "" : "s"} · ${b.reason ?? "hybrid retrieval"}`), [
      ...f,
      ...vo(P)
    ]);
  }, [Xt.parts, Ve, ke, e, Qe]), bn = N(() => {
    if (!D && Ce.length === 0) {
      S("Open a file before asking Atomek to synthesize an AI artifact");
      return;
    }
    const f = [
      `Create a polished Markdown artifact from ${D?.path ?? `${Ce.length} open editors`}.`,
    ...
    Z(!0), A("chat"), S("Asking Atomek to synthesize an AI artifact…"), (async () => {
      const b = await _e(f), P = await Q.askAgent(f, { requestContext: b });
  ...
  }, [D, Q, _e, Ce.length]), vn = N(async (l) => {
    if (l.kind === "folder") {
      const b = O.filter((P) => P.path === l.path || P.path.startsWith(`${l.path}/`));
      if (ue?.name === l.name || b.length > 0) {
        b.length > 0 && (He((P) => P?.name === l.name ? P : { name: l.name, files: b }), oe((P) => Ut(P, b))), h("explorer"), v(!0), W(null), ve(!1), $e({ ...l, at: Date.now() }), S(`Opened recent folder ${l.name}`);
        return;
      }
    }
    const f = O.find((b) => b.path === l.path || b.name === l.name);
    if (f) {
      pe(f), S(`Opened recent ${f.name}`);
      return;
    }
    if (!l.handleKey) {
      S("Recent item has no stored browser permission. Use Open File or Open Folder once, then Atomek can restore it.");
      return;
    }
    try {
      if (l.kind === "folder") {
        const J = await Tn(l.handleKey);
        if (!J || !await kn(J, "readwrite")) {
          S("Browser permission expired for this folder. Click Open Folder and pick it once to refresh the recent handle.");
          return;
        }
        const ce = await fa(J);
        je(l.handleKey), He(ce), oe(ce.files), fe([]), W(null), ve(!1), $e({ ...l, at: Date.now() }), S(`Reopened ${ce.name} (${ce.files.length} text files indexed)`);
        return;
      }
      const b = await Tn(l.handleKey);
      if (!b || !await kn(b, "readwrite")) {
        S("Browser permission expired for this file. Click Open File and pick it once to refresh the recent handle.");
        return;
      }
      const P = await Gs([b]);
      if (!P[0]) {
        S(`Recent file is not readable text: ${l.name}`);
        return;
      }
      oe((J) => Ut(J, P)), pe(P[0]), $e({ ...l, at: Date.now() }), S(`Reopened ${P[0].name}`);
    } catch (b) {
      S(`Open recent failed: ${b instanceof Error ? b.message : String(b)}`);
    }
  }, [O, ue?.name, pe, $e]), Se = N((l) => {
    Z(!0), A("chat"), Ne(""), (async () => {
      const f = await _e(l);
    ...
    if (!e.skills?.get) {
      S("Tytus skill registry is not available in this host build");
      return;
    }
    try {
...
`)), Z(!0), A("chat"), S(`Attached skill ${f.title} to chat input`);
    } catch (f) {
      S(`Failed to attach skill: ${f instanceof Error ? f.message : String(f)}`);
    }
  }, [e.skills]), Jr = N((l) => {
    const f = Q.messages.findIndex((P) => P.id === l.id), b = Q.messages.slice(0, f < 0 ? void 0 : f).reverse().find((P) => P.role === "user");
    if (!b?.body.trim()) {
      S("No previous user prompt to regenerate from");
      return;
    }
    (async () => {
      const P = await _e(b.body);
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek memory",
    ...
    if (!D) {
      S("No active file to save as AI artifact");
      return;
    }
    Q.createArtifact({
      title: D.path,
    ...
    const f = On(O, An(l.title || l.kind)), b = {
    ...
    oe((P) => [...P, b]), pe(b), S(`Opened ${l.title} as editable file`);
  }, [O, pe]), gn = N(() => {
    const l = window.prompt("Check command/name (manual capture only; Atomek will not execute it)");
    if (l === null) return;
    const f = l.trim();
    if (!f) {
      S("Manual check capture canceled — command/name was empty");
      return;
    }
...
`), J = {
    ...
    k((ce) => [J, ...ce]), j(!0), q("output"), S(`Captured manual check: ${f}`);
  }, []), ut = N((l, f) => {
    const b = Mo({
      body: f,
      files: O,
      ...
      edits: b.edits.map(hc),
      skipped: b.skipped
    };
    return b.edits.length > 1 ? (E(P), H(null), S(`Previewing AI workspace patch for ${b.edits.length} files`), !0) : b.edits.length === 1 ? (H(P.edits[0]), E(null), S(`Previewing AI patch for ${P.edits[0].fileName}`), !0) : (S(b.skipped.length > 0 ? `No applicable edit found. ${b.skipped.slice(0, 2).join(" · ")}` : "No fenced replacement block or applicable unified diff found. Ask Atomek for an edit again."), !1);
  }, [D, le, O]), la = N((l, f) => {
    const b = {
    ...
    k((P) => [b, ...P]), Z(!0), A("outputs"), j(!0), q("output"), S(`Saved local job output: ${l}`), (f.includes("```diff") || f.includes("--- a/")) && ut(l, f);
  }, [ut]), Br = N(() => {
    const l = te.trim();
    if (!l) return;
    Ne("");
    const f = ec(l);
    (async () => {
      const b = await _e(l), P = await Q.askAgent(l, { requestContext: b });
      if (!f || !P || P.status === "error") return;
      ut(P.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek edit", P.body) || S("Edit request answered without a patch. Use Generate patch / Edit to request an applicable diff.");
    })();
  }, [Q, _e, te, ut]), Gr = N(() => {
    G && (he(null), Se(tc(G)));
  }, [Se, G]), At = N((l) => {
    ...
    It(b), Tt(""), dn(""), _n("failed"), j(!0), q("terminal"), S(f.commands.length > 0 ? `Manual check ready: copy ${f.commands[0].command}` : "Manual check ready: enter a check command to copy");
  }, [O]), Qr = N((l) => {
    l.trim() && (Pt(l), It(l), S(`Manual check command copied: ${l}`));
  }, []), $r = N(() => {
    lt((l) => {
      if (!l) return l;
      const f = $o(l, ct), b = f.commands.at(-1)?.command ?? "";
      return b && It(b), f;
    }), Tt("");
  }, [ct]), _r = N(() => {
    if (!Fe || !Vt.trim()) {
      S("Select or enter a manual check command before capturing output");
      return;
    }
    const l = Vt.trim();
    lt((f) => f && _o(f, l, Dt, Ge)), dn(""), S(`Captured manual check result: ${l} (${Dt})`);
  }, [Ge, Vt, Fe, Dt]), es = N(() => {
    Fe && Se(el(Fe));
  }, [Se, Fe]), ts = N(() => {
    if (!T) return;
    ...
    if (!l) {
      S(`Cannot apply edit — ${T.fileName} is no longer open`), H(null);
      return;
    }
    l.content !== T.originalContent && !window.confirm(`${T.fileName} changed after the preview was created. Apply the AI edit anyway?`) || (oe((f) => f.map((b) => b.id === T.fileId ? { ...b, content: T.proposedContent, dirty: !0 } : b)), dt(T.fileId), Ae(`AI edit applied to ${l.name}. Save All to persist it to disk.`), H(null), At(`AI edit applied to ${l.name}`), S(`Applied AI edit to ${l.name} — unsaved; manual check ready`));
  }, [dt, O, T, At]), ns = N(() => {
    if (!T) return;
    const l = On(O, `${An(T.fileName)}-ai-edit`), f = {
    ...
    oe((b) => [...b, f]), pe(f), H(null), S(`Opened proposed edit as ${l}`);
  }, [D?.language, O, pe, T]), as = N(() => {
    if (!C) return;
    const l = new Map(C.edits.map((b) => [b.fileId, b]));
    O.some((b) => {
      const P = l.get(b.id);
    ...
    })), l.forEach((b, P) => dt(P)), Ae(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}. Save All to persist changes.`), E(null), At(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}`), S(`Applied AI workspace patch to ${l.size} file${l.size === 1 ? "" : "s"} — unsaved; manual check ready`));
  }, [dt, O, C, At]), rs = N(() => {
    if (!C) return;
    const l = [...O], f = C.edits.map((b) => {
      const P = On(l, `${An(b.fileName)}-ai-edit`), J = O.find((nt) => nt.id === b.fileId), ce = {
    ...
    oe((b) => [...b, ...f]), f[0] && pe(f[0]), E(null), S(`Opened ${f.length} proposed edit file${f.length === 1 ? "" : "s"}`);
  }, [O, pe, C]), ca = N((l) => {
    if (l === "explain") {
      Se("Explain the active file. Focus on purpose, structure, risks, and next useful edits.");
      return;
    }
    if (l === "improve") {
      Se("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful.");
      return;
    }
    if (l === "plan") {
      Se("Create an implementation plan from the open editor context. Be specific, ordered, and call out blockers.");
      return;
    }
    if (l === "edit") {
      Se("Edit the active file or open workspace files. Prefer one git-style unified diff in a fenced diff block, with paths matching opened files. If editing one file, a complete fenced replacement is also OK. Do not use provider-specific tools or model assumptions.");
      return;
    }
    Se("Draft a concrete Markdown artifact from the open editor context. Make it ready to save as an output.");
  }, [Se]);
  return re(() => {
    const l = (f) => {
      (f.metaKey || f.ctrlKey) && (f.key.toLowerCase() === "o" && (f.preventDefault(), Lt()), f.key.toLowerCase() === "s" && (f.preventDefault(), hn()), f.key.toLowerCase() === "w" && (f.preventDefault(), g && mn(g)), f.key.toLowerCase() === "b" && (f.preventDefault(), v((P) => !P)), f.shiftKey && f.key.toLowerCase() === "f" && (f.preventDefault(), h("search"), v(!0)), (f.key.toLowerCase() === "k" || f.key.toLowerCase() === "p") && (f.preventDefault(), De(!0)));
    };
    ...
    const l = t.current;
    if (!l) return;
    const f = () => r(Math.round(l.getBoundingClientRect().width));
    f();
    ...
    if (!n) return;
    const l = Xn(n);
    w((f) => Zt(f, l.primaryMin, l.primaryMax)), ge((f) => Zt(f, l.secondaryMin, l.secondaryMax));
  }, [n]), re(() => {
    const l = { primaryVisible: p, primaryWidth: y, secondaryVisible: R, secondaryWidth: F, markdownPreviewVisible: M };
    localStorage.setItem(pr, JSON.stringify(l));
  }, [M, p, y, R, F]), re(() => {
    if (!i.folder?.handleKey) return;
    let l = !1;
    return (async () => {
      try {
        const f = await Tn(i.folder?.handleKey ?? "");
        if (!f || !await kn(f, "readwrite") || l) return;
        const b = await fa(f);
        if (l) return;
        je(i.folder?.handleKey ?? null), He(b), oe((P) => kc(P, b.files)), fe((P) => P.filter((J) => b.files.some((ce) => ce.id === J) || O.some((ce) => ce.id === J))), S(`Restored ${b.name} (${b.files.length} text files indexed)`);
      } catch (f) {
        l || S(`Workspace restore failed: ${f instanceof Error ? f.message : String(f)}`);
      }
    })(), () => {
      l = !0;
    };
    ...
    wc({
      activity: c,
      folder: ue ? { name: ue.name, handleKey: We } : null,
      files: gc(O),
      openEditorIds: Pe,
      activeFileId: g,
      query: x,
  ...
  }, [c, g, _, we, te, We, O, ue, Pe, x, zt, m, Y]), re(() => {
    localStorage.setItem(vr, JSON.stringify(ke));
  }, [ke]), /* @__PURE__ */ d(
    "div",
    {
      ref: t,
      ...
      children: [
        ...
        p && /* @__PURE__ */ d("div", { className: "workbench-primary-region", children: [
          /* @__PURE__ */ a(
            Vl,
            {
              host: e,
              ...
              setStatus: S,
              hasFsAccess: Ks(),
              attachSkillToChat: oa,
              saveLocalJobOutput: la,
              activeFile: D
            }
          ),
        ...
        /* @__PURE__ */ d("main", { className: "workbench-editor-area", children: [
          /* @__PURE__ */ a("button", { className: "workbench-command-center", onClick: () => De(!0), children: "Workspace" }),
          /* @__PURE__ */ d("section", { className: "workbench-editor-stack", children: [
            ...
            /* @__PURE__ */ a(Fl, { file: D, folder: ue, showWelcome: un }),
            Te && Xe.length > 0 ? /* @__PURE__ */ d("div", { className: "workbench-ai-dirty-banner", children: [
              /* @__PURE__ */ a("span", { children: Te }),
              /* @__PURE__ */ a("button", { onClick: () => {
                ia();
              }, children: "Save all" }),
              /* @__PURE__ */ a("button", { onClick: () => Ae(null), title: "Dismiss", children: /* @__PURE__ */ a(Ye, { size: 13 }) })
            ] }) : null,
            /* @__PURE__ */ a("div", { className: "workbench-editor-content", children: D ? /* @__PURE__ */ d("div", { className: D.language === "markdown" && M ? "workbench-editor-split" : "workbench-editor-single", children: [
              /* @__PURE__ */ a("div", { className: "workbench-editor-pane", children: /* @__PURE__ */ a(is, { fallback: /* @__PURE__ */ a("div", { className: "workbench-empty-pane", children: "Loading editor…" }), children: /* @__PURE__ */ a(
                Pl,
                {
                  file: D,
                  revealLine: Cr,
              ...
              D.language === "markdown" && M && /* @__PURE__ */ a(Ul, { content: D.content })
            ] }) : Ft ? /* @__PURE__ */ a(
              ac,
              {
                host: e,
            ...
            ) : un ? /* @__PURE__ */ a(Yl, { host: e, openFile: Lt, openFolder: fn, newFile: pn, recent: zt, reopenRecent: vn, setStatus: S, openControlTower: () => {
              h("computer"), v(!0);
            }, openChat: () => {
              A("chat"), Z(!0);
            }, openEmbeddedDoc: Fr }) : /* @__PURE__ */ d("div", { className: "workbench-no-editor", children: [
              /* @__PURE__ */ a(on, { size: 34 }),
              /* @__PURE__ */ a("p", { children: "No editor open" }),
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => ve(!1), children: "Show Agent Team" })
            ] }) }),
            we && /* @__PURE__ */ a(
              Gl,
              {
                ...
                runAiSynthesis: bn,
                captureManualCheck: gn,
                openOutputAsFile: yn,
                manualCheckSession: Fe,
                manualCheckCommandInput: ct,
                setManualCheckCommandInput: Tt,
                manualCheckOutputInput: Ge,
                setManualCheckOutputInput: dn,
                manualCheckSelectedCommand: Vt,
                setManualCheckSelectedCommand: It,
                manualCheckStatus: Dt,
                setManualCheckStatus: _n,
                copyManualCheckCommand: Qr,
                addManualCheckCommand: $r,
                recordManualCheckResult: _r,
                askAgentFromManualChecks: es,
                onClose: () => j(!1)
              }
            )
          ] })
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek answer", l.body),
            ...
            removeContextAttachment: Vr,
            revealContextAttachment: Rr,
            projectIndexSummary: `${Qe.snapshot.files.length} files · ${Qe.snapshot.chunks.length} chunks`,
            projectIndexStale: Qe.isStale,
            refreshProjectIndex: () => {
              const l = Qe.refresh(O);
              S(`Project index refreshed: ${l.files.length} files · ${l.chunks.length} chunks`);
            },
            onResizeStart: Ir,
            onClose: () => Z(!1)
          }
        ...
        Ie && /* @__PURE__ */ a(
          Kl,
          {
            ...
            activeFile: D,
            commands: [
              { label: "File: New File", detail: "Create an untitled Markdown file", run: pn },
              ...
              ...zt.map((l) => ({ label: `File: Open Recent — ${l.name}`, detail: l.path, run: () => {
                vn(l);
              } })),
              { label: "File: Save All", detail: `${Xe.length} dirty file${Xe.length === 1 ? "" : "s"}`, run: () => {
                ia();
              }, disabled: Xe.length === 0 },
              { label: "File: Close All Editors", detail: `${Ce.length} open editor${Ce.length === 1 ? "" : "s"}`, run: Yr, disabled: Ce.length === 0 },
              ...
              { label: "Checks: Open Manual Check Panel", detail: "Capture copy/paste check commands without host execution", run: () => At("Manual check requested from command palette") },
              ...
              { label: "Atomek: Create AI Synthesis", detail: D || Ce.length > 0 ? "Ask AIL to produce a saved Markdown artifact" : "Open a file first", run: bn, disabled: !D && Ce.length === 0 },
              { label: "AI: Explain Active File", detail: D ? `Ask Cortex to explain ${D.path}` : "Open a file first", run: () => Se("Explain the active file. Focus on purpose, structure, risks, and next useful edits."), disabled: !D },
              { label: "AI: Improve Active File", detail: D ? `Ask Cortex for concrete edits to ${D.path}` : "Open a file first", run: () => Se("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful."), disabled: !D },
              { label: "AI: Draft Editable Replacement", detail: D ? `Ask Cortex for a full-file replacement for ${D.path}` : "Open a file first", run: () => ca("edit"), disabled: !D },
              { label: "AI: Plan Workspace Work", detail: Ce.length > 0 ? "Use open editors as bounded context" : "Open files first", run: () => Se("Create an implementation plan from the open editor context. Be specific and sequence the work."), disabled: Ce.length === 0 },
              { label: "AI: Save Active File as Artifact", detail: D ? "Persist active file in host.ai artifacts" : "Open a file first", run: Ur, disabled: !D },
              { label: "AI: Capture Manual Check Output", detail: "Paste check output as an auditable local artifact; no shell execution", run: gn },
              { label: "AI: Open Latest Artifact as File", detail: tt[0] ? `Create editable file from ${tt[0].title}` : "No outputs yet", run: () => tt[0] && yn(tt[0]), disabled: tt.length === 0 }
            ],
            openWorkbenchFile: pe,
            onClose: () => De(!1)
          }
        ...
        /* @__PURE__ */ a(fc, { status: Sr, file: D ?? xl, cursor: V, fileCount: O.length, dirtyCount: Xe.length })
      ]
    }
  );
}
function Wl({ active: e, setActive: t, togglePrimary: n, openSettings: r, settingsActive: s }) {
  return /* @__PURE__ */ d("aside", { className: "workbench-activity-bar", "aria-label": "Activity Bar", children: [
    /* @__PURE__ */ a("button", { className: "workbench-activity-brand", title: "Toggle side bar", "aria-label": "Toggle side bar", onClick: n, children: /* @__PURE__ */ a(fr, { size: 30, variant: "cream" }) }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Ma, { size: 25 }), label: "Explorer", active: e === "explorer", onClick: () => t("explorer") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Vs, { size: 25 }), label: "Search", active: e === "search", onClick: () => t("search") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Va, { size: 25 }), label: "Source Control", active: e === "source-control", onClick: () => t("source-control") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(ja, { size: 25 }), label: "Run and Debug", active: e === "run", onClick: () => t("run") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Dn, { size: 25 }), label: "Agent Team", active: e === "computer", onClick: () => t("computer") }),
    /* @__PURE__ */ a("div", { className: "workbench-activity-spacer" }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Rs, { size: 23 }), label: "Settings", active: s, onClick: r })
  ] });
}
...
function Vl(e) {
  return e.activity === "search" ? /* @__PURE__ */ a(Jl, { files: e.files, query: e.query, setQuery: e.setQuery, openWorkbenchFile: e.openWorkbenchFile, activeFileId: e.activeFileId }) : e.activity === "source-control" ? /* @__PURE__ */ a(Ca, { title: "SOURCE CONTROL", body: "No source control provider registered. Git belongs here, not as a fake demo." }) : e.activity === "run" ? /* @__PURE__ */ a(Ca, { title: "RUN AND DEBUG", body: "Run configurations, terminals, and recipe execution will plug into this surface later." }) : e.activity === "computer" ? /* @__PURE__ */ a(Ar, { host: e.host, setStatus: e.setStatus, attachSkillToChat: e.attachSkillToChat, saveLocalJobOutput: e.saveLocalJobOutput, activeFile: e.activeFile, openEditors: e.openEditors }) : /* @__PURE__ */ a(Il, { ...e });
}
function Il(e) {
  const t = !e.folder, n = de(() => Dl(e.files, e.folder?.name), [e.files, e.folder?.name]), [r, s] = z(() => /* @__PURE__ */ new Set());
  re(() => {
    const o = Nr(n);
    s((c) => {
      const h = new Set(c);
  ...
  return /* @__PURE__ */ d("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ d("div", { className: "workbench-sidebar-scroll", children: [
      t ? /* @__PURE__ */ d(Re, { children: [
        ...
        e.openEditors.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No open editors" }) : e.openEditors.map((o) => /* @__PURE__ */ a($n, { file: o, active: o.id === e.activeFileId, onOpen: () => e.openWorkbenchFile(o), label: o.name, detail: o.path }, o.id)),
        /* @__PURE__ */ d("div", { className: "workbench-section-title", children: [
          /* @__PURE__ */ a(sn, { size: 12 }),
          " ",
          e.folder?.name ?? "Workspace"
        ] }),
        n.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No readable text files found." }) : Tr(n, e.activeFileId, e.openWorkbenchFile, r, i)
      ] }),
      ...
      e.recent.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No recent folders yet." }) : e.recent.map((o) => /* @__PURE__ */ d("button", { className: "workbench-tree-row", onClick: () => {
        ...
        o.kind === "file" ? /* @__PURE__ */ a(Rn, { size: 14 }) : /* @__PURE__ */ a(Wa, { size: 14 }),
        /* @__PURE__ */ a("span", { className: "workbench-row-name", children: o.name })
      ] }, `${o.path}-${o.at}`))
    ] })
  ] });
}
function $n({ file: e, active: t, onOpen: n, basePath: r, depth: s = 0, label: i, detail: o }) {
  const c = r && e.path.startsWith(`${r}/`) ? e.path.slice(r.length + 1) : e.path, h = s || Math.max(0, c.split("/").length - 1);
  return /* @__PURE__ */ d("button", { className: `workbench-file-row ${t ? "active" : ""}`, style: { "--workbench-depth": h }, onClick: n, title: e.path, children: [
    /* @__PURE__ */ a(Rn, { size: 14 }),
    /* @__PURE__ */ d("span", { className: "workbench-row-text", children: [
      /* @__PURE__ */ a("span", { className: "workbench-row-name", children: i ?? c }),
...
function Dl(e, t) {
  const n = [], r = /* @__PURE__ */ new Map(), s = (o, c, h = n) => {
    const p = r.get(o);
    if (p) return p;
    const v = { name: c, path: o, children: [] };
    return r.set(o, v), h.push(v), v;
  };
  e.forEach((o) => {
...
function Nr(e) {
  return e.flatMap((t) => t.file ? [] : [t.path, ...Nr(t.children)]);
}
function Tr(e, t, n, r, s, i = 0) {
  return e.map((o) => {
    if (o.file)
      return /* @__PURE__ */ a($n, { file: o.file, active: o.file.id === t, onOpen: () => n(o.file), depth: i, label: o.name }, o.file.id);
    const c = r.has(o.path);
    return /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ d("button", { className: "workbench-folder-row", style: { "--workbench-depth": i }, onClick: () => s(o.path), title: c ? `Collapse ${o.name}` : `Expand ${o.name}`, children: [
        c ? /* @__PURE__ */ a(sn, { size: 12 }) : /* @__PURE__ */ a(sn, { className: "workbench-chevron-collapsed", size: 12 }),
        c ? /* @__PURE__ */ a(qn, { size: 14 }) : /* @__PURE__ */ a(Wa, { size: 14 }),
        /* @__PURE__ */ a("span", { className: "workbench-row-name", children: o.name }),
        /* @__PURE__ */ a("span", { className: "workbench-row-meta", children: o.children.length })
      ] }),
      c ? Tr(o.children, t, n, r, s, i + 1) : null
    ] }, o.path);
  });
}
function Fl({ file: e, folder: t, showWelcome: n }) {
...
function Rl(e) {
  return /* @__PURE__ */ d("div", { className: "workbench-tabs", children: [
    e.showWelcome && /* @__PURE__ */ d("button", { className: "workbench-tab active", children: [
      ...
      }, children: /* @__PURE__ */ a(Ye, { size: 13 }) })
    ] }),
    ...
    e.canPreview && /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.previewVisible ? "active" : ""}`, title: "Toggle Markdown Preview", onClick: e.togglePreview, children: /* @__PURE__ */ a(Fn, { size: 16 }) }),
    /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.secondaryVisible ? "active" : ""}`, title: "Toggle Chat", onClick: e.toggleSecondary, children: /* @__PURE__ */ a(Cs, { size: 16 }) })
  ] });
}
function El(e) {
...
function ql(e) {
  ...
  return [...e?.resources ?? []].sort((n, r) => (t[n.kind] ?? 9) - (t[r.kind] ?? 9) || Oe(n).localeCompare(Oe(r))).slice(0, 8);
}
function Yl({
  host: e,
  openFile: t,
  ...
  const [v, y] = z("Coordinate a Tytus mission across pods, local agents, shared folders, and app skills."), [w, m] = z(null), [A, R] = z([]), [Z, F] = z(!1), [ge, we] = z(null), [j, _] = z(null), [q, M] = z("pod-local"), be = N(async () => {
    F(!0), _(null);
    try {
  ...
  const ve = N(async () => {
    ...
    const g = v.trim() || "Coordinate a Tytus mission.", W = ot(g, w, q);
    F(!0);
    try {
      ...
      await e.missions.write({
        rootPath: x.rootPath,
        files: [
          { path: "MISSION.md", content: an(L, w, null, [], g, W) },
          { path: "MISSION.json", content: xr(L, w, g, W) },
          { path: "RESOURCES.md", content: rn(w) },
          { path: "TASKS.md", content: kr(Mt(g, w, W)) },
          { path: "HANDOFF.md", content: Pr(L) },
...
`) }
  ...
  }, [v, w, e.missions, c, o, q]), ue = El(w), He = Ll(w), We = Al(w), je = ql(w), O = w?.warnings ?? [], oe = Cl(w), Pe = Nt(w, ot(v, w, q)), fe = Mt(v, w, Pe.id);
  return /* @__PURE__ */ d("div", { className: "workbench-welcome workbench-control-home", children: [
    /* @__PURE__ */ d("section", { className: "workbench-control-hero-main", children: [
      /* @__PURE__ */ d("div", { className: "workbench-brand-lockup", "aria-label": "Atomek", children: [
        /* @__PURE__ */ a(fr, { size: 74, variant: "acid" }),
        /* @__PURE__ */ d("div", { children: [
          /* @__PURE__ */ a(hl, { className: "workbench-brand-wordmark" }),
      ...
      /* @__PURE__ */ d("div", { className: "workbench-control-goal-row", children: [
        /* @__PURE__ */ a("textarea", { value: v, onChange: (g) => y(g.target.value), rows: 3, "aria-label": "Mission goal" }),
        /* @__PURE__ */ d("div", { className: "workbench-control-hero-actions", children: [
          ...
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: h, children: "Open chat" })
        ] })
      ] }),
      /* @__PURE__ */ a("div", { className: "workbench-team-preset-strip", "aria-label": "Team presets", children: oe.map((g) => /* @__PURE__ */ d(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("small", { children: g.assignments.map((W) => W.resourceLabel).slice(0, 3).join(" · ") })
          ]
        },
        g.id
      )) }),
      ge ? /* @__PURE__ */ d("div", { className: "workbench-control-success", children: [
        "Mission ready: ",
        /* @__PURE__ */ a("code", { children: ge.rootPath })
      ] }) : null,
    ...
    /* @__PURE__ */ d("section", { className: "workbench-control-grid", children: [
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-control-metrics", children: ue.map((g) => /* @__PURE__ */ d("div", { className: "workbench-control-metric", children: [
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-agent-brand-grid", children: He.map((g) => /* @__PURE__ */ d("div", { className: `workbench-agent-brand-card ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ a("strong", { children: g.label }),
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-doc-grid", children: gl.map((g) => /* @__PURE__ */ d("button", { className: "workbench-doc-card", onClick: () => p(g), title: g.summary, children: [
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-fabric-flow", children: We.map((g, W) => /* @__PURE__ */ d("div", { className: `workbench-fabric-node ${g.status.replace(/\s+/g, "-")}`, children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-fabric-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Y(Jt.sharedFiles, "Shared Files"), children: "Open shared files" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Y(Jt.podInspector, "Pod Inspector"), children: "Open pods" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Y(Jt.channels, "Channels"), children: "Open channels" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Y(Jt.settings, "Agent Settings"), children: "Open agent settings" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card", children: [
        /* @__PURE__ */ d("header", { children: [
          ...
          /* @__PURE__ */ a("span", { children: A.length ? `${A.length} missions` : "none yet" })
        ] }),
        A.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "Create a mission once; it stays in Tytus Home/Missions and can be resumed here." }) : null,
        A.slice(0, 4).map((g) => /* @__PURE__ */ d("button", { className: "workbench-control-preset", onClick: () => {
          St(g), c();
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-control-resource-list", children: [
          je.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No resource graph yet. Start Tytus tray beta30 or newer, then refresh." }) : null,
          je.map((g) => /* @__PURE__ */ d("div", { className: "workbench-control-resource", children: [
            /* @__PURE__ */ d("div", { children: [
              /* @__PURE__ */ a("strong", { children: Oe(g) }),
              /* @__PURE__ */ a("span", { children: Qn(g) })
            ] }),
            /* @__PURE__ */ a("span", { className: `workbench-computer-pill ${g.status}`, children: g.status })
          ] }, g.id))
        ] }),
        O.length ? /* @__PURE__ */ a("div", { className: "workbench-resource-warnings", children: O.slice(0, 2).map((g) => /* @__PURE__ */ d("span", { children: [
          g.code,
          ": ",
          g.message
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-task-graph home", children: fe.map((g, W) => /* @__PURE__ */ d("button", { className: `workbench-task-card ${g.status}`, onClick: () => y(g.prompt), children: [
          /* @__PURE__ */ a("span", { children: W + 1 }),
          /* @__PURE__ */ a("strong", { children: g.title }),
...
function Jl({ files: e, query: t, setQuery: n, openWorkbenchFile: r, activeFileId: s }) {
  const i = de(() => Zl(e, t), [e, t]), o = de(() => {
  ...
  return /* @__PURE__ */ d("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ d("div", { className: "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ a("input", { className: "workbench-input", value: t, onChange: (c) => n(c.target.value), placeholder: "Search files and text", autoFocus: !0 }),
      /* @__PURE__ */ d("div", { className: "workbench-section-title", children: [
        /* @__PURE__ */ a(on, { size: 12 }),
        " Results"
      ] }),
      t.trim() ? o.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No matches." }) : o.map((c) => {
        const h = c[0].file;
        return /* @__PURE__ */ d("div", { className: "workbench-search-group", children: [
          /* @__PURE__ */ a($n, { file: h, active: h.id === s, onOpen: () => r(h) }),
          c.slice(0, 5).map((p) => /* @__PURE__ */ d("button", { className: "workbench-search-hit", onClick: () => r(h, p.lineNumber), title: p.line, children: [
          ...
          c.length > 5 && /* @__PURE__ */ d("div", { className: "workbench-search-more", children: [
            "+",
            c.length - 5,
            " more matches"
          ] })
...
function Kl(e) {
  const t = e.query.trim().toLowerCase(), n = e.files.slice(0, 80).map((s) => ({
    label: s.path,
    detail: `Open ${Ra(s.language)} file`,
...
function Bl(e) {
  const t = e.session ? tl(e.session) : "pending";
  return /* @__PURE__ */ d("div", { className: "workbench-manual-check-panel", children: [
    ...
    e.session ? /* @__PURE__ */ d(Re, { children: [
...
function Gl(e) {
  return /* @__PURE__ */ d("section", { className: "workbench-bottom-panel", "aria-label": "Panel", children: [
    /* @__PURE__ */ d("div", { className: "workbench-bottom-tabs", children: [
      ...
      /* @__PURE__ */ a("span", {}),
      /* @__PURE__ */ a("button", { title: "Close Panel", onClick: e.onClose, children: /* @__PURE__ */ a(Ye, { size: 14 }) })
    ] }),
    /* @__PURE__ */ d("div", { className: "workbench-bottom-body", children: [
      ...
      e.tab === "output" && /* @__PURE__ */ a(Lr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, compact: !0 })
    ] })
  ] });
}
function Ql(e) {
  return /* @__PURE__ */ d("aside", { className: "workbench-secondary", children: [
    ...
    /* @__PURE__ */ d("div", { className: "workbench-secondary-tabs", children: [
      ...
      /* @__PURE__ */ d("div", { className: "workbench-secondary-actions", children: [
        /* @__PURE__ */ a("button", { title: "New Chat", onClick: e.newChat, children: /* @__PURE__ */ a(js, { size: 15 }) }),
        /* @__PURE__ */ a("button", { title: "Chat Settings", onClick: e.openSettings, children: /* @__PURE__ */ a(gs, { size: 16 }) }),
        /* @__PURE__ */ a("button", { title: "Close Chat", onClick: e.onClose, children: /* @__PURE__ */ a(Ye, { size: 15 }) })
      ] })
    ] }),
    e.tab === "chat" ? /* @__PURE__ */ a($l, { ...e }) : e.tab === "agents" ? /* @__PURE__ */ a(
      Ar,
      {
        host: e.host,
    ...
    ) : /* @__PURE__ */ a(Lr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, previewEditFromOutput: e.previewEditFromOutput, canPreviewEdit: e.canPreviewEdit })
  ] });
}
function zr({ body: e }) {
  const t = de(() => Tl(e), [e]), [n, r] = z(null), s = N((i, o) => {
    (async () => await Pt(o) && (r(i), window.setTimeout(() => r((h) => h === i ? null : h), 1200)))();
  }, []);
  return /* @__PURE__ */ a("div", { className: "workbench-rich-body", children: t.map((i) => {
      ...
      return /* @__PURE__ */ d("div", { className: "workbench-rich-code", children: [
        /* @__PURE__ */ d("div", { className: "workbench-rich-code-head", children: [
          ...
          /* @__PURE__ */ d("button", { onClick: () => s(i.key, i.body), title: "Copy code block", children: [
            o ? /* @__PURE__ */ a(ps, { size: 12 }) : /* @__PURE__ */ a(Sn, { size: 12 }),
            o ? "Copied" : "Copy"
          ] })
        ] }),
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: Ja(i.body) }
      },
      i.key
    );
  }) });
...
function $l(e) {
  const t = e.selectedChatTarget.available, n = e.selectedChatTarget.kind === "atomek-ai", r = e.chatInput.trim().length > 0 && !e.busy && t, s = it(null), [i, o] = z(!0), [c, h] = z(!1), p = de(() => e.chatMessages.map((m) => `${m.id}:${m.status ?? ""}:${m.body.length}`).join("|"), [e.chatMessages]);
  re(() => {
    const m = s.current;
  ...
  return /* @__PURE__ */ d("div", { className: "workbench-chat-wrap", children: [
    /* @__PURE__ */ d("div", { className: "workbench-chat-threadbar", children: [
      n ? /* @__PURE__ */ d(
        "select",
        {
          ...
          children: [
            ...
            e.chatThreads.map((m) => /* @__PURE__ */ d("option", { value: m.id, children: [
              m.title,
              " · ",
              _l(m.lastMessageAt ?? m.updatedAt)
            ] }, m.id))
          ]
        }
      ) : /* @__PURE__ */ d("span", { className: "workbench-chat-route-summary", children: [
      ...
      /* @__PURE__ */ a(
        "select",
        {
          ...
          children: e.chatTargets.map((m) => /* @__PURE__ */ d("option", { value: m.id, disabled: !m.available, children: [
            m.label,
            m.kind === "pod-agent" && m.status !== "running" ? ` · ${m.status}` : ""
          ] }, m.id))
        }
      ),
      n ? /* @__PURE__ */ d(Re, { children: [
        /* @__PURE__ */ a(
          "button",
          {
            onClick: () => {
    ...
    /* @__PURE__ */ d("div", { ref: s, className: "workbench-chat-transcript", onScroll: v, children: [
      e.chatMessages.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-chat-empty", children: /* @__PURE__ */ d("div", { children: [
      ...
      ] }) }) : e.chatMessages.map((m) => /* @__PURE__ */ d("div", { className: `workbench-chat-message ${m.role}`, children: [
        ...
        /* @__PURE__ */ a("br", {}),
        /* @__PURE__ */ a(zr, { body: m.body }),
        m.gatewayLabel ? /* @__PURE__ */ d(Re, { children: [
          /* @__PURE__ */ a("br", {}),
          /* @__PURE__ */ a("small", { children: m.gatewayLabel })
        ] }) : null,
        m.role === "assistant" && m.status !== "streaming" && m.status !== "error" ? /* @__PURE__ */ d("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ d("button", { className: "workbench-chat-message-action", onClick: () => w(m), title: "Copy this answer", children: [
            /* @__PURE__ */ a(Sn, { size: 12 }),
            " Copy"
          ] }),
          /* @__PURE__ */ d("button", { className: "workbench-chat-message-action", onClick: () => e.saveMessageAsArtifact(m), title: "Save this answer as an output artifact", children: [
            /* @__PURE__ */ a(En, { size: 12 }),
            " Save"
          ] }),
          /* @__PURE__ */ d("button", { className: "workbench-chat-message-action", onClick: () => e.rememberMessage(m), title: "Store this answer in Atomek memory", children: [
            /* @__PURE__ */ a(Va, { size: 12 }),
            " Remember"
          ] }),
          /* @__PURE__ */ d("button", { className: "workbench-chat-message-action", onClick: () => e.previewEditFromMessage(m), disabled: e.workspaceFileCount === 0, title: "Preview an editable patch from this answer", children: [
            /* @__PURE__ */ a(Fn, { size: 12 }),
            " Preview"
          ] }),
          /* @__PURE__ */ d("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, title: "Regenerate this answer", children: [
            /* @__PURE__ */ a(yt, { size: 12 }),
            " Regenerate"
          ] })
        ] }) : null,
        m.role === "assistant" && m.status === "error" ? /* @__PURE__ */ d("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ d("button", { className: "workbench-chat-message-action", onClick: () => w(m), title: "Copy this error", children: [
            /* @__PURE__ */ a(Sn, { size: 12 }),
            " Copy"
          ] }),
          /* @__PURE__ */ d("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, children: [
            /* @__PURE__ */ a(yt, { size: 12 }),
            " Retry"
          ] })
        ] }) : null
      ] }, m.id)),
      c ? /* @__PURE__ */ a("button", { className: "workbench-chat-jump", onClick: y, children: "Jump to latest" }) : null
    ] }),
    /* @__PURE__ */ d("div", { className: "workbench-chat-composer", children: [
      /* @__PURE__ */ d("div", { className: "workbench-chat-tip", children: [
        ...
        /* @__PURE__ */ a("em", { children: e.selectedChatTarget.kind === "atomek-ai" ? La(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
        /* @__PURE__ */ a("span", { children: "Context" }),
        /* @__PURE__ */ a("strong", { children: Ai(e.contextScope) })
      ] }),
      /* @__PURE__ */ d("div", { className: "workbench-chat-box", children: [
        /* @__PURE__ */ d("div", { className: "workbench-chat-attachments", children: [
          ...
          e.contextScope === "indexed-project" ? /* @__PURE__ */ d(Re, { children: [
          ...
          e.contextAttachments.length === 0 ? /* @__PURE__ */ d("span", { className: "workbench-chat-chip muted", children: [
            ...
            return /* @__PURE__ */ d("span", { className: "workbench-chat-chip", title: F, children: [
              /* @__PURE__ */ a("button", { className: "workbench-chat-chip-open", onClick: () => e.revealContextAttachment(m), disabled: !m.fileId, title: "Reveal context", children: /* @__PURE__ */ a(ua, { size: 13 }) }),
              m.label,
              A ? /* @__PURE__ */ a("small", { children: A }) : null,
              m.snippet ? /* @__PURE__ */ d("small", { children: [
                m.snippet.slice(0, 60),
                m.snippet.length > 60 ? "…" : ""
              ] }) : null,
              m.dirty ? /* @__PURE__ */ a("small", { children: "dirty" }) : null,
              m.removable ? /* @__PURE__ */ a("button", { className: "workbench-chat-chip-remove", onClick: () => e.removeContextAttachment(m), title: "Remove context", children: /* @__PURE__ */ a(Ye, { size: 11 }) }) : null
            ] }, m.id);
          }),
        ...
        /* @__PURE__ */ d("div", { className: "workbench-chat-toolbar compact", children: [
          /* @__PURE__ */ a("span", { className: "workbench-chat-route-summary", children: e.selectedChatTarget.kind === "atomek-ai" ? La(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
          /* @__PURE__ */ a("span", {}),
          e.busy ? /* @__PURE__ */ a("button", { className: "workbench-chat-send stop", onClick: e.stopChat, title: "Stop", children: /* @__PURE__ */ a(Da, { size: 14 }) }) : /* @__PURE__ */ a("button", { className: `workbench-chat-send ${r ? "ready" : ""}`, onClick: e.askAgent, title: "Send", disabled: !r, "aria-label": "Send message", children: /* @__PURE__ */ a(Ds, { size: 16 }) })
        ] })
      ] })
    ] })
  ] });
...
function La(e, t, n) {
  e.model;
  const s = [e.gatewayPreference === "auto" ? t : Xr(e.gatewayPreference)];
...
function nc({ host: e, appName: t, currentVersion: n }) {
  const r = e.apps, [s, i] = z(null), [o, c] = z(!1), [h, p] = z(null), v = N(async () => {
    if (!r?.checkUpdate) {
  ...
  }, [r, t]), w = s?.latestVersion ?? n, m = !!s?.updateAvailable;
  return /* @__PURE__ */ d("div", { className: "workbench-settings-section", children: [
    ...
    /* @__PURE__ */ d("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ d("button", { className: "workbench-button-subtle", onClick: () => void v(), disabled: o, children: [
        /* @__PURE__ */ a(yt, { size: 14 }),
        o ? "Checking…" : "Check for update"
      ] }),
      m ? /* @__PURE__ */ a("button", { className: "workbench-button-primary", onClick: () => void y(), disabled: o, children: o ? "Updating…" : `Update ${t}` }) : null
    ] }),
    /* @__PURE__ */ a("div", { className: "workbench-settings-note", children: h ?? (s ? m ? "Update available." : "You are running the latest available version." : "Checking latest version…") })
  ] });
}
function ac(e) {
  const [t, n] = z([]), [r, s] = z("Loading gateway models…"), [i, o] = z([]), [c, h] = z("Checking embedding capability…");
  re(() => {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-settings-tab", children: /* @__PURE__ */ d("section", { className: "workbench-settings-page", "aria-label": "Atomek Settings", children: [
    /* @__PURE__ */ d("header", { className: "workbench-settings-header", children: [
      ...
      /* @__PURE__ */ a("button", { onClick: e.onClose, title: "Close", children: /* @__PURE__ */ a(Ye, { size: 15 }) })
    ] }),
    /* @__PURE__ */ d("div", { className: "workbench-settings-body", children: [
      /* @__PURE__ */ a(nc, { host: e.host, appName: "Atomek", currentVersion: za }),
      /* @__PURE__ */ d("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-settings-note", children: [
          "Current request: ",
          Xr(e.chatSettings.gatewayPreference),
...
function Lr({ outputs: e, clearOutputs: t, deleteArtifact: n, runAiSynthesis: r, captureManualCheck: s, openOutputAsFile: i, previewEditFromOutput: o, canPreviewEdit: c = !1, compact: h = !1 }) {
  return /* @__PURE__ */ d("div", { className: `workbench-panel-list ${h ? "compact" : ""}`, children: [
    /* @__PURE__ */ d("div", { style: { display: "flex", gap: 8, marginBottom: 10 }, children: [
      /* @__PURE__ */ d("button", { className: "workbench-button-subtle", onClick: r, children: [
        /* @__PURE__ */ a(Dn, { size: 14 }),
        "AI synthesis"
      ] }),
      /* @__PURE__ */ d("button", { className: "workbench-button-subtle", onClick: s, children: [
        /* @__PURE__ */ a(ja, { size: 14 }),
        "Capture check"
      ] }),
      /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: t, children: "Clear" })
    ] }),
    e.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No outputs yet. Save an AI answer as an artifact or create an AI synthesis." }) : e.map((p) => /* @__PURE__ */ d("div", { className: "workbench-output-card", children: [
      /* @__PURE__ */ d("div", { className: "workbench-output-head", children: [
        ...
        /* @__PURE__ */ a("button", { onClick: () => void Pt(p.body), children: "Copy" }),
        /* @__PURE__ */ a("button", { onClick: () => i(p), children: "Open as file" }),
        o ? /* @__PURE__ */ a(
          "button",
          {
            className: Aa(p.body) ? "workbench-output-edit-cta" : void 0,
            onClick: () => o(p),
            disabled: !c,
            children: Aa(p.body) ? "Preview/apply edit" : "Preview edit"
          }
        ) : null,
        p.source === "ai" ? /* @__PURE__ */ a("button", { onClick: () => n(p.id), children: "Delete" }) : null
      ] }),
      /* @__PURE__ */ a(zr, { body: p.body })
    ] }, p.id))
  ] });
}
function rc({ edit: e, onApply: t, onOpenAsFile: n, onClose: r }) {
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI edit", children: /* @__PURE__ */ d("section", { className: "workbench-edit-review", children: [
    /* @__PURE__ */ d("header", { className: "workbench-edit-review-head", children: [
      ...
      /* @__PURE__ */ a("button", { title: "Close", onClick: r, children: /* @__PURE__ */ a(Ye, { size: 16 }) })
    ] }),
...
function sc({ patch: e, onApply: t, onOpenAsFiles: n, onClose: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI workspace patch", children: /* @__PURE__ */ d("section", { className: "workbench-edit-review workspace", children: [
    ...
    /* @__PURE__ */ d("div", { className: "workbench-workspace-patch-list", children: [
      e.edits.map((i) => /* @__PURE__ */ d("article", { className: "workbench-workspace-patch-card", children: [
        ...
        /* @__PURE__ */ a("pre", { children: mc(i.proposedContent) })
      ] }, i.fileId)),
...
function oc(e, t) {
  ...
  if (e)
    n.push("", `Active file: ${e.path}`, `Language: ${e.language}`, `Dirty: ${e.dirty ? "yes" : "no"}`, "", "Active file content:", "```" + e.language, ic(e.content), "```");
  else if (t.length > 0) {
...
function Ar({
  ...
  const [c, h] = z([]), [p, v] = z([]), [y, w] = z(null), [m, A] = z(!1), [R, Z] = z(null), [F, ge] = z("Review the active Atomek context. Return concise findings. If you propose edits, output a unified diff or fenced replacement blocks so Atomek can preview before applying."), [we, j] = z(null), [_, q] = z([]), [M, be] = z(() => Hl()), [Y, ve] = z([]), [ue, He] = z([]), [We, je] = z([]), O = it([]), [oe, Pe] = z("task-execute"), [fe, g] = z("mission"), W = _.find((u) => u.status === "running" || u.status === "canceling") ?? _[0] ?? null, x = o === "dock", L = de(() => Nt(y, ot(F || M?.goal || "", y, M?.teamPresetId)), [F, M?.goal, M?.teamPresetId, y]), V = de(() => Mt(F || M?.goal || "", y, L.id), [F, M?.goal, L.id, y]), X = V.find((u) => u.id === oe) ?? V[1] ?? V[0] ?? null, ee = i.filter((u) => u.dirty).length, ae = s ? `${s.path} · ${s.language} · ${s.content.length.toLocaleString()} chars${s.dirty ? " · dirty" : ""}` : i.length > 0 ? `${i.length} open editor${i.length === 1 ? "" : "s"}${ee ? ` · ${ee} dirty` : ""}` : "No active file — jobs run with only your typed prompt.", le = de(() => [
    {
  ...
  const xe = N(async (u = M) => {
    if (!u?.rootPath || !e.missions?.listRuns)
      return je([]), [];
    try {
      const k = await e.missions.listRuns(u.rootPath);
      return je(k), O.current = k, k;
    } catch (k) {
      return t(`Mission run history failed: ${k instanceof Error ? k.message : String(k)}`), [];
    }
  }, [e.missions, M, t]), Ve = N(async (u, k) => {
    if (!u) return;
    const T = [...k].sort((C, E) => Xa(E).localeCompare(Xa(C))).slice(0, 100), H = T.map((C) => JSON.stringify(C)).join(`
`) + (T.length ? `
` : "");
    u.rootPath && e.missions?.write ? await e.missions.write({ rootPath: u.rootPath, files: [{ path: "RUNS.jsonl", content: H }] }) : u.handle && await Vn(u.handle, "RUNS.jsonl", H), je(T), O.current = T;
  }, [e.missions]), ze = N(async (u, k = M) => {
    if (!k) return;
    const T = [
      u,
      ...O.current.filter((H) => H.id !== u.id)
    ];
    await Ve(k, T);
  }, [M, Ve]), Ee = N(async () => {
    if (!e.local?.listTools && !e.skills?.list && !e.resources?.list) {
      h([]), v([]), w(null), Z("This Tytus host build does not expose local tools, resource graph, or skill registry yet.");
      return;
    }
    A(!0), Z(null);
    try {
      const [u, k, T, H] = await Promise.all([
        e.local?.listTools?.().catch((C) => (t(`Local tool discovery failed: ${C instanceof Error ? C.message : String(C)}`), [])) ?? Promise.resolve([]),
        e.skills?.list?.().catch((C) => (t(`Skill registry discovery failed: ${C instanceof Error ? C.message : String(C)}`), [])) ?? Promise.resolve([]),
        e.resources?.list?.().catch((C) => (t(`Resource graph discovery failed: ${C instanceof Error ? C.message : String(C)}`), null)) ?? Promise.resolve(null),
        e.missions?.list?.().catch((C) => (t(`Mission list failed: ${C instanceof Error ? C.message : String(C)}`), [])) ?? Promise.resolve([])
      ]);
      h(u), v(k), w(T), ve(H), M?.rootPath && xe(M), t(`Agent team loaded · ${u.length} tools · ${k.length} skills · ${H.length} missions${T ? ` · ${T.resources.length} resources` : ""}`);
    } catch (u) {
      Z(u instanceof Error ? u.message : String(u));
    } finally {
      A(!1);
    }
  ...
  re(() => {
    ...
    return window.addEventListener(Wn, u), () => window.removeEventListener(Wn, u);
  }, [Ee, xe]);
  const Je = N((u) => {
    const k = jl(u);
    be(k), St(k), xe(k), He([{
    ...
    }]), ge(u.goal || `Continue mission ${u.title}. Review MISSION.md, TASKS.md, RESOURCES.md, and runs/ before acting.`), t(`Resumed mission: ${u.rootPath}`);
  }, [xe, t]), ye = N(async (u, k, T = []) => {
    const H = [
      ...ue,
      ...T,
      { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.pack.write", message: "Mission context pack written from Atomek" }
    ], C = ot(k || u.goal, y, u.teamPresetId), E = Mt(k || u.goal, y, C), $ = [
      { path: "MISSION.md", content: an(u, y, s, i, k, C) },
      { path: "MISSION.json", content: xr(u, y, k, C) },
      { path: "RESOURCES.md", content: rn(y) },
      { path: "TASKS.md", content: kr(E) },
      { path: "HANDOFF.md", content: Pr(u) },
      { path: "INBOX.md", content: `# Mission inbox
...
` }
    ...
    if (u.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: u.rootPath, files: $ });
    else if (u.handle) {
      await bt(u.handle, "runs"), await bt(u.handle, "outputs"), await bt(u.handle, "proposals"), await bt(u.handle, "approvals");
      for (const U of $) await Xl(u.handle, U.path, U.content);
    } else
      throw new Error("Mission has neither tray rootPath nor browser folder handle");
    He(H), St(u);
  }, [s, e.missions, ue, i, y]), K = N(async (u, k = {}) => {
    if (M)
      return await ye(M, u), M;
    const T = `Atomek mission ${(/* @__PURE__ */ new Date()).toLocaleString()}`, H = u.trim() || "Coordinate Tytus resources for the current Atomek task.";
    let C = null;
    if (e.missions?.create) {
      ...
      C = {
        handle: $,
        name: $.name,
        missionId: `mission-${Date.now()}-${Sl($.name)}`,
        title: T,
        goal: H,
        source: "browser"
      };
    ...
    if (!C) return null;
    const E = { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.folder.ready", message: `Mission folder ready: ${C.rootPath ?? C.name}` };
    return be(C), St(C), He([E]), await ye(C, H, [E]), t(`Mission pack ready in ${C.rootPath ?? C.name}`), C;
  }, [e.missions, M, t, ye]), G = N(async (u) => {
    if (!e.local?.openTerminal) {
      t("Terminal bridge unavailable in this host build");
      return;
    }
    try {
      const k = F.trim() || `Open ${u.label} from Atomek with current context.`, T = u.kind === "ai-cli" ? await K(k) : M;
  ...
  }, [s, ae, K, e.local, F, M, t]), he = N(async () => {
    try {
  ...
  }, [K, F, t]), te = N(async (u, k, T, H = M, C) => {
    if (!H) return;
    const E = (/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-"), $ = C ?? `runs/${E}-${u.id}.md`, U = $.split("/").pop() || `${E}-${u.id}.md`;
    if (H.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: H.rootPath, files: [{ path: $, content: k }] });
    else if (H.handle) {
    ...
    await ye(H, F, [{
      ...
      message: `${u.label} exited ${T}; transcript saved to ${$}`,
      data: { toolId: u.id, exitCode: T, transcript: $ }
    }]);
  }, [e.missions, F, M, ye]), Ne = N(async (u) => {
    ...
    let T = null;
    try {
      T = await K(k), T && await ye(T, k, [{
        ts: (/* @__PURE__ */ new Date()).toISOString(),
        kind: "local-cli.run.start",
        message: `${u.label} background review started`,
        data: { toolId: u.id, taskId: X?.id ?? "manual", taskTitle: X?.title ?? "Manual run" }
      }]);
    } catch (E) {
    ...
    j(u.id);
    const H = `local-run-${Date.now()}-${u.id}`, C = mt();
    q((E) => [{
      id: H,
      toolId: u.id,
      label: u.label,
      ...
      lines: [`[Atomek] Starting ${u.label} local job for ${X?.title ?? "manual run"}…`]
    }, ...E].slice(0, 6));
    try {
...
`)
      }), $ = E.transcriptPath ?? (T?.rootPath ? `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${u.id}.md` : void 0), U = [
        `[Atomek] Started ${u.label} local job ${E.id}`,
        ...
        taskTitle: X?.title ?? "Manual run",
        transcriptPath: $,
        summary: `Started ${u.label} for ${X?.title ?? "manual run"}`
      };
      ze(ke, T).catch((B) => {
      ...
      e.local.streamJob(E.id, {
        onLog: (B) => {
          U.push(B), Ze((I) => ({ ...I, lines: U.slice(-500) }));
        },
        onDone: (B) => {
          B && (U.push(B), Ze((I) => ({ ...I, lines: U.slice(-500) })));
        },
        onFail: (B) => {
          U.push(`[FAIL] ${B}`), Ze((I) => ({
            ...I,
          ...
          }), r(`${u.label} local job failed`, U.join(`
`)), te(u, U.join(`
`), -1, T, $).catch((I) => {
...
`);
  ...
  }, [s, K, e.local, F, i, y, r, te, X, t, ze, ye]), Ie = N(async (u) => {
    const k = In(u);
    if (!k) {
      t(`Cannot dispatch ${Oe(u)}: missing pod id`);
      return;
    }
    const T = F.trim();
    if (!T) {
    ...
    let H = null;
    const C = Oe(u), E = `pod-run-${Date.now()}-${k}`, $ = mt(), U = `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${u.id.replace(/[^a-z0-9_.-]/gi, "-")}.md`;
    try {
      H = await K(T), H && await ye(H, T, [{
        ts: (/* @__PURE__ */ new Date()).toISOString(),
        kind: "pod-agent.run.start",
        message: `${C} mission task started`,
        data: { resourceId: u.id, podId: k, taskId: X?.id ?? "manual", taskTitle: X?.title ?? "Manual pod run" }
      }]);
    } catch (I) {
    ...
    const ke = {
      ...
      transcriptPath: U,
      summary: `Started ${C} for ${X?.title ?? "manual pod run"}`
    };
    q((I) => [{
      id: E,
      toolId: u.id,
      ...
      taskTitle: X?.title ?? "Manual pod run",
      transcriptPath: U,
      lines: [`[Atomek] Dispatching ${C} via Tytus host bridge…`, `[Atomek] Pod: ${k}`, `[Atomek] Task: ${X?.title ?? "manual pod run"}`]
    }, ...I].slice(0, 6)), await ze(ke, H).catch((I) => {
      t(`Mission run index failed: ${I instanceof Error ? I.message : String(I)}`);
    });
    const Ze = [], B = (I) => {
      Ze.push(I), q((se) => se.map((Le) => Le.id === E ? { ...Le, lines: [...Le.lines, I].slice(-500) } : Le));
    };
    try {
      const I = await e.daemon.callPodEndpoint(k, "/v1/models", { method: "GET" });
      if (!I.ok)
        throw new Error(`/v1/models ${I.status}: ${await I.text()}`);
      const se = await I.json(), Le = dc(se);
      if (!Le)
        throw new Error("pod /v1/models returned no model id");
      B(`[Atomek] Selected pod model from live metadata: ${Le}`);
      const Te = await e.daemon.callPodEndpoint(k, "/v1/chat/completions", {
        method: "POST",
...
`)
      ...
      const lt = typeof Fe == "string" ? Fe : uc(Fe);
      B(lt);
      const ct = [
        `# Pod job — ${C}`,
        "",
...
`);
      q((Tt) => Tt.map((Ge) => Ge.id === E ? { ...Ge, status: "complete", finishedAt: Date.now(), lines: [...Ge.lines, "[Atomek] Pod task complete."].slice(-500) } : Ge)), await ze({ ...ke, status: "complete", finishedAt: mt(), summary: `${C} completed`, transcriptPath: U }, H), r(`${C} pod job`, ct), await te({ id: u.id, label: C, kind: "pod-agent", status: u.status }, ct, 0, H, U), t(`${C} completed mission task`);
    } catch (I) {
      ...
      const Le = [`# Pod job failed — ${C}`, "", `- Pod: ${k}`, `- Error: ${se}`, "", "```text", Ze.join(`
`), "```", ""].join(`
`);
      r(`${C} pod job failed`, Le), await te({ id: u.id, label: C, kind: "pod-agent", status: u.status }, Le, -1, H, U).catch((Te) => {
        t(`Pod transcript save failed: ${Te instanceof Error ? Te.message : String(Te)}`);
      }), t(`Pod task failed: ${se}`);
    }
  }, [s, K, e.daemon, F, i, y, r, te, X, t, ze, ye]), De = N(async (u) => {
    if (!u.jobId || !e.local?.cancelJob) {
      t("Local job cancel bridge unavailable in this host build");
      return;
    }
    q((k) => k.map((T) => T.id === u.id ? { ...T, status: "canceling", lines: [...T.lines, "[Atomek] Cancel requested…"] } : T)), ze({
      id: u.id,
      jobId: u.jobId,
      toolId: u.toolId,
      label: u.label,
    ...
    try {
      ...
      q((T) => T.map((H) => H.id === u.id ? { ...H, status: "running", lines: [...H.lines, `[Atomek] Cancel failed: ${k instanceof Error ? k.message : String(k)}`] } : H)), t(`Local job cancel failed: ${k instanceof Error ? k.message : String(k)}`);
    }
  }, [e.local, t, ze]), ne = N(async (u) => {
    const k = [
      `Use Tytus resource "${Oe(u)}" (${u.kind}) for the next mission step.`,
...
`);
    ge(k), M && await ye(M, k, [{
      ...
      message: `Selected resource ${Oe(u)}`,
      data: { resourceId: u.id, kind: u.kind, status: u.status }
    }]), t(`Selected ${Oe(u)} for mission`);
  }, [M, t, ye]), me = N((u) => {
    const k = u.setupAction, T = k?.commandPreview ? `${k.label}: ${k.commandPreview}` : k?.deepLink ? `${k.label}: ${k.deepLink}` : k?.label ?? `${Oe(u)} needs setup`;
    t(T), Pt(k?.commandPreview ?? k?.deepLink ?? T);
  }, [t]);
  return /* @__PURE__ */ d("aside", { className: x ? "workbench-agent-dock" : "workbench-sidebar", children: [
    x ? null : /* @__PURE__ */ a("div", { className: "workbench-sidebar-title", children: "AGENT TEAM" }),
    /* @__PURE__ */ d("div", { className: x ? "workbench-agent-dock-scroll" : "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ d("div", { className: "workbench-computer-hero", children: [
        /* @__PURE__ */ a(Dn, { size: 18 }),
        /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ d("div", { className: "workbench-team-switcher", role: "tablist", "aria-label": "Atomek agent team views", children: [
        /* @__PURE__ */ a("button", { className: fe === "mission" ? "active" : "", onClick: () => g("mission"), children: "Mission" }),
        /* @__PURE__ */ a("button", { className: fe === "runs" ? "active" : "", onClick: () => g("runs"), children: "Runs" }),
        /* @__PURE__ */ a("button", { className: fe === "setup" ? "active" : "", onClick: () => g("setup"), children: "Setup" })
      ] }),
      fe === "mission" ? /* @__PURE__ */ d(Re, { children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-context-card mission", children: [
          ...
          /* @__PURE__ */ a("span", { children: M ? `${M.rootPath ?? M.name} · ${M.source} · ${ue.length} audit events · transcripts saved under runs/` : "Atomek creates this automatically before launching local agents. It is the shared folder agents read/write transcripts from." }),
        ...
        /* @__PURE__ */ d("div", { className: "workbench-team-assignment-list", children: [
          /* @__PURE__ */ d("div", { className: `workbench-team-assignment-summary ${L.readiness}`, children: [
          ...
          L.assignments.map((u) => /* @__PURE__ */ d("div", { className: "workbench-team-assignment-row", children: [
            /* @__PURE__ */ d("div", { children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-actions", children: [
          ...
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => M && void ye(M, F), disabled: !M, children: "Rewrite context files" })
        ] }),
        Y.length ? /* @__PURE__ */ d(Re, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RESUME MISSION" }),
          /* @__PURE__ */ a("div", { className: "workbench-mission-list", children: Y.slice(0, x ? 3 : 5).map((u) => /* @__PURE__ */ d(
            "button",
            {
        ...
        y?.warnings.length ? /* @__PURE__ */ a("div", { className: "workbench-resource-warnings", children: y.warnings.slice(0, 3).map((u) => /* @__PURE__ */ d("span", { children: [
          u.code,
          ": ",
          u.message
        ...
        /* @__PURE__ */ a("div", { className: "workbench-computer-presets", children: le.map((u) => /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => ge(u.prompt), children: u.label }, u.label)) }),
        /* @__PURE__ */ a(
          "textarea",
          {
        ...
        /* @__PURE__ */ a("div", { className: "workbench-task-graph", children: V.map((u, k) => /* @__PURE__ */ d(
          "button",
          {
            className: `workbench-task-card ${u.status} ${X?.id === u.id ? "active" : ""}`,
            onClick: () => {
              Pe(u.id), ge(u.prompt);
            },
      ...
      fe === "runs" ? /* @__PURE__ */ d(Re, { children: [
...
`) || "[waiting for output]" })
        ...
        We.length ? /* @__PURE__ */ d(Re, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RUN HISTORY" }),
          /* @__PURE__ */ a("div", { className: "workbench-run-history", children: We.slice(0, x ? 4 : 8).map((u) => /* @__PURE__ */ d("div", { className: "workbench-run-history-row", children: [
            /* @__PURE__ */ d("div", { children: [
            ...
            /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => void Pt(u.transcriptPath ?? u.id), title: "Copy transcript path or run id", children: "Copy path" })
          ] }, u.id)) })
        ] }) : null
      ] }) : null,
      fe === "setup" ? /* @__PURE__ */ d(Re, { children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-list compact", children: [
          !y && !m ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No resource graph reported yet. Older Tytus host builds need `/api/resources`." }) : null,
          y?.resources.slice(0, x ? 8 : 5).map((u) => /* @__PURE__ */ d("div", { className: "workbench-resource-row", children: [
            /* @__PURE__ */ d("div", { children: [
              /* @__PURE__ */ a("strong", { children: Oe(u) }),
              /* @__PURE__ */ a("span", { children: Qn(u) })
            ] }),
            /* @__PURE__ */ d("div", { className: "workbench-resource-row-actions", children: [
              ...
              u.kind === "pod-agent" && In(u) ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                Ie(u);
              }, children: "Ask pod" }) : null,
              u.status === "needs-setup" || u.setupAction ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => me(u), children: "Setup" }) : null
            ] })
          ] }, u.id))
        ] }),
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-list", children: [
          c.length === 0 && !m ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No local tools reported yet." }) : null,
          c.map((u) => /* @__PURE__ */ d("div", { className: "workbench-computer-card", children: [
            ...
            /* @__PURE__ */ d("div", { className: "workbench-computer-actions", children: [
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
                G(u);
              }, disabled: u.status !== "available", title: "Launch this tool in a fresh Tytus Terminal with mission context and execute it immediately.", children: lc(u) }),
              u.kind === "ai-cli" ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                Ne(u);
              }, disabled: u.status !== "available" || we !== null, title: "Run this local agent as a background read-only review inside Atomek and stream output here. It cannot write files directly.", children: cc(u, we) }) : null
            ] })
          ] }, u.id))
        ] }),
        /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "AGENTIC APP SKILLS" }),
        /* @__PURE__ */ d("div", { className: "workbench-computer-list", children: [
          p.length === 0 && !m ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No skills reported yet." }) : null,
          p.map((u) => /* @__PURE__ */ d("div", { className: "workbench-computer-card", children: [
            /* @__PURE__ */ d("div", { className: "workbench-computer-card-head", children: [
              /* @__PURE__ */ d("div", { children: [
                /* @__PURE__ */ a("strong", { children: u.title }),
                /* @__PURE__ */ d("span", { children: [
...
function fc({ status: e, file: t, cursor: n, fileCount: r, dirtyCount: s }) {
...
function Nc({ host: e }) {
  return /* @__PURE__ */ a(Ml, { host: e });
}
function Xc(e) {
  return function() {
    return /* @__PURE__ */ a(Nc, { host: e.host });
  };
}
export {
  Xc as default
