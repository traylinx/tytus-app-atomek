...
import { forwardRef as Ca, createElement as On, useState as z, useRef as it, useCallback as N, useEffect as re, lazy as rs, useMemo as de, Suspense as ss } from "react";
/**
 ...
 */
const is = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), os = (e) => e.replace(
  /^([A-Z])|[\s-_]+(\w)/g,
  (t, n, a) => a ? a.toUpperCase() : n.toLowerCase()
), da = (e) => {
  const t = os(e);
  return t.charAt(0).toUpperCase() + t.slice(1);
}, Sa = (...e) => e.filter((t, n, a) => !!t && t.trim() !== "" && a.indexOf(t) === n).join(" ").trim(), ls = (e) => {
  for (const t in e)
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const hs = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], ms = ie("check", hs);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const ps = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], an = ie("chevron-down", ps);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Js = /* @__PURE__ */ new Set([".git", "node_modules", "dist", "build", ".next", ".turbo", "coverage", ".cache"]);
function Zs() {
  const e = qn();
  return !!(e?.showOpenFilePicker && e.showDirectoryPicker);
}
async function Ks() {
  const e = qn()?.showOpenFilePicker;
  if (!e) return Ea(!1);
  const t = await e({ multiple: !0 }), n = await Promise.all(t.map((a) => Yn(a, a.name, "local-file")));
  return jt(n.filter(Boolean));
}
async function Us() {
  const e = qn()?.showDirectoryPicker;
  if (!e)
    return { name: "Browser fallback folder", files: await Ea(!0) };
  const t = await e({ mode: "readwrite" }), n = [];
  return await Jn(t, t.name, n, 0, 320), { name: t.name, handle: t, files: jt(n) };
}
async function Bs(e) {
  const t = await Promise.all(e.map((n) => Yn(n, n.name, "local-file")));
  return jt(t.filter(Boolean));
}
async function fa(e) {
  const t = [];
  return await Jn(e, e.name, t, 0, 320), { name: e.name, handle: e, files: jt(t) };
}
async function wn(e, t = "readwrite") {
  try {
...
async function Jn(e, t, n, a, s) {
  if (!(n.length >= s || a > 8))
    for await (const i of e.values()) {
      if (n.length >= s) break;
      if (i.kind === "directory") {
        if (Js.has(i.name)) continue;
        await Jn(i, `${t}/${i.name}`, n, a + 1, s);
        continue;
      }
      const o = i, c = await Yn(o, `${t}/${o.name}`, "local-folder");
      c && n.push(c);
    }
}
function Ea(e) {
...
const Ue = {
  ...
  available: !0
}, Qs = "atomek:selected-chat-target", on = {
  openclaw: "OpenClaw",
  hermes: "Hermes"
...
function $s(e) {
  try {
    return localStorage.getItem(Ja(e))?.trim() || Ue.id;
  } catch {
    return Ue.id;
  }
}
function ma(e, t) {
  try {
    localStorage.setItem(Ja(e), t || Ue.id);
  } catch {
  }
}
function gt(e, ...t) {
...
function _s(e) {
  ...
  return t || (e.id.match(/(?:pod-agent|ail-route)\.([^.]+)/)?.[1] ?? e.id);
}
function ei(e) {
...
function ti(e) {
  return e.kind !== "pod-agent" ? null : Za([
    e.label,
    e.id,
...
function ri(e, t) {
  ...
  if (n) {
    const a = Zn(n).replace(/\bNemoClaw\b/gi, "OpenClaw").replace(/\s+/g, " ").trim();
    if (ai(a)) return a;
  }
  return on[t];
}
...
function ii(e) {
  ...
  return e.map((i) => {
    ...
    const o = i.label, c = on[i.agentFamily];
    s[i.agentFamily] += 1;
...
function oi(e) {
  const t = e.daemon?.state, n = t?.included ?? [], a = t?.agents ?? [], s = new Map(a.map((o) => [o.id, o])), i = n.flatMap((o) => {
    const c = o.id ?? "", p = { ...(o.agentId ? s.get(o.agentId) : void 0)?.meta ?? {}, ...o.meta ?? {} }, v = Za([c, o.kind, gt(p, "displayName", "display_name", "agentFamily", "agentType", "brand")].join(" "));
    return !c || !v ? [] : [{
      id: `pod-agent.${c}`,
      kind: "pod-agent",
      label: on[v],
  ...
  return Ka({ generatedAt: (/* @__PURE__ */ new Date()).toISOString(), resources: i });
}
async function li(e, t) {
  ...
  const a = Ka(n), s = a.length > 0 ? [] : oi(e), i = /* @__PURE__ */ new Map();
  for (const o of [Ue, ...a, ...s]) i.set(o.id, o);
  return [...i.values()];
}
const et = "atomek:default", ci = 3e3, Kn = "tytus.atomek.threadTitleOverrides", Ua = "tytus.atomek.selectedThreadId", pa = {
  available: !1,
  source: "none",
...
}, di = (e, t = ci) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, ba = (e, t) => {
  const n = e.split(`
`).map((a) => a.replace(/^#+\s*/, "").trim()).find(Boolean);
  return n ? n.length > 80 ? `${n.slice(0, 77)}...` : n : t;
}, ui = (e) => ["briefing", "action-list", "quiz", "plan", "storyboard", "report", "local-draft", "markdown", "memory"].includes(e) ? e : "report", va = (e) => ({
  id: e.id,
  title: e.title,
  kind: ui(e.kind),
  body: e.body,
...
`)
  ...
  try {
    return localStorage.getItem(Ua)?.trim() || null;
  } catch {
    return null;
  }
}, at = (e) => {
...
}, Bn = (e) => `${et}:agent-session:${e}`, rn = (e) => `${et}:agent-transcript:${e}`, Ba = 100, bi = (e) => {
  try {
    return localStorage.getItem(Bn(e))?.trim() || null;
  } catch {
    return null;
  }
}, vi = (e, t) => {
  try {
    localStorage.setItem(Bn(e), t);
  } catch {
  }
}, Ft = (e, t) => {
  try {
    const n = localStorage.getItem(rn(e)), a = n ? JSON.parse(n) : [], s = /* @__PURE__ */ new Map();
    for (const i of [...a, ...t]) s.set(i.id, i);
    localStorage.setItem(rn(e), JSON.stringify([...s.values()].slice(-Ba)));
  } catch {
  }
}, yi = (e) => {
  try {
    const t = localStorage.getItem(rn(e));
    if (!t) return [];
    const n = JSON.parse(t);
    return Array.isArray(n) ? n.filter(
      (a) => a && typeof a == "object" && a.role !== void 0 && typeof a.body == "string"
    ).slice(-Ba) : [];
  } catch {
    return [];
  }
  ...
  try {
    localStorage.removeItem(rn(e)), localStorage.removeItem(Bn(e));
  } catch {
  }
}, wi = (e) => {
  const t = e.daemon;
...
function xi({ host: e, requestContext: t, chatSettings: n, selectedTarget: a = Ue, setStatus: s }) {
  const i = e.ai, [o, c] = z(null), [h, p] = z([]), [v, y] = z([]), [w, m] = z([]), [A, R] = z([]), [Z, F] = z(pa), [ge, we] = z(!1), j = it(!0), _ = it(null), q = N(async () => {
    ...
    if (i)
      try {
        const x = ya(await i.listThreads({ workspaceKey: et, status: "active" })), L = pi(), V = x.find((ee) => ee.id === L) ?? x[0] ?? await i.createThread({ workspaceKey: et, title: "Atomek chat" });
        if (!j.current) return;
  ...
  const ue = N(async () => {
    ...
    if (a.kind === "pod-agent") {
      gi(a.podId), y([]), R([]), s(`Cleared ${a.label} chat`);
      return;
    }
    if (!i) return;
    const x = await i.createThread({ workspaceKey: et, title: "Atomek chat" });
    ...
    if (V)
      try {
        ...
        typeof X != "function" && hi(x, V), p((le) => le.map((xe) => xe.id === ae.id ? ae : xe)), c((le) => le?.id === ae.id ? ae : le), s(typeof X == "function" ? `Renamed chat: ${ae.title}` : `Renamed chat locally: ${ae.title}`);
      } catch (X) {
    ...
    try {
      ...
      if (X.kind === "pod-agent") {
        ...
        if (y((ne) => [...ne, he, Ne]), Ft(X.podId, [he, Ne]), !X.available) {
          const ne = ha(X.description), me = { ...Ne, body: ne.message, status: "error", error: ne.message };
          return y((u) => u.map((k) => k.id === te ? me : k)), Ft(X.podId, [me]), s(ne.message), me;
        }
        if (!K) {
          ...
          return y((u) => u.map((k) => k.id === te ? me : k)), Ft(X.podId, [me]), s("Agent chat bridge unavailable"), me;
        }
        let Ie = "";
        const De = (ne, me) => (y((u) => u.map((k) => k.id === te ? ne : k)), Ft(X.podId, [he, ne]), s(me), ne);
        try {
          for await (const ne of K.chatAgent({
            podId: X.podId,
            routeId: X.routeId ?? null,
            sessionId: bi(X.podId),
            message: Pi(V, le),
            mode: "operator",
            target: "agent",
            ...
            if (ne.type === "session" && vi(X.podId, ne.sessionId), ne.type === "token" && (Ie = Zn(`${Ie}${ne.text}`), y((me) => me.map((u) => u.id === te ? { ...u, body: Ie, status: "streaming" } : u))), ne.type === "error") {
      ...
      if (!xe || !i) return null;
      at(xe.id);
      const Ve = await fe(V).catch(() => []), ze = fi(Ve), Ee = ze ? [...le, ze] : [...le];
      let Je = null;
  ...
  }, [i, n.gatewayPreference, n.model, ue, e, fe, q, t, a, s]), W = N(() => {
...
const Ni = (e) => `tytus-workbench:///${encodeURI(e.path)}`, Ti = (e) => {
  let t = 2166136261;
  for (let n = 0; n < e.length; n += 1)
    t ^= e.charCodeAt(n), t = Math.imul(t, 16777619);
  return (t >>> 0).toString(16).padStart(8, "0");
}, zi = ({ files: e, openEditorIds: t, activeFileId: n, versions: a, activeSelection: s }) => {
...
}, Xi = "active-file", Li = (e) => e === "none" ? "No context" : e === "active-selection" ? "Active selection" : e === "active-file" ? "Active file" : e === "open-editors" ? "Open editors" : e === "selected-files" ? "Selected files" : "Indexed project", Ai = (e, t = "file") => `${t}:${e.id}`, Oi = (e, t) => [
  "selection",
  e.id,
  t.startLineNumber,
  t.startColumn,
...
[...clipped ${e.length - t} chars...]`, Ii = (e, t, n) => {
  ...
  for (const o of a) {
    ...
    const p = [
      ...
      o.range ? `Range: ${ga(o.range)}` : null
    ].filter(Boolean).join(`
`), v = o.kind === "selection" && o.range ? Di(c.content, o.range) : c.content, y = o.kind === "selection" ? ji : o.label.startsWith("Open editor") ? Wi : Mi;
    s.push({
...
`));
}, ga = (e) => `${e.startLineNumber}:${e.startColumn}-${e.endLineNumber}:${e.endColumn}`, wa = 75e4, Fi = 2800, Ri = 240, Ei = 80, qi = /* @__PURE__ */ new Set([
  ".git",
  ".hg",
  ".svn",
  ".next",
  ...
  return n === 0 || e.content.length === 0 ? "empty" : n > (t.maxFileBytes ?? wa) || e.content.length > (t.maxFileBytes ?? wa) ? "huge" : !t.includeDirty && e.dirty ? null : Gi(e.path) ? "vendor" : Qi(e) ? "binary" : null;
}, ka = (e, t = {}) => {
  const n = Date.now(), a = [], s = [], i = [];
  for (const o of e) {
    const c = o.size ?? o.content.length, h = Sn(o, t);
    if (h) {
      s.push({ fileId: o.id, name: o.name, path: o.path, language: o.language, reason: h, size: c });
      continue;
    }
    const p = st(o.content), v = Ji(o, p, n, t);
    i.push(...v), a.push({
      fileId: o.id,
      name: o.name,
      path: o.path,
...
}, Ji = (e, t = st(e.content), n = Date.now(), a = {}) => {
  const s = Math.max(500, a.maxChunkChars ?? Fi), i = Math.min(Math.max(0, a.chunkOverlapChars ?? Ri), Math.floor(s / 2)), o = Math.max(1, a.maxChunksPerFile ?? Ei), c = Ui(e.content), h = [];
  let p = 0, v = 0;
  for (; p < e.content.length && h.length < o; ) {
    const y = Ki(e.content, p, Math.min(e.content.length, p + s)), w = e.content.slice(p, y).trim();
    if (w.length > 0) {
      const m = Bi(c, p, y);
      h.push({
...
` && t.push(n + 1);
  ...
  const a = Pa(e, t), s = Pa(e, Math.max(t, n - 1));
  return {
    startLineNumber: a + 1,
    startColumn: t - e[a] + 1,
    endLineNumber: s + 1,
  ...
  return 0;
}, Gi = (e) => e.split(/[\\/]+/).filter(Boolean).some((t) => qi.has(t)), Qi = (e) => {
  const t = e.name.includes(".") ? e.name.split(".").pop()?.toLowerCase() : void 0;
  if (t && Yi.has(t) || e.content.includes("\0")) return !0;
...
class $i {
  ...
  options;
  constructor(t = [], n = {}) {
    this.options = { ...n }, this.snapshot = ka(t, this.options);
  }
  getSnapshot() {
  ...
  refresh(t, n = this.options) {
    return this.options = { ...n }, this.snapshot = ka(t, this.options), this.snapshot;
  }
  update(t, n = this.options) {
    return this.refresh(t, n);
  }
  staleReport(t) {
    return _i(this.snapshot, t, this.options);
  }
  isStale(t) {
    return this.staleReport(t).stale;
  }
}
const ht = (e = [], t = {}) => new $i(e, t), _i = (e, t, n = {}) => {
  ...
  for (const c of t)
    !s.has(c.id) && !Sn(c, n) && i.push({ fileId: c.id, path: c.path, status: "new", currentHash: st(c.content) });
  const o = e.signature !== Ga(t);
  return { stale: i.length > 0, signatureChanged: o, files: i };
}, eo = 8, to = 12e3, Qa = (e, t, n = {}, a) => {
  const s = ro(t);
  if (s.length === 0) return [];
  const i = new Set(a?.files.map((v) => v.fileId) ?? []), o = e.chunks.filter((v) => n.includeDirty !== !1 || !v.dirty).map((v) => so(v, s)).filter((v) => v.score >= (n.minScore ?? 1)).sort((v, y) => y.score - v.score || v.chunk.path.localeCompare(y.chunk.path) || v.chunk.ordinal - y.chunk.ordinal), c = [], h = /* @__PURE__ */ new Set();
  let p = n.maxChars ?? to;
  for (const v of o) {
    if (c.length >= (n.limit ?? eo) || p <= 0) break;
...
[...context clipped...]` : v.chunk.text;
    c.push(no(v, w, i.has(v.chunk.fileId))), p -= w.length;
  }
  return c;
...
`), ro = (e) => Array.from(new Set(
  ...
  const c = [];
  for (const h of t) {
    const p = Pn(n, h), v = Pn(a, h), y = Pn(s, h), w = i === h ? 1 : 0;
  ...
  const h = N((w = s.current) => {
    const m = (i.current ?? ht([], a)).refresh(w, a);
    return c(m), m;
  }, [a.maxFileBytes, a.maxChunkChars, a.chunkOverlapChars, a.maxChunksPerFile, a.includeDirty]), p = N((w = s.current) => {
    const m = (i.current ?? ht([], a)).update(w, a);
    return c(m), m;
  }, [h]);
  re(() => {
    n && h(e);
  }, [n, e, h]);
  const v = (i.current ?? ht([], a)).staleReport(e), y = N((w, m = {}) => {
    const A = i.current ?? ht([], a);
    return Qa(A.getSnapshot(), w, m, A.staleReport(s.current));
  }, []);
  return { snapshot: o, staleReport: v, isStale: v.stale, refresh: h, update: p, retrieve: y };
}, lo = "tytus.atomek.semanticVector:v1", $a = "__gateway_default__", _a = (e) => e?.trim() || $a, co = (e) => {
  const t = _a(e);
  return t === $a ? "gateway default" : t;
}, er = (e, t, n) => [
  lo,
  ...
  if (!tr()) return null;
  try {
    const a = er(e, t, n), s = window.localStorage.getItem(a);
    if (!s) return null;
  ...
  if (!tr()) return null;
  try {
    const t = er(e.appId, e.modelAlias, { id: e.chunkId, hash: e.contentHash }), n = { ...e, key: t };
    return window.localStorage.setItem(t, JSON.stringify(n)), n;
  } catch {
    return null;
  }
}, At = 8, ho = 12e3, mo = 180, po = async (e, t, n, a, s = {}, i, o) => {
  const c = Qa(t, n, { ...s, limit: Math.max(s.limit ?? At, 16) }, i), h = e.ai;
  ...
  try {
    const p = _a(a.embeddingModel), v = await h.embedText({
      input: n,
    ...
    const w = new Map(c.map((j) => [j.chunkId, j])), m = Po(n), A = /* @__PURE__ */ new Map();
    t.chunks.filter((j) => s.includeDirty !== !1 || !j.dirty).slice(0, mo).forEach((j) => A.set(j.id, j)), c.forEach((j) => {
    ...
    for (const j of R) {
      o?.aborted;
      const _ = uo(e.appId, p, j) ?? await vo(h, e.appId, p, j, a, o);
      if (!_) continue;
      _.updatedAt > Date.now() - 1e3 && (F += 1);
      const q = wo(y, _.vector);
      if (!Number.isFinite(q)) continue;
      const be = w.get(j.id)?.score ?? xo(j, m), Y = ko(be) * 0.42 + Math.max(0, q) * 0.58;
    ...
    const ge = new Set(i?.files.map((j) => j.fileId) ?? []), we = Z.sort((j, _) => _.score - j.score || _.keywordScore - j.keywordScore || j.chunk.path.localeCompare(_.chunk.path) || j.chunk.ordinal - _.chunk.ordinal).slice(0, Math.max(s.limit ?? At, 1)).map((j) => yo(j, ge.has(j.chunk.fileId)));
    return {
      hits: go(we, s.maxChars ?? ho),
      mode: "hybrid",
      reason: `Hybrid retrieval used ${co(a.embeddingModel)} embeddings + keyword ranking.`,
      embeddedChunks: F
    };
  } catch (p) {
    return {
  ...
  return {
    ...
    text: e.chunk.text,
    snippet: No(e.chunk.text, e.matchedTerms),
    score: e.score,
...
}, ko = (e) => Math.min(1, Math.max(0, e / 24)), Po = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), xo = (e, t) => {
  const n = `${e.path}
${e.name}
...
}, To = /```([^\n`]*)\n([\s\S]*?)```/g, zo = /^@@\s+-(\d+)(?:,\d+)?\s+\+(\d+)(?:,\d+)?\s+@@/;
function Gn(e) {
  return Array.from(e.matchAll(To)).map((t) => ar(t[1] ?? "", Co(t[2] ?? ""))).filter((t) => t.content.trim().length > 0);
}
function ar(e, t) {
  const n = e.trim().split(/[\s,]+/).filter(Boolean), a = {}, s = [];
  for (const i of n) {
    const o = i.match(/^([a-z0-9_-]+)=(.+)$/i);
    o ? a[o[1].toLowerCase()] = Ho(o[2]) : s.push(i.toLowerCase());
  }
...
function rr(e) {
  return [...Gn(e).filter((a) => Me(a, "diff") || Me(a, "patch")).map((a) => a.content), e].filter((a, s, i) => Xo(a) && i.findIndex((o) => o === a) === s);
}
function Xo(e) {
...
`);
    /^@@\s+-\d+/m.test(v) && i.push({ raw: v, ...xn(v) });
  }
  return i.length > 0 ? i : [{ raw: t, ...xn(t) }];
}
function xn(e) {
  const t = e.match(/^diff --git\s+(?:"?a\/(.+?)"?|(\S+))\s+(?:"?b\/(.+?)"?|(\S+))/m), n = e.match(/^---\s+(?:"?a\/(.+?)"?|(\S+))/m), a = e.match(/^\+\+\+\s+(?:"?b\/(.+?)"?|(\S+))/m), s = Be(t?.[1] || t?.[2] || n?.[1] || n?.[2] || "") || null, i = Be(t?.[3] || t?.[4] || a?.[1] || a?.[2] || "") || null, o = i && i !== "/dev/null" ? i : s;
...
function Hn(e) {
  return Gn(e).filter((t) => Ao(t)).map((t) => ({
    content: So(t.content),
...
function jo(e) {
  ...
  for (const v of rr(t))
    for (const y of Lo(v)) {
      ...
      const m = jn(w.file.content, y.raw);
  ...
  for (const v of Hn(t)) {
    const y = v.path ? xa(n, v.path) : s ? { file: s, normalizedPatchPath: Be(s.path), confidence: "exact" } : null;
    if (!y) {
...
function xa(e, t) {
  const n = Be(t), a = n.split("/").at(-1) ?? n, s = e.find((c) => Be(c.path) === n);
  ...
  const o = e.find((c) => c.name === a || Be(c.path).endsWith(`/${a}`));
...
function Et(e) {
  ...
  return {
    ...
    stats: Wo(e.file.content, e.proposedContent),
    base: {
...
const ln = (e) => typeof e == "object" && e !== null, Fo = (e) => ln(e.ai) ? e.ai : null, Ro = (e) => {
  if (!ln(e)) return null;
  const t = e.id;
  return typeof t == "string" && t.trim() ? t : null;
}, Eo = (e) => {
  const t = Ro(e);
  return !t || !ln(e) ? null : { ...e, id: t };
}, qe = (e) => typeof e == "string" ? /\bembeddings?\b|text-embedding/i.test(e) : Array.isArray(e) ? e.some(qe) : ln(e) ? Object.values(e).some(qe) : !1, qo = async (e, t) => {
  const n = Fo(e);
  if (typeof n?.listModels != "function") return [];
  const a = await n.listModels(t);
  return Array.isArray(a) ? a.map(Eo).filter((s) => !!s) : [];
}, Yo = (e) => (e.embedding ?? e.embeddings ?? e.supportsEmbedding ?? e.supportsEmbeddings) === !0 ? !0 : qe(e.capability) || qe(e.capabilities) || qe(e.modality) || qe(e.modalities) || qe(e.task) || qe(e.tasks) || qe(e.type) || qe(e.kind), ir = (e) => typeof e == "object" && e !== null, Jo = (e) => ir(e.ai) ? e.ai : null, or = (e) => typeof Jo(e)?.embedText == "function", Zo = async (e, t) => or(e) ? (await qo(e, t)).filter(Yo) : [], Ko = (e) => ir(e.ai) ? or(e) ? null : "host.ai.embedText is not exposed by this Tytus build." : "host.ai is not available in this Tytus build.", Uo = ["typecheck", "test", "lint", "build", "release:check", "verify", "verify:cortex"], Bo = [
...
function _o(e) {
  const t = e.results.length > 0 ? e.results.map((a, s) => [
    ...
    `Status: ${a.status}`,
    "Output:",
    ol(a.output || "(no output pasted)", "text")
  ].join(`
`)).join(`
...
function tl(e) {
  ...
  for (const a of t) {
    const s = nl(a.content);
    if (!s?.scripts) continue;
    const i = cr(a.path), o = al(e, i, s);
    if (!o) continue;
    const c = Object.keys(s.scripts).filter((p) => typeof s.scripts?.[p] == "string"), h = rl(c);
    for (const p of h) {
      const v = `${o} run ${p}`;
      n.push({
        id: dr(`${i}:${v}`),
...
function al(e, t, n) {
  ...
  for (const [a, s] of Bo)
    if (e.some((i) => il(i.path) === a && cr(i.path) === t)) return s;
  return null;
}
function rl(e) {
  const t = Uo.filter((a) => e.includes(a)), n = e.filter((a) => !t.includes(a)).filter((a) => /(^|:)(check|typecheck|test|lint|verify|build)(:|$)/i.test(a)).sort((a, s) => a.localeCompare(s));
  return [...t, ...n];
}
function sl(e) {
  const t = /* @__PURE__ */ new Set();
...
function fl({ className: e }) {
  return /* @__PURE__ */ r("img", { src: ul, alt: "ATOMEK", className: e, draggable: !1 });
}
const hl = `# Tytus Resource Fabric
...
], gl = "tytus-atomek-handles", wt = "handles", wl = 1, fr = () => new Promise((e, t) => {
  const n = indexedDB.open(gl, wl);
  n.onupgradeneeded = () => {
    const a = n.result;
...
async function Nn(e) {
  const t = await fr(), n = await new Promise((a, s) => {
...
const kl = rs(() => import("./WorkbenchMonacoEditor-CJhaNTZX.js").then((e) => e.W).then((e) => ({ default: e.WorkbenchMonacoEditor }))), Pl = {
  id: "welcome",
  name: "Agent Team",
  path: "Agent Team",
  language: "text",
  ...
  dirty: !1,
  source: "sample"
}, hr = "tytus.workspace.recent", mr = "tytus.workspace.layout", pr = "tytus.atomek.session.v2", br = "tytus.atomek.chatAiSettings", Tn = "atomek:default", vr = "tytus.atomek.currentMission", Mn = "tytus.atomek.currentMissionChanged", Ta = "0.4.26", en = {
...
function xt(e, t = "repo-repair") {
  const n = St.find((Y) => Y.id === t) ?? St[0], a = e?.resources ?? [], s = rt(a, (Y) => Y.kind === "pod-agent" && Pt(Y) === "openclaw"), i = rt(a, (Y) => Y.kind === "pod-agent" && Pt(Y) === "hermes"), o = rt(a, (Y) => Y.kind === "ail-route"), c = rt(a, (Y) => Y.kind === "shared-folder"), h = Ke(a, "local-cli", ["claude"]), p = Ke(a, "local-cli", ["opencode", "open code"]), v = Ke(a, "local-cli", ["codex"]), y = Ke(a, "local-cli", ["pi"]), w = Ke(a, "local-cli", ["kimi"]), m = rt(a, (Y) => Y.kind === "local-cli"), A = Ke(a, "app-skill", ["juli3ta", "music", "song"]), R = Ke(a, "app-skill", ["blender", "3d"]), Z = Ke(a, "app-skill", ["remotion", "video", "render"]), F = rt(a, (Y) => Y.kind === "app-skill"), ge = t === "pod-local" ? s ?? i ?? o ?? h ?? m : t === "creative-production" ? i ?? o ?? h ?? m : t === "research-watch" ? s ?? o ?? i ?? h ?? m : h ?? p ?? o ?? m, we = t === "creative-production" ? A ?? R ?? Z ?? F ?? p ?? h ?? m : p ?? h ?? v ?? m, j = t === "pod-local" ? v ?? y ?? w ?? s ?? h ?? m : t === "research-watch" ? y ?? w ?? v ?? s ?? m : v ?? y ?? s ?? w ?? m, _ = t === "creative-production" ? A ?? R ?? Z ?? F : t === "research-watch" ? Ke(a, "app-skill", ["browser", "channel", "telegram"]) ?? F : F, q = [
...
function ot(e, t, n) {
  if (n && St.some((s) => s.id === n)) return n;
  const a = e.toLowerCase();
  return /(music|song|audio|video|render|blender|remotion|juli3ta|creative)/.test(a) ? "creative-production" : /(research|watch|monitor|news|summar|scan)/.test(a) ? "research-watch" : (t?.resources ?? []).some((s) => s.kind === "pod-agent" && gr(s)) ? "pod-local" : "repo-repair";
}
function Ol(e) {
  return St.map((t) => xt(e, t.id));
}
function Jt(e) {
...
function Ct(e) {
  ...
  try {
    localStorage.setItem(vr, JSON.stringify(t)), window.dispatchEvent(new CustomEvent(Mn, { detail: t }));
  } catch {
  }
}
function Sl() {
  try {
    ...
    return !t.missionId || !t.title ? null : {
      ...
      teamPresetId: St.some((n) => n.id === t.teamPresetId) ? t.teamPresetId : void 0
    };
  } catch {
    return null;
  }
...
function Ht(e, t, n) {
  const a = e.trim() || "Coordinate a Tytus mission.", s = xt(t, ot(a, t, n)), i = (y) => s.assignments.find((w) => w.role === y), o = i("planner"), c = i("implementer"), h = i("reviewer"), p = i("team-desk"), v = i("app-tool");
  return [
    {
      id: "task-scope",
...
function jl({ host: e }) {
  const t = it(null), [n, a] = z(0), s = de(() => kc(), []), i = de(() => bc(), []), o = de(() => pc(mc(), i.recent), [i.recent]), [c, h] = z(i.activity ?? "computer"), [p, v] = z(s.primaryVisible), [y, w] = z(s.primaryWidth), [m, A] = z(i.secondaryTab ?? "chat"), [R, Z] = z(s.secondaryVisible), [F, ge] = z(s.secondaryWidth), [we, j] = z(!!i.bottomPanelVisible), [_, q] = z(i.bottomPanelTab ?? "problems"), [M, be] = z(s.markdownPreviewVisible), [Y, ve] = z(!!i.welcomeClosed), [ue, He] = z(i.folder ? { name: i.folder.name, files: [] } : null), [We, je] = z(i.folder?.handleKey ?? null), [O, oe] = z(() => vc(i.files)), [Pe, fe] = z(() => (i.openEditorIds ?? []).filter((l) => (i.files ?? []).some((f) => f.id === l))), [g, W] = z(() => i.activeFileId && (i.files ?? []).some((l) => l.id === i.activeFileId) ? i.activeFileId : null), [x, L] = z(i.query ?? ""), [V, X] = z({ lineNumber: 1, column: 1 }), [ee, ae] = z(null), [le, xe] = z({}), [Ve, ze] = z(Xi), [Ee, Je] = z([]), [ye, K] = z([]), [G, he] = z(null), [te, Ne] = z(i.chatInput ?? ""), [Ie, De] = z(!1), [ne, me] = z(""), [u, k] = z([]), [T, H] = z(null), [C, E] = z(null), [$, U] = z(!1), [ke, Ze] = z(() => Pc()), [B, I] = z([Ue]), [se, Le] = z(() => $s(Tn)), [Te, Ae] = z(null), [Fe, lt] = z(null), [ct, Nt] = z(""), [Ge, cn] = z(""), [Mt, Wt] = z(""), [Vt, _n] = z("failed"), [Or, ea] = z(null), [Cr, S] = z("Ready"), [Tt, Sr] = z(() => o), Ce = Pe.map((l) => O.find((f) => f.id === l)).filter(Boolean), D = g ? O.find((l) => l.id === g) ?? null : null, ta = de(() => zi({ files: O, openEditorIds: Pe, activeFileId: g, versions: le, activeSelection: ee }), [g, ee, le, O, Pe]), na = de(() => ({
    scope: Ve,
    removedAttachmentIds: Ee,
    selectedFileIds: []
  }), [Ve, Ee]), zt = de(() => Ii(ta, O, na), [na, ta, O]), Qe = oo(O, { autoRefresh: !0, includeDirty: !0 }), aa = de(() => ye.map((l) => ({
    id: l.id,
    kind: "index-hit",
    label: l.label,
    path: l.path,
    ...
    snippet: l.snippet
  })), [ye]), Hr = de(() => [...zt.attachments, ...aa], [zt.attachments, aa]), ra = de(() => B.find((l) => l.id === se) ?? Ue, [B, se]), Q = xi({ host: e, requestContext: zt.parts, chatSettings: ke, selectedTarget: ra, setStatus: S }), tt = de(
    () => [...Q.artifacts, ...u].sort((l, f) => f.createdAt - l.createdAt),
    [Q.artifacts, u]
  ), It = $ && !D, dn = !D && !It && !Y, Xe = de(() => O.filter((l) => l.dirty), [O]), jr = de(() => {
  ...
  const Mr = N((l) => {
    ...
    Le(f.id), ma(Tn, f.id), S(`Chat target: ${f.label}`);
  }, [B, S]), Wr = N((l) => {
    if (l.kind === "index-hit") {
    ...
    const f = zn(n), b = l.clientX, P = F, J = (nt) => {
      const gn = P + (b - nt.clientX);
      ge(Yt(gn, f.secondaryMin, f.secondaryMax));
    }, ce = () => {
    ...
    l.preventDefault(), l.currentTarget.setPointerCapture?.(l.pointerId);
    const f = zn(n), b = l.clientX, P = y, J = (nt) => {
      const gn = P + (nt.clientX - b);
      w(Yt(gn, f.primaryMin, f.primaryMax));
    }, ce = () => {
      window.removeEventListener("pointermove", J), window.removeEventListener("pointerup", ce);
    };
    window.addEventListener("pointermove", J), window.addEventListener("pointerup", ce);
    ...
    Sr((f) => {
      ...
      return localStorage.setItem(hr, JSON.stringify(b)), b;
    });
  }, []), pe = N((l, f) => {
    ...
    oe((b) => Zt(b, [f])), pe(f), A("chat"), Z(!0), be(!0), S(`Opened Atomek guide: ${l.title}`);
  }, [pe]), Fr = N((l) => {
    if (!l.fileId) return;
    const f = O.find((b) => b.id === l.fileId);
    f && (pe(f, l.range?.startLineNumber ?? 1), S(`Revealed context: ${l.label}`));
  }, [O, pe]), Xt = N(async () => {
    if (Xn(Xe, "open new files"))
      try {
        const l = await Ks();
        if (l.length === 0) return;
        oe((f) => Zt(f, l)), await Promise.all(l.map(async (f) => {
          const b = f.handle ? `file:${f.path}` : void 0;
          f.handle && b && await Na(b, f.handle), $e({ name: f.name, path: f.path, kind: "file", handleKey: b, at: Date.now() });
        })), pe(l[0]), S(`Opened ${l.length} local file${l.length === 1 ? "" : "s"}`);
      } catch (l) {
        l.name !== "AbortError" && S(`Open file failed: ${l.message}`);
      }
  }, [Xe, pe, $e]), un = N(async () => {
    if (Xn(Xe, "open another folder"))
      try {
        const l = await Us(), f = l.handle ? `folder:${l.name}:${Date.now()}` : null;
        l.handle && f && await Na(f, l.handle), je(f), He(l), oe(l.files), fe([]), W(null), ve(!1), $e({ name: l.name, path: l.name, kind: "folder", handleKey: f ?? void 0, at: Date.now() }), S(`${l.handle ? "Opened local folder" : "Opened browser fallback folder"} ${l.name} (${l.files.length} text files indexed)`);
      } catch (l) {
    ...
    try {
      const f = await Promise.all(l.map((P) => kn(P))), b = new Map(f.map((P) => [P.id, P]));
    ...
    Xn(Xe, "close all editors") && (fe([]), W(null), ea(null), ve(!1), S("Closed all editors"));
  }, [Xe]), mn = N(() => {
...
`,
  ...
  }, [D, Q, _e, Ce.length]), bn = N(async (l) => {
    if (l.kind === "folder") {
      const b = O.filter((P) => P.path === l.path || P.path.startsWith(`${l.path}/`));
      if (ue?.name === l.name || b.length > 0) {
        b.length > 0 && (He((P) => P?.name === l.name ? P : { name: l.name, files: b }), oe((P) => Zt(P, b))), h("explorer"), v(!0), W(null), ve(!1), $e({ ...l, at: Date.now() }), S(`Opened recent folder ${l.name}`);
        return;
      }
    }
    ...
    try {
      if (l.kind === "folder") {
        const J = await Nn(l.handleKey);
        if (!J || !await wn(J, "readwrite")) {
      ...
      const b = await Nn(l.handleKey);
      if (!b || !await wn(b, "readwrite")) {
      ...
      oe((J) => Zt(J, P)), pe(P[0]), $e({ ...l, at: Date.now() }), S(`Reopened ${P[0].name}`);
    } catch (b) {
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek memory",
    ...
    const f = An(O, Ln(l.title || l.kind)), b = {
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek edit", P.body) || S("Edit request answered without a patch. Use Generate patch / Edit to request an applicable diff.");
    ...
    Wt(b), Nt(""), cn(""), _n("failed"), j(!0), q("terminal"), S(f.commands.length > 0 ? `Manual check ready: copy ${f.commands[0].command}` : "Manual check ready: enter a check command to copy");
  }, [O]), Gr = N((l) => {
    l.trim() && (kt(l), Wt(l), S(`Manual check command copied: ${l}`));
  }, []), Qr = N(() => {
    lt((l) => {
      if (!l) return l;
      const f = Qo(l, ct), b = f.commands.at(-1)?.command ?? "";
      return b && Wt(b), f;
    }), Nt("");
  }, [ct]), $r = N(() => {
    if (!Fe || !Mt.trim()) {
    ...
    const l = Mt.trim();
    lt((f) => f && $o(f, l, Vt, Ge)), cn(""), S(`Captured manual check result: ${l} (${Vt})`);
  }, [Ge, Mt, Fe, Vt]), _r = N(() => {
    Fe && Se(_o(Fe));
  }, [Se, Fe]), es = N(() => {
    if (!T) return;
    ...
    l.content !== T.originalContent && !window.confirm(`${T.fileName} changed after the preview was created. Apply the AI edit anyway?`) || (oe((f) => f.map((b) => b.id === T.fileId ? { ...b, content: T.proposedContent, dirty: !0 } : b)), dt(T.fileId), Ae(`AI edit applied to ${l.name}. Save All to persist it to disk.`), H(null), Lt(`AI edit applied to ${l.name}`), S(`Applied AI edit to ${l.name} — unsaved; manual check ready`));
  }, [dt, O, T, Lt]), ts = N(() => {
    if (!T) return;
    const l = An(O, `${Ln(T.fileName)}-ai-edit`), f = {
    ...
    })), l.forEach((b, P) => dt(P)), Ae(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}. Save All to persist changes.`), E(null), Lt(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}`), S(`Applied AI workspace patch to ${l.size} file${l.size === 1 ? "" : "s"} — unsaved; manual check ready`));
  }, [dt, O, C, Lt]), as = N(() => {
    if (!C) return;
    const l = [...O], f = C.edits.map((b) => {
      const P = An(l, `${Ln(b.fileName)}-ai-edit`), J = O.find((nt) => nt.id === b.fileId), ce = {
  ...
  return re(() => {
    const l = (f) => {
      (f.metaKey || f.ctrlKey) && (f.key.toLowerCase() === "o" && (f.preventDefault(), Xt()), f.key.toLowerCase() === "s" && (f.preventDefault(), fn()), f.key.toLowerCase() === "w" && (f.preventDefault(), g && hn(g)), f.key.toLowerCase() === "b" && (f.preventDefault(), v((P) => !P)), f.shiftKey && f.key.toLowerCase() === "f" && (f.preventDefault(), h("search"), v(!0)), (f.key.toLowerCase() === "k" || f.key.toLowerCase() === "p") && (f.preventDefault(), De(!0)));
    };
    ...
    if (!n) return;
    const l = zn(n);
    w((f) => Yt(f, l.primaryMin, l.primaryMax)), ge((f) => Yt(f, l.secondaryMin, l.secondaryMax));
  }, [n]), re(() => {
    ...
    return (async () => {
      try {
        const f = await Nn(i.folder?.handleKey ?? "");
        if (!f || !await wn(f, "readwrite") || l) return;
        const b = await fa(f);
        if (l) return;
        je(i.folder?.handleKey ?? null), He(b), oe((P) => wc(P, b.files)), fe((P) => P.filter((J) => b.files.some((ce) => ce.id === J) || O.some((ce) => ce.id === J))), S(`Restored ${b.name} (${b.files.length} text files indexed)`);
      } catch (f) {
  ...
  }, [c, g, _, we, te, We, O, ue, Pe, x, Tt, m, Y]), re(() => {
    localStorage.setItem(br, JSON.stringify(ke));
  }, [ke]), /* @__PURE__ */ d(
    "div",
    {
      ref: t,
      ...
      children: [
        ...
        p && /* @__PURE__ */ d("div", { className: "workbench-primary-region", children: [
          ...
          /* @__PURE__ */ r("div", { className: "workbench-primary-resizer", onPointerDown: Ir, title: "Resize Explorer" })
        ] }),
        /* @__PURE__ */ d("main", { className: "workbench-editor-area", children: [
          ...
          /* @__PURE__ */ d("section", { className: "workbench-editor-stack", children: [
            ...
            /* @__PURE__ */ r(Dl, { file: D, folder: ue, showWelcome: dn }),
            Te && Xe.length > 0 ? /* @__PURE__ */ d("div", { className: "workbench-ai-dirty-banner", children: [
              ...
              /* @__PURE__ */ r("button", { onClick: () => Ae(null), title: "Dismiss", children: /* @__PURE__ */ r(Ye, { size: 13 }) })
            ] }) : null,
            /* @__PURE__ */ r("div", { className: "workbench-editor-content", children: D ? /* @__PURE__ */ d("div", { className: D.language === "markdown" && M ? "workbench-editor-split" : "workbench-editor-single", children: [
              /* @__PURE__ */ r("div", { className: "workbench-editor-pane", children: /* @__PURE__ */ r(ss, { fallback: /* @__PURE__ */ r("div", { className: "workbench-empty-pane", children: "Loading editor…" }), children: /* @__PURE__ */ r(
                kl,
                {
                  file: D,
                  revealLine: Or,
              ...
              D.language === "markdown" && M && /* @__PURE__ */ r(Kl, { content: D.content })
            ] }) : It ? /* @__PURE__ */ r(
              nc,
              {
                host: e,
            ...
            ) : dn ? /* @__PURE__ */ r(ql, { host: e, openFile: Xt, openFolder: un, newFile: mn, recent: Tt, reopenRecent: bn, setStatus: S, openControlTower: () => {
              h("computer"), v(!0);
            }, openChat: () => {
              A("chat"), Z(!0);
            }, openEmbeddedDoc: Dr }) : /* @__PURE__ */ d("div", { className: "workbench-no-editor", children: [
              /* @__PURE__ */ r(sn, { size: 34 }),
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek answer", l.body),
            ...
            contextScope: Ve,
            setContextScope: ze,
            contextAttachments: Hr,
            removeContextAttachment: Wr,
        ...
        Ie && /* @__PURE__ */ r(
          Zl,
          {
            ...
            activeFile: D,
            commands: [
              { label: "File: New File", detail: "Create an untitled Markdown file", run: mn },
              ...
              { label: "File: Close All Editors", detail: `${Ce.length} open editor${Ce.length === 1 ? "" : "s"}`, run: qr, disabled: Ce.length === 0 },
              ...
              { label: "Atomek: Create AI Synthesis", detail: D || Ce.length > 0 ? "Ask AIL to produce a saved Markdown artifact" : "Open a file first", run: pn, disabled: !D && Ce.length === 0 },
              ...
              { label: "AI: Save Active File as Artifact", detail: D ? "Persist active file in host.ai artifacts" : "Open a file first", run: Kr, disabled: !D },
              { label: "AI: Capture Manual Check Output", detail: "Paste check output as an auditable local artifact; no shell execution", run: yn },
              { label: "AI: Open Latest Artifact as File", detail: tt[0] ? `Create editable file from ${tt[0].title}` : "No outputs yet", run: () => tt[0] && vn(tt[0]), disabled: tt.length === 0 }
            ],
            openWorkbenchFile: pe,
            onClose: () => De(!1)
          }
        ...
        /* @__PURE__ */ r(uc, { status: Cr, file: D ?? Pl, cursor: V, fileCount: O.length, dirtyCount: Xe.length })
      ]
    }
  );
}
function Ml({ active: e, setActive: t, togglePrimary: n, openSettings: a, settingsActive: s }) {
  return /* @__PURE__ */ d("aside", { className: "workbench-activity-bar", "aria-label": "Activity Bar", children: [
    /* @__PURE__ */ r("button", { className: "workbench-activity-brand", title: "Toggle side bar", "aria-label": "Toggle side bar", onClick: n, children: /* @__PURE__ */ r(ur, { size: 30, variant: "cream" }) }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(ja, { size: 25 }), label: "Explorer", active: e === "explorer", onClick: () => t("explorer") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Ws, { size: 25 }), label: "Search", active: e === "search", onClick: () => t("search") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Wa, { size: 25 }), label: "Source Control", active: e === "source-control", onClick: () => t("source-control") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Ha, { size: 25 }), label: "Run and Debug", active: e === "run", onClick: () => t("run") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(In, { size: 25 }), label: "Agent Team", active: e === "computer", onClick: () => t("computer") }),
    /* @__PURE__ */ r("div", { className: "workbench-activity-spacer" }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Fs, { size: 23 }), label: "Settings", active: s, onClick: a })
  ] });
}
...
function Wl(e) {
  return e.activity === "search" ? /* @__PURE__ */ r(Yl, { files: e.files, query: e.query, setQuery: e.setQuery, openWorkbenchFile: e.openWorkbenchFile, activeFileId: e.activeFileId }) : e.activity === "source-control" ? /* @__PURE__ */ r(Oa, { title: "SOURCE CONTROL", body: "No source control provider registered. Git belongs here, not as a fake demo." }) : e.activity === "run" ? /* @__PURE__ */ r(Oa, { title: "RUN AND DEBUG", body: "Run configurations, terminals, and recipe execution will plug into this surface later." }) : e.activity === "computer" ? /* @__PURE__ */ r(Lr, { host: e.host, setStatus: e.setStatus, attachSkillToChat: e.attachSkillToChat, saveLocalJobOutput: e.saveLocalJobOutput, activeFile: e.activeFile, openEditors: e.openEditors }) : /* @__PURE__ */ r(Vl, { ...e });
}
function Vl(e) {
  const t = !e.folder, n = de(() => Il(e.files, e.folder?.name), [e.files, e.folder?.name]), [a, s] = z(() => /* @__PURE__ */ new Set());
  re(() => {
    const o = xr(n);
    s((c) => {
      const h = new Set(c);
  ...
  return /* @__PURE__ */ d("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ d("div", { className: "workbench-sidebar-scroll", children: [
      t ? /* @__PURE__ */ d(Re, { children: [
        ...
        e.openEditors.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No open editors" }) : e.openEditors.map((o) => /* @__PURE__ */ r($n, { file: o, active: o.id === e.activeFileId, onOpen: () => e.openWorkbenchFile(o), label: o.name, detail: o.path }, o.id)),
        /* @__PURE__ */ d("div", { className: "workbench-section-title", children: [
          /* @__PURE__ */ r(an, { size: 12 }),
          " ",
          e.folder?.name ?? "Workspace"
        ] }),
        n.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No readable text files found." }) : Nr(n, e.activeFileId, e.openWorkbenchFile, a, i)
      ] }),
      /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "Recent" }),
      e.recent.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No recent folders yet." }) : e.recent.map((o) => /* @__PURE__ */ d("button", { className: "workbench-tree-row", onClick: () => {
        e.reopenRecent(o);
      }, title: o.path, children: [
        o.kind === "file" ? /* @__PURE__ */ r(Fn, { size: 14 }) : /* @__PURE__ */ r(Ma, { size: 14 }),
        /* @__PURE__ */ r("span", { className: "workbench-row-name", children: o.name })
      ] }, `${o.path}-${o.at}`))
    ] })
  ] });
}
function $n({ file: e, active: t, onOpen: n, basePath: a, depth: s = 0, label: i, detail: o }) {
...
function Nr(e, t, n, a, s, i = 0) {
  return e.map((o) => {
    if (o.file)
      return /* @__PURE__ */ r($n, { file: o.file, active: o.file.id === t, onOpen: () => n(o.file), depth: i, label: o.name }, o.file.id);
    ...
    return /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ d("button", { className: "workbench-folder-row", style: { "--workbench-depth": i }, onClick: () => s(o.path), title: c ? `Collapse ${o.name}` : `Expand ${o.name}`, children: [
        ...
        c ? /* @__PURE__ */ r(En, { size: 14 }) : /* @__PURE__ */ r(Ma, { size: 14 }),
        /* @__PURE__ */ r("span", { className: "workbench-row-name", children: o.name }),
        /* @__PURE__ */ r("span", { className: "workbench-row-meta", children: o.children.length })
      ] }),
      c ? Nr(o.children, t, n, a, s, i + 1) : null
    ] }, o.path);
  });
}
function Dl({ file: e, folder: t, showWelcome: n }) {
  const a = n ? ["Agent Team"] : e?.path.split("/").filter(Boolean) ?? [], s = t && a[0] === t.name ? a.slice(1) : a;
  return /* @__PURE__ */ r("div", { className: "workbench-breadcrumb", children: s.length === 0 ? /* @__PURE__ */ r("span", { children: "Workspace" }) : s.map((i, o) => /* @__PURE__ */ d("span", { className: "workbench-breadcrumb-part", children: [
...
function Fl(e) {
  return /* @__PURE__ */ d("div", { className: "workbench-tabs", children: [
    e.showWelcome && /* @__PURE__ */ d("button", { className: "workbench-tab active", children: [
      ...
      }, children: /* @__PURE__ */ r(Ye, { size: 13 }) })
    ] }),
    ...
    e.canPreview && /* @__PURE__ */ r("button", { className: `workbench-editor-action ${e.previewVisible ? "active" : ""}`, title: "Toggle Markdown Preview", onClick: e.togglePreview, children: /* @__PURE__ */ r(Dn, { size: 16 }) }),
    /* @__PURE__ */ r("button", { className: `workbench-editor-action ${e.secondaryVisible ? "active" : ""}`, title: "Toggle Chat", onClick: e.toggleSecondary, children: /* @__PURE__ */ r(Os, { size: 16 }) })
  ] });
}
function Rl(e) {
  ...
  const ve = N(async () => {
    ...
    try {
      ...
      await e.missions.write({
        rootPath: x.rootPath,
        files: [
          { path: "MISSION.md", content: tn(L, w, null, [], g, W) },
          { path: "MISSION.json", content: Pr(L, w, g, W) },
          { path: "RESOURCES.md", content: nn(w) },
          { path: "TASKS.md", content: wr(Ht(g, w, W)) },
          { path: "HANDOFF.md", content: kr(L) },
...
`) }
      ...
      }), we(x), Ct(L), o(`Mission created: ${x.rootPath}`), c();
    } catch (x) {
      o(`Mission create failed: ${x instanceof Error ? x.message : String(x)}`);
    } finally {
      F(!1);
    }
  }, [v, w, e.missions, c, o, q]), ue = Rl(w), He = Xl(w), We = Ll(w), je = El(w), O = w?.warnings ?? [], oe = Ol(w), Pe = xt(w, ot(v, w, q)), fe = Ht(v, w, Pe.id);
  return /* @__PURE__ */ d("div", { className: "workbench-welcome workbench-control-home", children: [
    /* @__PURE__ */ d("section", { className: "workbench-control-hero-main", children: [
      /* @__PURE__ */ d("div", { className: "workbench-brand-lockup", "aria-label": "Atomek", children: [
        /* @__PURE__ */ r(ur, { size: 74, variant: "acid" }),
        /* @__PURE__ */ d("div", { children: [
          /* @__PURE__ */ r(fl, { className: "workbench-brand-wordmark" }),
      ...
      /* @__PURE__ */ r("div", { className: "workbench-team-preset-strip", "aria-label": "Team presets", children: oe.map((g) => /* @__PURE__ */ d(
        "button",
        {
    ...
    /* @__PURE__ */ d("section", { className: "workbench-control-grid", children: [
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ r("div", { className: "workbench-control-metrics", children: ue.map((g) => /* @__PURE__ */ d("div", { className: "workbench-control-metric", children: [
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ r("div", { className: "workbench-agent-brand-grid", children: He.map((g) => /* @__PURE__ */ d("div", { className: `workbench-agent-brand-card ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r("strong", { children: g.label }),
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ r("div", { className: "workbench-doc-grid", children: yl.map((g) => /* @__PURE__ */ d("button", { className: "workbench-doc-card", onClick: () => p(g), title: g.summary, children: [
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ r("div", { className: "workbench-fabric-flow", children: We.map((g, W) => /* @__PURE__ */ d("div", { className: `workbench-fabric-node ${g.status.replace(/\s+/g, "-")}`, children: [
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card", children: [
        ...
        /* @__PURE__ */ d("button", { className: "workbench-start-link", onClick: n, children: [
          /* @__PURE__ */ r(En, { size: 18 }),
          "Open workspace folder"
        ] }),
        /* @__PURE__ */ d("button", { className: "workbench-start-link", onClick: t, children: [
          /* @__PURE__ */ r(ja, { size: 18 }),
          "Open file"
        ] }),
        /* @__PURE__ */ d("button", { className: "workbench-start-link", onClick: a, children: [
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ d("header", { children: [
          ...
          /* @__PURE__ */ r("span", { children: w ? `${w.resources.length} discovered` : "not loaded" })
        ] }),
        /* @__PURE__ */ d("div", { className: "workbench-control-resource-list", children: [
          ...
          je.map((g) => /* @__PURE__ */ d("div", { className: "workbench-control-resource", children: [
            /* @__PURE__ */ d("div", { children: [
              ...
              /* @__PURE__ */ r("span", { children: Qn(g) })
            ] }),
            /* @__PURE__ */ r("span", { className: `workbench-computer-pill ${g.status}`, children: g.status })
          ] }, g.id))
        ] }),
        O.length ? /* @__PURE__ */ r("div", { className: "workbench-resource-warnings", children: O.slice(0, 2).map((g) => /* @__PURE__ */ d("span", { children: [
          g.code,
          ": ",
          g.message
      ...
      /* @__PURE__ */ d("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ r("div", { className: "workbench-task-graph home", children: fe.map((g, W) => /* @__PURE__ */ d("button", { className: `workbench-task-card ${g.status}`, onClick: () => y(g.prompt), children: [
          /* @__PURE__ */ r("span", { children: W + 1 }),
          /* @__PURE__ */ r("strong", { children: g.title }),
...
function Yl({ files: e, query: t, setQuery: n, openWorkbenchFile: a, activeFileId: s }) {
  const i = de(() => Jl(e, t), [e, t]), o = de(() => {
    ...
    /* @__PURE__ */ d("div", { className: "workbench-sidebar-scroll", children: [
      ...
      t.trim() ? o.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No matches." }) : o.map((c) => {
        ...
        return /* @__PURE__ */ d("div", { className: "workbench-search-group", children: [
          /* @__PURE__ */ r($n, { file: h, active: h.id === s, onOpen: () => a(h) }),
          c.slice(0, 5).map((p) => /* @__PURE__ */ d("button", { className: "workbench-search-hit", onClick: () => a(h, p.lineNumber), title: p.line, children: [
...
function Zl(e) {
  const t = e.query.trim().toLowerCase(), n = e.files.slice(0, 80).map((s) => ({
    label: s.path,
    detail: `Open ${Fa(s.language)} file`,
  ...
  return re(() => {
  ...
  }, [e.onClose]), /* @__PURE__ */ r("div", { className: "workbench-command-overlay", role: "dialog", "aria-label": "Command Palette", children: /* @__PURE__ */ d("div", { className: "workbench-command-palette", children: [
    /* @__PURE__ */ r(
      "input",
      {
    ...
    /* @__PURE__ */ r("div", { className: "workbench-command-list", children: a.map((s) => /* @__PURE__ */ d(
      "button",
      {
        disabled: s.disabled,
...
function Ul(e) {
  const t = e.session ? el(e.session) : "pending";
    ...
    e.session ? /* @__PURE__ */ d(Re, { children: [
      ...
      /* @__PURE__ */ d("div", { className: "workbench-manual-check-grid", children: [
        /* @__PURE__ */ d("section", { children: [
          ...
          /* @__PURE__ */ r("div", { className: "workbench-check-command-list", children: e.session.commands.map((n) => /* @__PURE__ */ d(
            "button",
            {
      ...
      e.session.results.length > 0 ? /* @__PURE__ */ d("div", { className: "workbench-check-results", children: [
        ...
        e.session.results.map((n, a) => /* @__PURE__ */ d("article", { children: [
...
function Bl(e) {
  return /* @__PURE__ */ d("section", { className: "workbench-bottom-panel", "aria-label": "Panel", children: [
    /* @__PURE__ */ d("div", { className: "workbench-bottom-tabs", children: [
      ...
      /* @__PURE__ */ r("span", {}),
      /* @__PURE__ */ r("button", { title: "Close Panel", onClick: e.onClose, children: /* @__PURE__ */ r(Ye, { size: 14 }) })
    ] }),
    /* @__PURE__ */ d("div", { className: "workbench-bottom-body", children: [
      ...
      e.tab === "output" && /* @__PURE__ */ r(Xr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, compact: !0 })
    ] })
  ] });
}
function Gl(e) {
  return /* @__PURE__ */ d("aside", { className: "workbench-secondary", children: [
    ...
    /* @__PURE__ */ d("div", { className: "workbench-secondary-tabs", children: [
      ...
      /* @__PURE__ */ d("div", { className: "workbench-secondary-actions", children: [
        /* @__PURE__ */ r("button", { title: "New Chat", onClick: e.newChat, children: /* @__PURE__ */ r(Hs, { size: 15 }) }),
        /* @__PURE__ */ r("button", { title: "Chat Settings", onClick: e.openSettings, children: /* @__PURE__ */ r(ys, { size: 16 }) }),
        /* @__PURE__ */ r("button", { title: "Close Chat", onClick: e.onClose, children: /* @__PURE__ */ r(Ye, { size: 15 }) })
      ] })
    ] }),
    e.tab === "chat" ? /* @__PURE__ */ r(Ql, { ...e }) : e.tab === "agents" ? /* @__PURE__ */ r(
      Lr,
      {
        host: e.host,
    ...
    ) : /* @__PURE__ */ r(Xr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, previewEditFromOutput: e.previewEditFromOutput, canPreviewEdit: e.canPreviewEdit })
  ] });
}
function Tr({ body: e }) {
  const t = de(() => Nl(e), [e]), [n, a] = z(null), s = N((i, o) => {
  ...
  return /* @__PURE__ */ r("div", { className: "workbench-rich-body", children: t.map((i) => {
      ...
      return /* @__PURE__ */ d("div", { className: "workbench-rich-code", children: [
        /* @__PURE__ */ d("div", { className: "workbench-rich-code-head", children: [
          ...
          /* @__PURE__ */ d("button", { onClick: () => s(i.key, i.body), title: "Copy code block", children: [
            o ? /* @__PURE__ */ r(ms, { size: 12 }) : /* @__PURE__ */ r(Cn, { size: 12 }),
            o ? "Copied" : "Copy"
          ] })
        ] }),
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: Ya(i.body) }
      },
      i.key
    );
  }) });
...
function Ql(e) {
  const t = e.selectedChatTarget.available, n = e.selectedChatTarget.kind === "atomek-ai", a = e.chatInput.trim().length > 0 && !e.busy && t, s = it(null), [i, o] = z(!0), [c, h] = z(!1), p = de(() => e.chatMessages.map((m) => `${m.id}:${m.status ?? ""}:${m.body.length}`).join("|"), [e.chatMessages]);
  re(() => {
    const m = s.current;
  ...
  return /* @__PURE__ */ d("div", { className: "workbench-chat-wrap", children: [
    ...
    /* @__PURE__ */ d("div", { ref: s, className: "workbench-chat-transcript", onScroll: v, children: [
      e.chatMessages.length === 0 ? /* @__PURE__ */ r("div", { className: "workbench-chat-empty", children: /* @__PURE__ */ d("div", { children: [
        /* @__PURE__ */ r(Ls, { size: 48 }),
    ...
    /* @__PURE__ */ d("div", { className: "workbench-chat-composer", children: [
      /* @__PURE__ */ d("div", { className: "workbench-chat-tip", children: [
        ...
        /* @__PURE__ */ r("em", { children: e.selectedChatTarget.kind === "atomek-ai" ? Xa(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
        /* @__PURE__ */ r("span", { children: "Context" }),
        /* @__PURE__ */ r("strong", { children: Li(e.contextScope) })
      ] }),
      /* @__PURE__ */ d("div", { className: "workbench-chat-box", children: [
        /* @__PURE__ */ d("div", { className: "workbench-chat-attachments", children: [
          ...
          e.contextAttachments.length === 0 ? /* @__PURE__ */ d("span", { className: "workbench-chat-chip muted", children: [
            ...
            return /* @__PURE__ */ d("span", { className: "workbench-chat-chip", title: F, children: [
              /* @__PURE__ */ r("button", { className: "workbench-chat-chip-open", onClick: () => e.revealContextAttachment(m), disabled: !m.fileId, title: "Reveal context", children: /* @__PURE__ */ r(ua, { size: 13 }) }),
              m.label,
              ...
              m.removable ? /* @__PURE__ */ r("button", { className: "workbench-chat-chip-remove", onClick: () => e.removeContextAttachment(m), title: "Remove context", children: /* @__PURE__ */ r(Ye, { size: 11 }) }) : null
            ] }, m.id);
          }),
        ...
        /* @__PURE__ */ d("div", { className: "workbench-chat-toolbar compact", children: [
          /* @__PURE__ */ r("span", { className: "workbench-chat-route-summary", children: e.selectedChatTarget.kind === "atomek-ai" ? Xa(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
          /* @__PURE__ */ r("span", {}),
          e.busy ? /* @__PURE__ */ r("button", { className: "workbench-chat-send stop", onClick: e.stopChat, title: "Stop", children: /* @__PURE__ */ r(Ia, { size: 14 }) }) : /* @__PURE__ */ r("button", { className: `workbench-chat-send ${a ? "ready" : ""}`, onClick: e.askAgent, title: "Send", disabled: !a, "aria-label": "Send message", children: /* @__PURE__ */ r(Is, { size: 16 }) })
        ] })
      ] })
    ] })
  ] });
...
function Xa(e, t, n) {
  e.model;
  const s = [e.gatewayPreference === "auto" ? t : zr(e.gatewayPreference)];
...
function tc({ host: e, appName: t, currentVersion: n }) {
  ...
  }, [a, t]), w = s?.latestVersion ?? n, m = !!s?.updateAvailable;
...
function nc(e) {
  ...
  return /* @__PURE__ */ r("div", { className: "workbench-settings-tab", children: /* @__PURE__ */ d("section", { className: "workbench-settings-page", "aria-label": "Atomek Settings", children: [
    /* @__PURE__ */ d("header", { className: "workbench-settings-header", children: [
      ...
      /* @__PURE__ */ r("button", { onClick: e.onClose, title: "Close", children: /* @__PURE__ */ r(Ye, { size: 15 }) })
    ] }),
    /* @__PURE__ */ d("div", { className: "workbench-settings-body", children: [
      /* @__PURE__ */ r(tc, { host: e.host, appName: "Atomek", currentVersion: Ta }),
      /* @__PURE__ */ d("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ d("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ r("datalist", { id: "atomek-chat-models", children: t.map((w) => /* @__PURE__ */ r("option", { value: w.id, children: w.gatewayLabel }, `${w.gatewayLabel}:${w.id}`)) })
        ] }),
      ...
      /* @__PURE__ */ d("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ d("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ r("datalist", { id: "atomek-embedding-models", children: i.map((w) => /* @__PURE__ */ r("option", { value: w.id, children: w.gatewayLabel }, `${w.gatewayLabel}:${w.id}`)) })
        ] }),
...
function Xr({ outputs: e, clearOutputs: t, deleteArtifact: n, runAiSynthesis: a, captureManualCheck: s, openOutputAsFile: i, previewEditFromOutput: o, canPreviewEdit: c = !1, compact: h = !1 }) {
  return /* @__PURE__ */ d("div", { className: `workbench-panel-list ${h ? "compact" : ""}`, children: [
    /* @__PURE__ */ d("div", { style: { display: "flex", gap: 8, marginBottom: 10 }, children: [
      /* @__PURE__ */ d("button", { className: "workbench-button-subtle", onClick: a, children: [
        /* @__PURE__ */ r(In, { size: 14 }),
        "AI synthesis"
      ] }),
    ...
    e.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No outputs yet. Save an AI answer as an artifact or create an AI synthesis." }) : e.map((p) => /* @__PURE__ */ d("div", { className: "workbench-output-card", children: [
      /* @__PURE__ */ d("div", { className: "workbench-output-head", children: [
        ...
        o ? /* @__PURE__ */ r(
          "button",
          {
            className: La(p.body) ? "workbench-output-edit-cta" : void 0,
            onClick: () => o(p),
            disabled: !c,
            children: La(p.body) ? "Preview/apply edit" : "Preview edit"
          }
        ) : null,
        p.source === "ai" ? /* @__PURE__ */ r("button", { onClick: () => n(p.id), children: "Delete" }) : null
      ] }),
      /* @__PURE__ */ r(Tr, { body: p.body })
    ] }, p.id))
  ] });
}
function ac({ edit: e, onApply: t, onOpenAsFile: n, onClose: a }) {
  return /* @__PURE__ */ r("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI edit", children: /* @__PURE__ */ d("section", { className: "workbench-edit-review", children: [
    /* @__PURE__ */ d("header", { className: "workbench-edit-review-head", children: [
      ...
      /* @__PURE__ */ r("button", { title: "Close", onClick: a, children: /* @__PURE__ */ r(Ye, { size: 16 }) })
    ] }),
...
function rc({ patch: e, onApply: t, onOpenAsFiles: n, onClose: a }) {
  const s = e.edits.reduce((i, o) => ({
    added: i.added + o.stats.added,
    removed: i.removed + o.stats.removed,
    changed: i.changed + o.stats.changed
  }), { added: 0, removed: 0, changed: 0 });
  return /* @__PURE__ */ r("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI workspace patch", children: /* @__PURE__ */ d("section", { className: "workbench-edit-review workspace", children: [
    /* @__PURE__ */ d("header", { className: "workbench-edit-review-head", children: [
      /* @__PURE__ */ d("div", { children: [
    ...
    /* @__PURE__ */ d("div", { className: "workbench-workspace-patch-list", children: [
      e.edits.map((i) => /* @__PURE__ */ d("article", { className: "workbench-workspace-patch-card", children: [
        ...
        /* @__PURE__ */ r("pre", { children: hc(i.proposedContent) })
      ] }, i.fileId)),
...
function ic(e, t) {
  ...
  if (e)
    n.push("", `Active file: ${e.path}`, `Language: ${e.language}`, `Dirty: ${e.dirty ? "yes" : "no"}`, "", "Active file content:", "```" + e.language, sc(e.content), "```");
  else if (t.length > 0) {
...
function Lr({
  ...
  const xe = N(async (u = M) => {
    ...
    if (!u) return;
    const T = [...k].sort((C, E) => za(E).localeCompare(za(C))).slice(0, 100), H = T.map((C) => JSON.stringify(C)).join(`
`) + (T.length ? `
` : "");
    u.rootPath && e.missions?.write ? await e.missions.write({ rootPath: u.rootPath, files: [{ path: "RUNS.jsonl", content: H }] }) : u.handle && await Wn(u.handle, "RUNS.jsonl", H), je(T), O.current = T;
  ...
  re(() => {
    ...
    return window.addEventListener(Mn, u), () => window.removeEventListener(Mn, u);
  }, [Ee, xe]);
  const Je = N((u) => {
    const k = Hl(u);
    be(k), Ct(k), xe(k), He([{
    ...
    ], C = ot(k || u.goal, y, u.teamPresetId), E = Ht(k || u.goal, y, C), $ = [
      { path: "MISSION.md", content: tn(u, y, s, i, k, C) },
      { path: "MISSION.json", content: Pr(u, y, k, C) },
      { path: "RESOURCES.md", content: nn(y) },
      { path: "TASKS.md", content: wr(E) },
      { path: "HANDOFF.md", content: kr(u) },
      { path: "INBOX.md", content: `# Mission inbox
...
` }
    ...
    if (u.rootPath && e.missions?.write)
      ...
      for (const U of $) await zl(u.handle, U.path, U.content);
    } else
    ...
    if (e.missions?.create) {
      ...
      C = {
        handle: $,
        name: $.name,
        missionId: `mission-${Date.now()}-${Cl($.name)}`,
        title: T,
        goal: H,
        source: "browser"
      };
    ...
    return be(C), Ct(C), He([E]), await ye(C, H, [E]), t(`Mission pack ready in ${C.rootPath ?? C.name}`), C;
...
`)
      ...
      e.local.streamJob(E.id, {
        ...
        onFail: (B) => {
          ...
          }), a(`${u.label} local job failed`, U.join(`
`)), te(u, U.join(`
`), -1, T, $).catch((I) => {
...
`);
          ...
          }), a(`${u.label} local job`, I), te(u, I, B, T, $).catch((se) => {
  ...
  }, [s, K, e.local, F, i, y, a, te, X, t, ze, ye]), Ie = N(async (u) => {
    const k = Vn(u);
    if (!k) {
    ...
    try {
      ...
      const se = await I.json(), Le = cc(se);
      if (!Le)
...
`)
      ...
      const lt = typeof Fe == "string" ? Fe : dc(Fe);
      B(lt);
      const ct = [
        `# Pod job — ${C}`,
        "",
...
`);
      q((Nt) => Nt.map((Ge) => Ge.id === E ? { ...Ge, status: "complete", finishedAt: Date.now(), lines: [...Ge.lines, "[Atomek] Pod task complete."].slice(-500) } : Ge)), await ze({ ...ke, status: "complete", finishedAt: mt(), summary: `${C} completed`, transcriptPath: U }, H), a(`${C} pod job`, ct), await te({ id: u.id, label: C, kind: "pod-agent", status: u.status }, ct, 0, H, U), t(`${C} completed mission task`);
    } catch (I) {
...
`), "```", ""].join(`
`);
      a(`${C} pod job failed`, Le), await te({ id: u.id, label: C, kind: "pod-agent", status: u.status }, Le, -1, H, U).catch((Te) => {
        t(`Pod transcript save failed: ${Te instanceof Error ? Te.message : String(Te)}`);
      }), t(`Pod task failed: ${se}`);
    }
  }, [s, K, e.daemon, F, i, y, a, te, X, t, ze, ye]), De = N(async (u) => {
...
`);
    ...
    t(T), kt(k?.commandPreview ?? k?.deepLink ?? T);
  }, [t]);
  return /* @__PURE__ */ d("aside", { className: x ? "workbench-agent-dock" : "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ d("div", { className: x ? "workbench-agent-dock-scroll" : "workbench-sidebar-scroll", children: [
      ...
      /* @__PURE__ */ d("div", { className: "workbench-team-switcher", role: "tablist", "aria-label": "Atomek agent team views", children: [
        /* @__PURE__ */ r("button", { className: fe === "mission" ? "active" : "", onClick: () => g("mission"), children: "Mission" }),
        /* @__PURE__ */ r("button", { className: fe === "runs" ? "active" : "", onClick: () => g("runs"), children: "Runs" }),
        /* @__PURE__ */ r("button", { className: fe === "setup" ? "active" : "", onClick: () => g("setup"), children: "Setup" })
      ] }),
      fe === "mission" ? /* @__PURE__ */ d(Re, { children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-context-card mission", children: [
          ...
          /* @__PURE__ */ r("span", { children: M ? `${M.rootPath ?? M.name} · ${M.source} · ${ue.length} audit events · transcripts saved under runs/` : "Atomek creates this automatically before launching local agents. It is the shared folder agents read/write transcripts from." }),
        ...
        /* @__PURE__ */ d("div", { className: "workbench-team-assignment-list", children: [
          ...
          L.assignments.map((u) => /* @__PURE__ */ d("div", { className: "workbench-team-assignment-row", children: [
            /* @__PURE__ */ d("div", { children: [
              ...
              /* @__PURE__ */ r("span", { children: u.resourceLabel })
            ] }),
            /* @__PURE__ */ r("em", { children: u.status })
          ] }, `${u.role}-${u.resourceId}`))
        ] }),
        ...
        Y.length ? /* @__PURE__ */ d(Re, { children: [
          ...
          /* @__PURE__ */ r("div", { className: "workbench-mission-list", children: Y.slice(0, x ? 3 : 5).map((u) => /* @__PURE__ */ d(
            "button",
            {
        ...
        y?.warnings.length ? /* @__PURE__ */ r("div", { className: "workbench-resource-warnings", children: y.warnings.slice(0, 3).map((u) => /* @__PURE__ */ d("span", { children: [
          u.code,
          ": ",
          u.message
        ...
        /* @__PURE__ */ r("div", { className: "workbench-computer-presets", children: le.map((u) => /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => ge(u.prompt), children: u.label }, u.label)) }),
        /* @__PURE__ */ r(
          "textarea",
          {
        ...
        /* @__PURE__ */ r("div", { className: "workbench-task-graph", children: V.map((u, k) => /* @__PURE__ */ d(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ r("span", { children: k + 1 }),
              /* @__PURE__ */ r("strong", { children: u.title }),
              /* @__PURE__ */ r("em", { children: u.resourceHint }),
              /* @__PURE__ */ r("small", { children: u.assignedResourceLabel })
            ]
          },
          u.id
        )) })
...
`) || "[waiting for output]" })
        ...
        We.length ? /* @__PURE__ */ d(Re, { children: [
          ...
          /* @__PURE__ */ r("div", { className: "workbench-run-history", children: We.slice(0, x ? 4 : 8).map((u) => /* @__PURE__ */ d("div", { className: "workbench-run-history-row", children: [
            /* @__PURE__ */ d("div", { children: [
              /* @__PURE__ */ r("strong", { children: u.taskTitle || u.label }),
              /* @__PURE__ */ d("span", { children: [
                u.label,
                " · ",
                u.status,
              ...
              u.transcriptPath ? /* @__PURE__ */ r("small", { children: u.transcriptPath }) : null
            ] }),
            /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => void kt(u.transcriptPath ?? u.id), title: "Copy transcript path or run id", children: "Copy path" })
          ] }, u.id)) })
        ] }) : null
      ] }) : null,
      fe === "setup" ? /* @__PURE__ */ d(Re, { children: [
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-list compact", children: [
          ...
          y?.resources.slice(0, x ? 8 : 5).map((u) => /* @__PURE__ */ d("div", { className: "workbench-resource-row", children: [
            /* @__PURE__ */ d("div", { children: [
              /* @__PURE__ */ r("strong", { children: Oe(u) }),
              /* @__PURE__ */ r("span", { children: Qn(u) })
            ] }),
            /* @__PURE__ */ d("div", { className: "workbench-resource-row-actions", children: [
              /* @__PURE__ */ r("span", { className: `workbench-computer-pill ${u.status}`, children: u.status }),
              /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
                ne(u);
              }, children: "Use" }),
              u.kind === "pod-agent" && Vn(u) ? /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
                Ie(u);
              }, children: "Ask pod" }) : null,
              u.status === "needs-setup" || u.setupAction ? /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => me(u), children: "Setup" }) : null
            ] })
          ] }, u.id))
        ] }),
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-list", children: [
          ...
          c.map((u) => /* @__PURE__ */ d("div", { className: "workbench-computer-card", children: [
            ...
            u.description ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: u.description }) : null,
            /* @__PURE__ */ d("div", { className: "workbench-computer-actions", children: [
              /* @__PURE__ */ r("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
                G(u);
              }, disabled: u.status !== "available", title: "Launch this tool in a fresh Tytus Terminal with mission context and execute it immediately.", children: oc(u) }),
              u.kind === "ai-cli" ? /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
                Ne(u);
              }, disabled: u.status !== "available" || we !== null, title: "Run this local agent as a background read-only review inside Atomek and stream output here. It cannot write files directly.", children: lc(u, we) }) : null
            ] })
          ] }, u.id))
        ] }),
        ...
        /* @__PURE__ */ d("div", { className: "workbench-computer-list", children: [
          ...
          p.map((u) => /* @__PURE__ */ d("div", { className: "workbench-computer-card", children: [
            ...
            /* @__PURE__ */ r("p", { className: "workbench-muted", children: u.description }),
            u.triggers?.length ? /* @__PURE__ */ r("div", { className: "workbench-computer-triggers", children: u.triggers.slice(0, 4).map((k) => /* @__PURE__ */ r("span", { children: k }, k)) }) : null,
            /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
              n(u);
...
function uc({ status: e, file: t, cursor: n, fileCount: a, dirtyCount: s }) {
  return /* @__PURE__ */ d("footer", { className: "workbench-statusbar", children: [
    ...
    /* @__PURE__ */ r("span", { children: Fa(t.language) })
  ] });
}
function Xn(e, t) {
