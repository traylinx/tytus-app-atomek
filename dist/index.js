...
import { forwardRef as Ea, createElement as Vn, useState as P, useRef as Me, useCallback as x, useEffect as le, createContext as gs, useMemo as he, useContext as ws, lazy as ks, Suspense as xs } from "react";
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const js = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], Ms = me("check", js);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Ws = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], Xt = me("chevron-down", Ws);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function wi(e) {
  return at(e, "routeId") || at(e, "route_id") || null;
}
function vt(e) {
  const t = [
    at(e, "agentFamily"),
    at(e, "agentType"),
    at(e, "internalAgentType"),
    at(e, "brand"),
    e.label
  ].join(" ").toLowerCase();
...
function ki(e) {
  const t = e?.resources ?? [], n = (c) => c.status === "ready" || c.status === "available", r = t.filter((c) => c.kind === "pod-agent" && vt(c) === "openclaw"), i = t.filter((c) => c.kind === "pod-agent" && vt(c) === "hermes"), s = t.filter((c) => c.kind === "local-cli" && n(c)), o = t.filter((c) => c.kind === "shared-folder" && n(c));
  return [
...
function kt(e, t = "repo-repair") {
  const n = Ct.find((V) => V.id === t) ?? Ct[0], r = e?.resources ?? [], i = ot(r, (V) => V.kind === "pod-agent" && vt(V) === "openclaw"), s = ot(r, (V) => V.kind === "pod-agent" && vt(V) === "hermes"), o = ot(r, (V) => V.kind === "ail-route"), c = ot(r, (V) => V.kind === "shared-folder"), f = $e(r, "local-cli", ["claude"]), b = $e(r, "local-cli", ["opencode", "open code"]), p = $e(r, "local-cli", ["codex"]), v = $e(r, "local-cli", ["pi"]), N = $e(r, "local-cli", ["kimi"]), S = ot(r, (V) => V.kind === "local-cli"), j = $e(r, "app-skill", ["juli3ta", "music", "song"]), I = $e(r, "app-skill", ["blender", "3d"]), J = $e(r, "app-skill", ["remotion", "video", "render"]), F = ot(r, (V) => V.kind === "app-skill"), se = t === "pod-local" ? i ?? s ?? o ?? f ?? S : t === "creative-production" ? s ?? o ?? f ?? S : t === "research-watch" ? i ?? o ?? s ?? f ?? S : f ?? b ?? o ?? S, be = t === "creative-production" ? j ?? I ?? J ?? F ?? b ?? f ?? S : b ?? f ?? p ?? S, L = t === "pod-local" ? p ?? v ?? N ?? i ?? f ?? S : t === "research-watch" ? v ?? N ?? p ?? i ?? S : p ?? v ?? i ?? N ?? S, Z = t === "creative-production" ? j ?? I ?? J ?? F : t === "research-watch" ? $e(r, "app-skill", ["browser", "channel", "telegram"]) ?? F : F, K = [
    zt("planner", "Planner", "Break goal into tasks, risks, and required context.", se, "No planner agent ready"),
    zt("implementer", "Implementer", "Execute local/app work and return transcript or patch proposal.", be, "No local/app implementer ready"),
    zt("reviewer", "Reviewer", "Independent critique before approval or handoff.", L, "No reviewer agent ready"),
    zt("team-desk", "Team Desk", "Shared mission folder for transcripts, outputs, proposals, and handoff.", c, "Mission folder only until shared folder is bound")
  ];
  (t === "creative-production" || Z) && K.push(zt("app-tool", "App Tool", "Drive installed local app skill through mission context.", Z, "No configured app skill"));
  const W = K.filter((V) => V.status === "ready" || V.status === "available" || V.status === "degraded").length, T = W >= K.length - 1 ? "ready" : W >= 2 ? "partial" : "needs-setup";
  return { ...n, readiness: T, assignments: K };
}
function lt(e, t, n) {
  if (n && Ct.some((i) => i.id === n)) return n;
  const r = e.toLowerCase();
  return /(music|song|audio|video|render|blender|remotion|juli3ta|creative)/.test(r) ? "creative-production" : /(research|watch|monitor|news|summar|scan)/.test(r) ? "research-watch" : (t?.resources ?? []).some((i) => i.kind === "pod-agent" && rr(i)) ? "pod-local" : "repo-repair";
}
function Ni(e) {
...
function Ot(e, t, n) {
  const r = e.trim() || "Coordinate a Tytus mission.", i = kt(t, lt(r, t, n)), s = (v) => i.assignments.find((N) => N.role === v), o = s("planner"), c = s("implementer"), f = s("reviewer"), b = s("team-desk"), p = s("app-tool");
  return [
    {
      id: "task-scope",
      ...
      resourceHint: o ? It(o) : "Planner agent",
      role: "planner",
    ...
    },
    {
      ...
      resourceHint: c ? It(c) : "Local/app implementer",
      role: "implementer",
    ...
    } : null,
    {
      ...
      resourceHint: f ? `${It(f)} · ${b?.resourceLabel ?? "mission folder"}` : "Reviewer + mission folder",
      role: "reviewer",
...
const cr = "tytus.atomek.currentMission", En = "tytus.atomek.currentMissionChanged";
function Ti(e, t) {
...
function Lt(e) {
  ...
  try {
    localStorage.setItem(cr, JSON.stringify(t)), window.dispatchEvent(new CustomEvent(En, { detail: t }));
  } catch {
  }
}
function Ai() {
...
const Ge = {
  ...
  available: !0
}, Xi = "atomek:selected-chat-target", cn = {
  openclaw: "OpenClaw",
  hermes: "Hermes"
...
function ln(e) {
  return e.replace(Bt, "private gateway").replace(_t, "private gateway").replace(en, "private gateway").replace(Ut, "private gateway").replace(Qt, "agent runtime").replace($t, "your Tytus pod").replace(Gt, "agent runtime").replace(/\s{3,}/g, "  ");
}
function qn(e) {
...
function Ci(e) {
  try {
    return localStorage.getItem(lr(e))?.trim() || Ge.id;
  } catch {
    return Ge.id;
  }
}
function Ta(e, t) {
  try {
    localStorage.setItem(lr(e), t || Ge.id);
  } catch {
  }
}
function yt(e, ...t) {
...
function Hi(e) {
  return e.kind !== "pod-agent" ? null : dr([
    e.label,
    e.id,
    yt(e.metadata, "displayName", "display_name", "name", "podName", "pod_name"),
    yt(e.metadata, "agentFamily", "agent_family", "agentType", "agent_type", "internalAgentType", "brand")
  ].join(" "));
}
function ji(e) {
...
function Mi(e) {
  const t = e.trim();
  return t.length < 2 || t.length > 44 ? !1 : Bt.test(t) || _t.test(t) || en.test(t) || Ut.test(t) || Qt.test(t) || $t.test(t) || Gt.test(t) ? (Bt.lastIndex = 0, _t.lastIndex = 0, en.lastIndex = 0, Ut.lastIndex = 0, Qt.lastIndex = 0, $t.lastIndex = 0, Gt.lastIndex = 0, !1) : (Bt.lastIndex = 0, _t.lastIndex = 0, en.lastIndex = 0, Ut.lastIndex = 0, Qt.lastIndex = 0, $t.lastIndex = 0, Gt.lastIndex = 0, /^[\p{L}\p{N}][\p{L}\p{N} ._()'&+-]*$/u.test(t));
}
function Wi(e, t) {
  const n = yt(e.metadata, "displayName", "display_name", "customName", "custom_name", "podDisplayName", "pod_display_name", "name");
  if (n) {
...
function Ii(e) {
  ...
  return e.map((s) => {
    ...
    r[f] = (r[f] ?? 0) + 1;
    const b = t.filter((N) => N.label.toLowerCase() === f).length > 1, p = o === c && n[s.agentFamily] > 1;
    if (!b && !p) return s;
    const v = p ? i[s.agentFamily] : r[f];
    return { ...s, label: `${o} ${v}` };
  });
}
function Fi(e) {
  const t = e.daemon?.state, n = t?.included ?? [], r = t?.agents ?? [], i = new Map(r.map((o) => [o.id, o])), s = n.flatMap((o) => {
    const c = o.id ?? "", b = { ...(o.agentId ? i.get(o.agentId) : void 0)?.meta ?? {}, ...o.meta ?? {} }, p = dr([c, o.kind, yt(b, "displayName", "display_name", "agentFamily", "agentType", "brand")].join(" "));
    return !c || !p ? [] : [{
      id: `pod-agent.${c}`,
      kind: "pod-agent",
      label: cn[p],
  ...
  return ur({ generatedAt: (/* @__PURE__ */ new Date()).toISOString(), resources: s });
}
async function Di(e, t) {
  ...
  const r = ur(n), i = r.length > 0 ? [] : Fi(e), s = /* @__PURE__ */ new Map();
  for (const o of [Ge, ...r, ...i]) s.set(o.id, o);
  return [...s.values()];
}
const aa = "atomek", Je = "atomek:default", Ri = 3e3, ra = "tytus.atomek.threadTitleOverrides", hr = "tytus.atomek.selectedThreadId", za = {
  available: !1,
  source: "none",
  label: "Tytus AI unavailable",
  reason: "host.ai is not available in this Tytus build."
}, mt = (e) => e.role !== "user" && e.role !== "assistant" ? null : {
  id: e.id,
  role: e.role,
  body: e.body,
  status: e.status,
...
}, Ei = (e, t = Ri) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, Ln = (e, t) => {
  const n = e.split(`
`).map((r) => r.replace(/^#+\s*/, "").trim()).find(Boolean);
  return n ? n.length > 80 ? `${n.slice(0, 77)}...` : n : t;
}, qi = (e) => ["briefing", "action-list", "quiz", "plan", "storyboard", "report", "local-draft", "markdown", "memory"].includes(e) ? e : "report", Aa = (e) => ({
  id: e.id,
  title: e.title,
  kind: qi(e.kind),
  body: e.body,
...
`)
  ...
  try {
    const n = sa();
    n[e] = t, localStorage.setItem(ra, JSON.stringify(n));
  } catch {
  }
}, Ji = (e) => {
  try {
    const t = sa();
    delete t[e], localStorage.setItem(ra, JSON.stringify(t));
  } catch {
  }
}, Xa = (e) => {
  const t = sa();
  ...
  try {
    return localStorage.getItem(hr)?.trim() || null;
  } catch {
    return null;
  }
}, it = (e) => {
...
}, an = (e) => `${Je}:agent-session:${e}`, rn = (e) => `${Je}:agent-transcript:${e}`, ia = (e) => `${Je}:${aa}:agent-session:${e}`, sn = (e) => `${Je}:${aa}:agent-transcript:${e}`, mr = 100, Ki = (e, t) => {
  try {
    const n = localStorage.getItem(ia(e))?.trim();
    if (n) return n;
  ...
  try {
    ...
    localStorage.setItem(sn(e), JSON.stringify([...i.values()].slice(-mr)));
  } catch {
  }
}, tn = (e) => {
  if (!e) return [];
  ...
  try {
    const n = tn(localStorage.getItem(sn(e)));
    if (n.length > 0) return n;
    const r = tn(localStorage.getItem(rn(e)));
    return r.length > 0 || !t || t === e ? r : tn(localStorage.getItem(rn(t)));
  } catch {
    return [];
  }
};
function Gi() {
  const e = `${Je}:${aa}:agent-transcript:`, t = [];
  try {
    for (let n = 0; n < localStorage.length; n += 1) {
      const r = localStorage.key(n);
      if (!r || !r.startsWith(e)) continue;
      const i = tn(localStorage.getItem(r));
...
const fr = (e, t) => {
  try {
    localStorage.removeItem(sn(e)), localStorage.removeItem(ia(e)), localStorage.removeItem(rn(e)), localStorage.removeItem(an(e)), t && t !== e && (localStorage.removeItem(rn(t)), localStorage.removeItem(an(t)));
  } catch {
  }
}, $i = (e) => {
  const t = e.daemon;
...
function to({ host: e, requestContext: t, chatSettings: n, selectedTarget: r = Ge, setStatus: i }) {
  const s = e.ai, [o, c] = P(null), [f, b] = P([]), [p, v] = P([]), [N, S] = P([]), [j, I] = P([]), [J, F] = P(za), [se, be] = P(!1), L = Me(!0), Z = Me(null), K = x(async () => {
    if (!s) {
      F(za);
      return;
    }
    try {
      ...
      F({
        ...
        source: "none",
        label: "Tytus AI unavailable",
        reason: z instanceof Error ? z.message : String(z)
      });
    }
  }, [s]), W = x(async (z) => {
    if (s)
      try {
        const C = await s.listArtifacts({ threadId: z });
        if (!L.current) return;
        S(C.map(Aa));
      } catch (C) {
        i(`AI artifacts unavailable: ${C instanceof Error ? C.message : String(C)}`);
      }
  }, [s, i]), T = x(async (z) => {
    if (s)
      try {
        const C = await s.listMessages(z);
        if (!L.current) return;
        const E = f.find((X) => X.id === z) ?? null;
        E && c(E), it(z), v(C.map(mt).filter(Boolean)), I([]), await W(z);
      } catch (C) {
        i(`Load chat failed: ${C instanceof Error ? C.message : String(C)}`);
      }
  }, [s, W, i, f]), V = x(async () => {
    if (s)
      try {
        const z = Xa(await s.listThreads({ workspaceKey: Je, status: "active" })), C = Zi(), E = z.find((ae) => ae.id === C) ?? z[0] ?? await s.createThread({ workspaceKey: Je, title: "Atomek chat" });
        if (!L.current) return;
        b(z[0] ? z : [E]), c(E), it(E.id);
        const X = await s.listMessages(E.id);
        if (!L.current) return;
        v(X.map(mt).filter(Boolean)), await W(E.id);
      } catch (z) {
        i(`AI chat unavailable: ${z instanceof Error ? z.message : String(z)}`);
      }
  }, [s, W, i]);
  le(() => (L.current = !0, K(), V(), () => {
    L.current = !1;
  }), [V, K]);
  const xe = r.kind === "pod-agent" ? r.podId : null;
  le(() => {
    if (r.kind === "pod-agent") {
      v(Ui(r.id, r.podId)), I([]);
      return;
    ...
    return (async () => {
      try {
        const C = await s.listMessages(o.id);
        !z && L.current && v(C.map(mt).filter(Boolean));
      } catch {
      }
    })(), () => {
      z = !0;
  ...
  const ee = x(async () => {
    if (!s) return null;
    if (o) return o;
    const z = await s.createThread({ workspaceKey: Je, title: "Atomek chat" });
    return L.current && (c(z), it(z.id), b((C) => [z, ...C.filter((E) => E.id !== z.id)])), z;
  }, [s, o]), pe = x(async () => {
    if (r.kind === "pod-agent") {
      fr(r.id, r.podId), v([]), I([]), i(`Cleared ${r.label} chat`);
      return;
    }
    if (!s) return;
    const z = await s.createThread({ workspaceKey: Je, title: "Atomek chat" });
    c(z), it(z.id), b((C) => [z, ...C.filter((E) => E.id !== z.id)]), v([]), S([]), I([]), i("New AI chat created");
  }, [s, r, i]), Te = x(async (z, C) => {
    if (!s) return;
    const E = C.trim();
    if (E)
      try {
        const X = s.updateThread, ae = f.find((ve) => ve.id === z) ?? o, ie = typeof X == "function" ? await X({ threadId: z, title: E }) : { ...ae ?? await ee(), id: z, title: E, updatedAt: Date.now() };
        typeof X != "function" && La(z, E), b((ve) => ve.map((g) => g.id === ie.id ? ie : g)), c((ve) => ve?.id === ie.id ? ie : ve), i(typeof X == "function" ? `Renamed chat: ${ie.title}` : `Renamed chat locally: ${ie.title}`);
      } catch (X) {
        i(`Rename chat failed: ${X instanceof Error ? X.message : String(X)}`);
      }
  }, [s, ee, i, o, f]), Oe = x(async (z) => {
    if (s)
      try {
        await s.deleteThread(z), Ji(z);
        const C = f.filter((E) => E.id !== z);
        if (b(C), o?.id === z) {
          const E = C[0] ?? await s.createThread({ workspaceKey: Je, title: "Atomek chat" });
          c(E), it(E.id), b((ae) => ae.some((ie) => ie.id === E.id) ? ae : [E, ...ae]);
          const X = await s.listMessages(E.id);
          v(X.map(mt).filter(Boolean)), await W(E.id);
        }
        i("Deleted AI chat");
      } catch (C) {
        i(`Delete chat failed: ${C instanceof Error ? C.message : String(C)}`);
      }
  }, [s, W, i, o?.id, f]), Ae = x(async (z) => {
    if (!s) return null;
    try {
      const C = await ee();
      if (!C) return null;
      it(C.id);
      const E = await s.createArtifact({
        threadId: C.id,
        messageId: z.messageId ?? null,
        title: z.title?.trim() || Ln(z.body, "Atomek artifact"),
        kind: z.kind ?? "markdown",
        body: z.body
      }), X = Aa(E);
      return S((ae) => [X, ...ae.filter((ie) => ie.id !== X.id)]), i(`Saved AI artifact: ${X.title}`), X;
    } catch (C) {
      return i(`Save artifact failed: ${C instanceof Error ? C.message : String(C)}`), null;
    }
  }, [s, ee, i]), m = x(async (z) => {
    if (s)
      try {
        await s.deleteArtifact(z), S((C) => C.filter((E) => E.id !== z)), i("Deleted AI artifact");
      } catch (C) {
        i(`Delete artifact failed: ${C instanceof Error ? C.message : String(C)}`);
      }
  }, [s, i]), q = x(async (z) => {
    if (!s) return null;
    try {
      const C = await s.writeMemory({
        title: z.title?.trim() || Ln(z.body, "Atomek memory"),
        body: z.body,
        metadata: {
          source: "atomek",
          messageId: z.messageId ?? null
      ...
      return I((E) => [C, ...E.filter((X) => X.id !== C.id)].slice(0, 5)), i(`Remembered: ${C.title}`), C;
    } catch (C) {
      return i(`Remember failed: ${C instanceof Error ? C.message : String(C)}`), null;
    }
  }, [s, i]), G = x(async (z) => {
    if (!s) return [];
    const C = await s.searchMemory({ query: z, limit: 5 });
    return L.current && I(C), C;
  }, [s]), we = x(async (z, C = {}) => {
    const E = z.trim();
    if (!E) return null;
    const X = r;
    ...
    Z.current = ie;
    try {
      const ve = C.requestContext ?? t;
      if (X.kind === "pod-agent") {
        const te = $i(e), B = Date.now(), de = {
          id: `agent-user-${B}`,
          role: "user",
          body: E,
          status: "complete",
          createdAt: B
        }, oe = `agent-assistant-${B}`, Xe = {
          id: oe,
          role: "assistant",
          body: "",
          status: "streaming",
        ...
        if (v((d) => [...d, de, Xe]), Ft(X.id, [de, Xe]), !X.available) {
          const d = qn(X.description), w = { ...Xe, body: d.message, status: "error", error: d.message };
          return v((A) => A.map((O) => O.id === oe ? w : O)), Ft(X.id, [w]), i(d.message), w;
        }
        if (!te) {
          const d = "Agent chat bridge unavailable in this Tytus host build. Update TytusOS host API/runtime to enable OpenClaw and Hermes chat.", w = { ...Xe, body: d, status: "error", error: d };
          return v((A) => A.map((O) => O.id === oe ? w : O)), Ft(X.id, [w]), i("Agent chat bridge unavailable"), w;
        }
        let Ve = "";
        const Qe = (d, w) => (v((A) => A.map((O) => O.id === oe ? d : O)), Ft(X.id, [de, d]), i(w), d);
        try {
          for await (const d of te.chatAgent({
            podId: X.podId,
            routeId: X.routeId ?? null,
            sessionId: Ki(X.id, X.podId),
            message: eo(E, ve),
            mode: "operator",
            target: "agent",
            ...
            if (d.type === "profile") {
              ...
              v(
                (A) => A.map(
                  (O) => O.id === oe ? { ...O, gatewayLabel: w } : O
                )
              );
            }
            if (d.type === "session" && Bi(X.id, d.sessionId), d.type === "token" && (Ve = ln(`${Ve}${d.text}`), v((w) => w.map((A) => A.id === oe ? { ...A, body: Ve, status: "streaming" } : A))), d.type === "error") {
              const w = qn(d.message), A = { ...Xe, body: w.message, status: "error", error: w.message };
              return Qe(A, w.message);
            }
            if (d.type === "done")
              return ae = { ...Xe, body: Ve || "Agent finished without visible output.", status: "complete" }, Qe(ae, `${X.label} answered`);
          }
        } catch (d) {
          if (ie.signal.aborted || d instanceof DOMException && d.name === "AbortError")
            return ae = { ...Xe, body: Ve || "Stopped by user.", status: "complete" }, Qe(ae, `${X.label} response stopped`);
          throw d;
        }
        return ie.signal.aborted ? (ae = { ...Xe, body: Ve || "Stopped by user.", status: "complete" }, Qe(ae, `${X.label} response stopped`)) : ae || (ae = { ...Xe, body: Ve || "Agent finished without visible output.", status: "complete" }, Qe(ae, `${X.label} answered`));
      }
      const g = await ee();
      if (!g || !s) return null;
      it(g.id);
      const re = (g.title ?? "").trim();
      if ((!re || re === "Atomek chat") && E.trim()) {
        const te = Ln(E, "Atomek chat");
        te && te !== re && (async () => {
          try {
            const B = s.updateThread, de = typeof B == "function" ? await B({ threadId: g.id, title: te }) : { ...g, title: te, updatedAt: Date.now() };
            if (typeof B != "function" && La(g.id, te), !L.current) return;
            c((oe) => oe?.id === de.id ? de : oe), b((oe) => oe.map((Xe) => Xe.id === de.id ? de : Xe));
          } catch {
          }
        })();
      }
      const ye = await G(E).catch(() => []), Ee = Yi(ye), Pe = Ee ? [...ve, Ee] : [...ve];
      let Le = null;
      for await (const te of s.sendMessage({
        ...
        if (te.type === "message_created") {
          const B = mt(te.message);
          if (!B) continue;
          B.role === "assistant" && (Le = B.id), v((de) => [...de.filter((oe) => oe.id !== B.id), B]);
        }
        if (te.type === "token" && (Le = te.messageId, v((B) => B.some((de) => de.id === te.messageId) ? B.map(
          (de) => de.id === te.messageId ? { ...de, body: te.body, status: "streaming", sourceLabel: "Atomek" } : de
        ) : [...B, {
          id: te.messageId,
          role: "assistant",
          body: te.body,
          ...
          const B = mt(te.message);
          if (!B) continue;
          B.role === "assistant" && (ae = B), v((de) => de.map((oe) => oe.id === B.id ? B : oe)), B.gatewayLabel && i(`AI answered via ${B.gatewayLabel}`);
        }
        if (te.type === "run_failed") {
          const B = ie.signal.aborted;
          i(B ? "AI response stopped" : `AI failed: ${te.error}`), Le && v((de) => de.map((oe) => oe.id !== Le ? oe : B ? { ...oe, status: "complete", error: void 0, body: oe.body || "Stopped by user." } : { ...oe, status: "error", error: te.error, body: te.error }));
        }
      }
      const Be = Xa(await s.listThreads({ workspaceKey: Je, status: "active" }).catch(() => []));
      return L.current && Be.length > 0 && b(Be), K(), ae;
    } catch (ve) {
      return ve instanceof DOMException && ve.name === "AbortError" ? (i("AI response stopped"), ae) : (i(`AI failed: ${ve instanceof Error ? ve.message : String(ve)}`), null);
    } finally {
      Z.current === ie && (Z.current = null), be(!1);
    }
  }, [s, n.gatewayPreference, n.model, ee, e, G, K, t, r, i]), R = x(() => {
...
const no = (e) => `tytus-workbench:///${encodeURI(e.path)}`, ao = (e) => {
  let t = 2166136261;
  for (let n = 0; n < e.length; n += 1)
    t ^= e.charCodeAt(n), t = Math.imul(t, 16777619);
  return (t >>> 0).toString(16).padStart(8, "0");
}, ro = ({ files: e, openEditorIds: t, activeFileId: n, versions: r, activeSelection: i }) => {
  const s = new Set(t), o = e.map((c) => {
    ...
    return {
      ...
      language: c.language,
      version: r[c.id] ?? 1,
      contentHash: ao(c.content),
      dirty: c.dirty,
      source: c.source,
      selection: f && i ? i : void 0,
      updatedAt: Date.now(),
      open: s.has(c.id),
      active: f
    };
  ...
  return {
    ...
    activeDocumentId: n,
    openDocumentIds: t.filter((c) => o.some((f) => f.id === c))
  };
}, so = "active-file", io = (e) => e === "none" ? "No context" : e === "active-selection" ? "Active selection" : e === "active-file" ? "Active file" : e === "open-editors" ? "Open editors" : e === "selected-files" ? "Selected files" : "Indexed project", oo = (e, t = "file") => `${t}:${e.id}`, co = (e, t) => [
  "selection",
  e.id,
  t.startLineNumber,
  t.startColumn,
  ...
  let i = [];
  return t.scope === "active-selection" ? r?.selection ? i = [lo(r, r.selection, !0)] : r && (i = [Dt(r, !0, "Active file")]) : t.scope === "active-file" ? r && (i = [Dt(r, !0, "Active file")]) : t.scope === "open-editors" ? i = e.openDocumentIds.map((s) => e.byId.get(s)).filter(Boolean).map((s) => Dt(s, !0, "Open editor")) : t.scope === "selected-files" && (i = t.selectedFileIds.map((s) => e.byId.get(s)).filter(Boolean).map((s) => Dt(s, !1, "Selected file"))), ho(i).filter((s) => !n.has(s.id));
}, ho = (e) => {
  const t = /* @__PURE__ */ new Set();
  return e.filter((n) => t.has(n.id) ? !1 : (t.add(n.id), !0));
}, mo = 4e3, fo = 8e3, po = 4e3, bo = (e, t) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, vo = (e, t, n) => {
  const r = uo(e, n), i = [], s = new Map(t.map((o) => [o.id, o]));
  for (const o of r) {
    if (!o.fileId) continue;
    const c = s.get(o.fileId), f = e.byId.get(o.fileId);
    if (!c || !f || !o.includeBody) continue;
    const b = [
      `Path: ${c.path}`,
      `Language: ${c.language}`,
      `Version: ${f.version}`,
      ...
      o.range ? `Range: ${Ca(o.range)}` : null
    ].filter(Boolean).join(`
`), p = o.kind === "selection" && o.range ? yo(c.content, o.range) : c.content, v = o.kind === "selection" ? mo : o.label.startsWith("Open editor") ? po : fo;
    i.push({
...
`));
}, Ca = (e) => `${e.startLineNumber}:${e.startColumn}-${e.endLineNumber}:${e.endColumn}`, Oa = 75e4, go = 2800, wo = 240, ko = 80, xo = /* @__PURE__ */ new Set([
  ".git",
  ".hg",
  ".svn",
  ".next",
  ...
  return n === 0 || e.content.length === 0 ? "empty" : n > (t.maxFileBytes ?? Oa) || e.content.length > (t.maxFileBytes ?? Oa) ? "huge" : !t.includeDirty && e.dirty ? null : Xo(e.path) ? "vendor" : Co(e) ? "binary" : null;
}, Sa = (e, t = {}) => {
  const n = Date.now(), r = [], i = [], s = [];
  for (const o of e) {
    const c = o.size ?? o.content.length, f = Yn(o, t);
    if (f) {
      i.push({ fileId: o.id, name: o.name, path: o.path, language: o.language, reason: f, size: c });
      continue;
    }
    const b = ct(o.content), p = No(o, b, n, t);
    s.push(...p), r.push({
      fileId: o.id,
      name: o.name,
      path: o.path,
...
}, No = (e, t = ct(e.content), n = Date.now(), r = {}) => {
  const i = Math.max(500, r.maxChunkChars ?? go), s = Math.min(Math.max(0, r.chunkOverlapChars ?? wo), Math.floor(i / 2)), o = Math.max(1, r.maxChunksPerFile ?? ko), c = Ao(e.content), f = [];
  let b = 0, p = 0;
  for (; b < e.content.length && f.length < o; ) {
    const v = zo(e.content, b, Math.min(e.content.length, b + i)), N = e.content.slice(b, v).trim();
    if (N.length > 0) {
      const S = Lo(c, b, v);
      f.push({
...
` && t.push(n + 1);
  ...
  const r = Ha(e, t), i = Ha(e, Math.max(t, n - 1));
  return {
    startLineNumber: r + 1,
    startColumn: t - e[r] + 1,
    endLineNumber: i + 1,
  ...
  return 0;
}, Xo = (e) => e.split(/[\\/]+/).filter(Boolean).some((t) => xo.has(t)), Co = (e) => {
  const t = e.name.includes(".") ? e.name.split(".").pop()?.toLowerCase() : void 0;
  if (t && Po.has(t) || e.content.includes("\0")) return !0;
...
class Oo {
  ...
  options;
  constructor(t = [], n = {}) {
    this.options = { ...n }, this.snapshot = Sa(t, this.options);
  }
  getSnapshot() {
  ...
  refresh(t, n = this.options) {
    return this.options = { ...n }, this.snapshot = Sa(t, this.options), this.snapshot;
  }
  update(t, n = this.options) {
    return this.refresh(t, n);
  }
  staleReport(t) {
    return So(this.snapshot, t, this.options);
  }
  isStale(t) {
    return this.staleReport(t).stale;
  }
}
const ft = (e = [], t = {}) => new Oo(e, t), So = (e, t, n = {}) => {
  const r = new Map(t.map((c) => [c.id, c])), i = e.byFileId, s = [];
  for (const c of e.files) {
    const f = r.get(c.fileId);
    if (!f) {
      s.push({ fileId: c.fileId, path: c.path, status: "deleted", indexedHash: c.hash });
      continue;
    }
    if (Yn(f, n)) {
      s.push({ fileId: c.fileId, path: f.path, status: "skipped-now", indexedHash: c.hash, currentHash: ct(f.content) });
      continue;
    }
    const p = ct(f.content);
    p !== c.hash ? s.push({ fileId: c.fileId, path: f.path, status: "changed", indexedHash: c.hash, currentHash: p }) : f.dirty !== c.dirty && s.push({ fileId: c.fileId, path: f.path, status: "dirty-state-changed", indexedHash: c.hash, currentHash: p });
  }
  for (const c of t)
    !i.has(c.id) && !Yn(c, n) && s.push({ fileId: c.id, path: c.path, status: "new", currentHash: ct(c.content) });
  const o = e.signature !== pr(t);
  return { stale: s.length > 0, signatureChanged: o, files: s };
}, Ho = 8, jo = 12e3, br = (e, t, n = {}, r) => {
  const i = Vo(t);
  if (i.length === 0) return [];
  const s = new Set(r?.files.map((p) => p.fileId) ?? []), o = e.chunks.filter((p) => n.includeDirty !== !1 || !p.dirty).map((p) => Io(p, i)).filter((p) => p.score >= (n.minScore ?? 1)).sort((p, v) => v.score - p.score || p.chunk.path.localeCompare(v.chunk.path) || p.chunk.ordinal - v.chunk.ordinal), c = [], f = /* @__PURE__ */ new Set();
  let b = n.maxChars ?? jo;
  for (const p of o) {
    if (c.length >= (n.limit ?? Ho) || b <= 0) break;
    const v = `${p.chunk.fileId}:${p.chunk.ordinal}`;
    if (f.has(v)) continue;
    f.add(v);
    const N = p.chunk.text.length > b ? `${p.chunk.text.slice(0, Math.max(0, b - 28))}
[...context clipped...]` : p.chunk.text;
    c.push(Mo(p, N, s.has(p.chunk.fileId))), b -= N.length;
  }
  return c;
}, Mo = (e, t = e.chunk.text, n = !1) => {
...
`), Vo = (e) => Array.from(new Set(
  ...
  const c = [];
  for (const f of t) {
    const b = Xn(n, f), p = Xn(r, f), v = Xn(i, f), N = s === f ? 1 : 0;
    b + p + v + N !== 0 && (c.push(f), o += Math.min(b, 12), o += p * 4, o += v * 6, o += N * 3, (n.includes(`function ${f}`) || n.includes(`const ${f}`) || n.includes(`class ${f}`) || n.includes(`type ${f}`)) && (o += 3));
  }
  ...
  const n = e.toLowerCase(), r = t.map((f) => n.indexOf(f)).filter((f) => f >= 0).sort((f, b) => f - b)[0] ?? 0, i = Math.max(0, r - 120), s = Math.min(e.length, r + 260), o = i > 0 ? "…" : "", c = s < e.length ? "…" : "";
  return `${o}${e.slice(i, s).replace(/\s+/g, " ").trim()}${c}`;
}, Do = (e, t = {}) => {
  const { autoRefresh: n = !1, ...r } = t, i = Me(e), s = Me(null);
  s.current || (s.current = ft(e, r));
  const [o, c] = P(() => s.current?.getSnapshot() ?? ft(e, r).getSnapshot());
  i.current = e;
  const f = x((N = i.current) => {
    const S = (s.current ?? ft([], r)).refresh(N, r);
    return c(S), S;
  }, [r.maxFileBytes, r.maxChunkChars, r.chunkOverlapChars, r.maxChunksPerFile, r.includeDirty]), b = x((N = i.current) => {
    const S = (s.current ?? ft([], r)).update(N, r);
    return c(S), S;
  }, [f]);
  le(() => {
    n && f(e);
  }, [n, e, f]);
  const p = (s.current ?? ft([], r)).staleReport(e), v = x((N, S = {}) => {
    const j = s.current ?? ft([], r);
    return br(j.getSnapshot(), N, S, j.staleReport(i.current));
  }, []);
  return { snapshot: o, staleReport: p, isStale: p.stale, refresh: f, update: b, retrieve: v };
}, Ro = "tytus.atomek.semanticVector:v1", vr = "__gateway_default__", yr = (e) => e?.trim() || vr, Eo = (e) => {
  const t = yr(e);
  return t === vr ? "gateway default" : t;
}, gr = (e, t, n) => [
  Ro,
  ...
  if (!wr()) return null;
  try {
    const r = gr(e, t, n), i = window.localStorage.getItem(r);
    if (!i) return null;
  ...
  if (!wr()) return null;
  try {
    const t = gr(e.appId, e.modelAlias, { id: e.chunkId, hash: e.contentHash }), n = { ...e, key: t };
    return window.localStorage.setItem(t, JSON.stringify(n)), n;
  } catch {
    return null;
  }
}, At = 8, Jo = 12e3, Zo = 180, Ko = async (e, t, n, r, i = {}, s, o) => {
  const c = br(t, n, { ...i, limit: Math.max(i.limit ?? At, 16) }, s), f = e.ai;
  if (typeof f?.embedText != "function")
    return { hits: c.slice(0, i.limit ?? At), mode: "keyword", reason: "Semantic index unavailable — using keyword retrieval.", embeddedChunks: 0 };
  try {
    const b = yr(r.embeddingModel), p = await f.embedText({
      input: n,
    ...
    const N = new Map(c.map((L) => [L.chunkId, L])), S = ec(n), j = /* @__PURE__ */ new Map();
    t.chunks.filter((L) => i.includeDirty !== !1 || !L.dirty).slice(0, Zo).forEach((L) => j.set(L.id, L)), c.forEach((L) => {
      const Z = t.byChunkId.get(L.chunkId);
      Z && j.set(Z.id, Z);
    });
    const I = Array.from(j.values()), J = [];
    let F = 0;
    for (const L of I) {
      o?.aborted;
      const Z = qo(e.appId, b, L) ?? await Uo(f, e.appId, b, L, r, o);
      if (!Z) continue;
      Z.updatedAt > Date.now() - 1e3 && (F += 1);
      const K = $o(v, Z.vector);
      if (!Number.isFinite(K)) continue;
      const T = N.get(L.id)?.score ?? tc(L, S), V = _o(T) * 0.42 + Math.max(0, K) * 0.58;
      J.push({ chunk: L, keywordScore: T, vectorScore: K, score: V, matchedTerms: S.filter((xe) => L.text.toLowerCase().includes(xe)) });
    }
    if (J.length === 0) return { hits: c.slice(0, i.limit ?? At), mode: "vector-fallback", reason: "Semantic retrieval produced no vectors — using keyword retrieval.", embeddedChunks: F };
    const se = new Set(s?.files.map((L) => L.fileId) ?? []), be = J.sort((L, Z) => Z.score - L.score || Z.keywordScore - L.keywordScore || L.chunk.path.localeCompare(Z.chunk.path) || L.chunk.ordinal - Z.chunk.ordinal).slice(0, Math.max(i.limit ?? At, 1)).map((L) => Go(L, se.has(L.chunk.fileId)));
    return {
      hits: Qo(be, i.maxChars ?? Jo),
      mode: "hybrid",
      reason: `Hybrid retrieval used ${Eo(r.embeddingModel)} embeddings + keyword ranking.`,
      embeddedChunks: F
    };
  } catch (b) {
    return {
      hits: c.slice(0, i.limit ?? At),
  ...
  return {
    ...
    text: e.chunk.text,
    snippet: nc(e.chunk.text, e.matchedTerms),
    score: e.score,
...
}, _o = (e) => Math.min(1, Math.max(0, e / 24)), ec = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), tc = (e, t) => {
  const n = `${e.path}
${e.name}
...
}, ac = /```([^\n`]*)\n([\s\S]*?)```/g, rc = /^@@\s+-(\d+)(?:,\d+)?\s+\+(\d+)(?:,\d+)?\s+@@/;
function oa(e) {
  return Array.from(e.matchAll(ac)).map((t) => xr(t[1] ?? "", lc(t[2] ?? ""))).filter((t) => t.content.trim().length > 0);
}
function xr(e, t) {
  const n = e.trim().split(/[\s,]+/).filter(Boolean), r = {}, i = [];
  for (const s of n) {
    const o = s.match(/^([a-z0-9_-]+)=(.+)$/i);
    o ? r[o[1].toLowerCase()] = uc(o[2]) : i.push(s.toLowerCase());
  }
  return { lang: e.trim().toLowerCase(), flags: i, attrs: r, content: t };
}
function Ye(e, t) {
  return (typeof e == "string" ? xr(e, "").flags : e.flags).includes(t.toLowerCase());
}
function Pr(e) {
  return [...oa(e).filter((r) => Ye(r, "diff") || Ye(r, "patch")).map((r) => r.content), e].filter((r, i, s) => sc(r) && s.findIndex((o) => o === r) === i);
}
function sc(e) {
...
function Cn(e) {
  const t = e.match(/^diff --git\s+(?:"?a\/(.+?)"?|(\S+))\s+(?:"?b\/(.+?)"?|(\S+))/m), n = e.match(/^---\s+(?:"?a\/(.+?)"?|(\S+))/m), r = e.match(/^\+\+\+\s+(?:"?b\/(.+?)"?|(\S+))/m), i = _e(t?.[1] || t?.[2] || n?.[1] || n?.[2] || "") || null, s = _e(t?.[3] || t?.[4] || r?.[1] || r?.[2] || "") || null, o = s && s !== "/dev/null" ? s : i;
...
function Jn(e) {
  return oa(e).filter((t) => oc(t)).map((t) => ({
    content: dc(t.content),
...
function oc(e) {
  return Ye(e, "atomek-replace") || Ye(e, "atomek-full") || Ye(e, "full-replacement") || Ye(e, "full") || Ye(e, "replace");
}
function cc(e) {
...
`), i = [];
  ...
  for (let c = 0; c < r.length; c += 1) {
    const f = r[c].match(rc);
    if (!f) continue;
    o = !0;
    const b = Number(f[1]), p = Math.max(0, b - 1);
    if (p < s) return null;
...
function hc(e) {
  ...
  for (const p of Pr(t))
    for (const v of ic(p)) {
      if (!v.path) {
        if (i) {
          const j = Zn(i.content, v.raw);
          j && j !== i.content && o.set(i.id, Rt({
            file: i,
            proposedContent: j,
            sourceTitle: r,
      ...
      const S = Zn(N.file.content, v.raw);
      if (!S || S === N.file.content) {
  ...
  for (const p of Jn(t)) {
    const v = p.path ? ja(n, p.path) : i ? { file: i, normalizedPatchPath: _e(i.path), confidence: "exact" } : null;
    if (!v) {
  ...
  const f = Jn(t).some((p) => p.path);
  if (o.size === 0 && i && !f) {
    const p = mc(t, i);
    p && p.content !== i.content && o.set(i.id, Rt({
      file: i,
      proposedContent: p.content,
      sourceTitle: r,
      extractionLabel: p.label,
...
`), i = Math.max(n.length, r.length);
  let s = 0, o = 0, c = 0;
  for (let f = 0; f < i; f += 1)
    n[f] !== r[f] && (n[f] === void 0 ? s += 1 : r[f] === void 0 ? o += 1 : c += 1);
...
function Rt(e) {
  ...
  return {
    ...
    stats: fc(e.file.content, e.proposedContent),
    base: {
...
const dn = (e) => typeof e == "object" && e !== null, yc = (e) => dn(e.ai) ? e.ai : null, gc = (e) => {
  if (!dn(e)) return null;
  const t = e.id;
...
}, Ue = (e) => typeof e == "string" ? /\bembeddings?\b|text-embedding/i.test(e) : Array.isArray(e) ? e.some(Ue) : dn(e) ? Object.values(e).some(Ue) : !1, kc = async (e, t) => {
  const n = yc(e);
  if (typeof n?.listModels != "function") return [];
  const r = await n.listModels(t);
  return Array.isArray(r) ? r.map(wc).filter((i) => !!i) : [];
}, xc = (e) => (e.embedding ?? e.embeddings ?? e.supportsEmbedding ?? e.supportsEmbeddings) === !0 ? !0 : Ue(e.capability) || Ue(e.capabilities) || Ue(e.modality) || Ue(e.modalities) || Ue(e.task) || Ue(e.tasks) || Ue(e.type) || Ue(e.kind), Tr = (e) => typeof e == "object" && e !== null, Pc = (e) => Tr(e.ai) ? e.ai : null, zr = (e) => typeof Pc(e)?.embedText == "function", Nc = async (e, t) => zr(e) ? (await kc(e, t)).filter(xc) : [], Tc = (e) => Tr(e.ai) ? zr(e) ? null : "host.ai.embedText is not exposed by this Tytus build." : "host.ai is not available in this Tytus build.", zc = ["typecheck", "test", "lint", "build", "release:check", "verify", "verify:cortex"], Ac = [
...
function Oc(e) {
  const t = e.results.length > 0 ? e.results.map((r, i) => [
    ...
    `Status: ${r.status}`,
    "Output:",
    Fc(r.output || "(no output pasted)", "text")
  ].join(`
`)).join(`
...
function Hc(e) {
  ...
  for (const r of t) {
    const i = jc(r.content);
    if (!i?.scripts) continue;
    const s = Lr(r.path), o = Mc(e, s, i);
    if (!o) continue;
    const c = Object.keys(i.scripts).filter((b) => typeof i.scripts?.[b] == "string"), f = Wc(c);
    for (const b of f) {
      const p = `${o} run ${b}`;
      n.push({
        id: Xr(`${s}:${p}`),
...
function Mc(e, t, n) {
  ...
  for (const [r, i] of Ac)
    if (e.some((s) => Ic(s.path) === r && Lr(s.path) === t)) return i;
  return null;
}
function Wc(e) {
  const t = zc.filter((r) => e.includes(r)), n = e.filter((r) => !t.includes(r)).filter((r) => /(^|:)(check|typecheck|test|lint|verify|build)(:|$)/i.test(r)).sort((r, i) => r.localeCompare(i));
  return [...t, ...n];
}
function Vc(e) {
  const t = /* @__PURE__ */ new Set();
...
function Yc({ className: e }) {
  return /* @__PURE__ */ a("img", { src: qc, alt: "ATOMEK", className: e, draggable: !1 });
}
const Or = {
...
}, Ma = { en: Or, es: Jc }, Wa = (e) => (e || "en").toLowerCase().split("-")[0] || "en", Zc = (e, t) => t ? e.replace(/\{(\w+)\}/g, (n, r) => String(t[r] ?? `{${r}}`)) : e, Sr = gs({ locale: "en", t: (e) => Or[e] ?? e });
function Kc({ host: e, children: t }) {
  const [n, r] = P(() => Wa(e.i18n?.locale));
  le(() => e.i18n?.onLocaleChange((s) => r(Wa(s))), [e]);
  const i = he(() => ({
    locale: n,
    t: (s, o) => {
      const c = e.i18n?.t(s, o);
      return c && c !== s ? c : Zc(Ma[n]?.[s] ?? Ma.en[s] ?? s, o);
    }
  }), [e, n]);
  return /* @__PURE__ */ a(Sr.Provider, { value: i, children: t });
}
function Ke() {
  return ws(Sr).t;
}
const Bc = `# Tytus Resource Fabric
...
], el = "tytus-atomek-handles", gt = "handles", tl = 1, Hr = () => new Promise((e, t) => {
  const n = indexedDB.open(el, tl);
  n.onupgradeneeded = () => {
    const r = n.result;
    r.objectStoreNames.contains(gt) || r.createObjectStore(gt);
  }, n.onsuccess = () => e(n.result), n.onerror = () => t(n.error ?? new Error("Failed to open Atomek handle store"));
});
async function Va(e, t) {
  const n = await Hr();
  await new Promise((r, i) => {
    const s = n.transaction(gt, "readwrite");
    s.objectStore(gt).put(t, e), s.oncomplete = () => r(), s.onerror = () => i(s.error ?? new Error("Failed to persist file handle"));
  }), n.close();
}
async function On(e) {
  const t = await Hr(), n = await new Promise((r, i) => {
    const o = t.transaction(gt, "readonly").objectStore(gt).get(e);
    o.onsuccess = () => r(o.result ?? null), o.onerror = () => i(o.error ?? new Error("Failed to read file handle"));
  });
  return t.close(), n;
}
const nl = ks(() => import("./WorkbenchMonacoEditor-DeMocMpz.js").then((e) => e.W).then((e) => ({ default: e.WorkbenchMonacoEditor }))), al = {
  id: "welcome",
  name: "Agent Team",
  path: "Agent Team",
  language: "text",
  ...
  dirty: !1,
  source: "sample"
}, jr = "tytus.workspace.recent", Mr = "tytus.workspace.layout", Wr = "tytus.atomek.session.v2", Vr = "tytus.atomek.chatAiSettings", Sn = "atomek:default", Ia = "0.4.34", nn = {
...
function Hn(e) {
  const t = Math.max(e || 1400, 760), n = Math.max(0, t - rl), r = n < 1180, i = r ? 200 : 240, s = r ? 280 : 300, o = r ? 360 : 420, c = Math.max(i, Math.min(r ? 340 : 420, Math.floor(n * 0.28))), f = Math.min(300, c), b = Math.floor(n * (r ? 0.5 : 0.62)), p = n - f - o, v = Math.max(s, Math.min(r ? 1e3 : 1400, b, p));
...
function cl({ host: e }) {
  const t = Ke(), n = Me(null), [r, i] = P(0), s = he(() => Zl(), []), o = he(() => Rl(), []), c = he(() => Dl(Fl(), o.recent), [o.recent]), [f, b] = P(() => sl(o.activity) || "explorer"), [p, v] = P(s.primaryVisible), [N, S] = P(s.primaryWidth), [j, I] = P(o.secondaryTab ?? "chat"), [J, F] = P(s.secondaryVisible), [se, be] = P(s.secondaryWidth), [L, Z] = P(!!o.bottomPanelVisible), [K, W] = P(() => il(o.bottomPanelTab)), [T, V] = P(s.markdownPreviewVisible), [xe, ee] = P(!!o.welcomeClosed), [pe, Te] = P(o.folder ? { name: o.folder.name, files: [] } : null), [Oe, Ae] = P(o.folder?.handleKey ?? null), [m, q] = P(() => El(o.files)), [G, we] = P(() => (o.openEditorIds ?? []).filter((l) => (o.files ?? []).some((h) => h.id === l))), [R, z] = P(() => o.activeFileId && (o.files ?? []).some((l) => l.id === o.activeFileId) ? o.activeFileId : null), [C, E] = P(o.query ?? ""), [X, ae] = P({ lineNumber: 1, column: 1 }), [ie, ve] = P(null), [g, re] = P({}), [fe, ye] = P(so), [Ee, Pe] = P([]), [Le, Be] = P([]), [te, B] = P(null), [de, oe] = P(o.chatInput ?? ""), [Xe, Ve] = P(!1), [Qe, d] = P(""), [w, A] = P([]), [O, H] = P(null), [D, U] = P(null), [ce, Se] = P(!1), [Ce, ue] = P(() => Kl()), [$, _] = P([Ge]), [ze, Ie] = P(() => Ci(Sn)), [He, ke] = P(null), [Fe, un] = P(null), [hn, mn] = P(""), [fn, pn] = P(""), [Ht, jt] = P(""), [Mt, la] = P("failed"), [Jr, da] = P(null), [Zr, M] = P("Ready"), [xt, Kr] = P(() => c), De = G.map((l) => m.find((h) => h.id === l)).filter(Boolean), Y = R ? m.find((l) => l.id === R) ?? null : null, ua = he(() => ro({ files: m, openEditorIds: G, activeFileId: R, versions: g, activeSelection: ie }), [R, ie, g, m, G]), ha = he(() => ({
    scope: fe,
    removedAttachmentIds: Ee,
    selectedFileIds: []
  }), [fe, Ee]), Pt = he(() => vo(ua, m, ha), [ha, ua, m]), et = Do(m, { autoRefresh: !0, includeDirty: !0 }), ma = he(() => Le.map((l) => ({
    id: l.id,
    kind: "index-hit",
    label: l.label,
    path: l.path,
    ...
    snippet: l.snippet
  })), [Le]), Br = he(() => [...Pt.attachments, ...ma], [Pt.attachments, ma]), fa = he(() => $.find((l) => l.id === ze) ?? Ge, [$, ze]), ne = to({ host: e, requestContext: Pt.parts, chatSettings: Ce, selectedTarget: fa, setStatus: M }), rt = he(
    () => [...ne.artifacts, ...w].sort((l, h) => h.createdAt - l.createdAt),
    [ne.artifacts, w]
  ), Wt = ce && !Y, bn = !Y && !Wt && !xe, je = he(() => m.filter((l) => l.dirty), [m]), Ur = he(() => {
    const l = C.trim().toLowerCase();
    return l ? m.filter((h) => h.path.toLowerCase().includes(l)) : m;
  }, [m, C]);
  le(() => {
    re((l) => {
      const h = {};
      for (const y of m) h[y.id] = l[y.id] ?? 1;
      return h;
    });
  }, [m]), le(() => {
    Pe([]), Be([]);
    ...
    const h = async () => {
      const k = await Di(e);
      l && (_(k), Ie((Q) => {
        const ge = k.some((st) => st.id === Q) ? Q : Ge.id;
        return ge !== Q && Ta(Sn, ge), ge;
      }));
    };
    h();
  ...
  const Gr = x((l) => {
    const h = $.find((y) => y.id === l) ?? Ge;
    Ie(h.id), Ta(Sn, h.id), M(`Chat target: ${h.label}`);
  }, [$, M]), Qr = x((l) => {
    if (l.kind === "index-hit") {
      Be((h) => h.filter((y) => y.id !== l.id)), M(`Removed project context: ${l.label}`);
      return;
    }
    Pe((h) => h.includes(l.id) ? h : [...h, l.id]), M(`Removed chat context: ${l.label}`);
  }, []), Vt = x(() => {
    Se(!0), z(null), ee(!0), M("Atomek settings opened");
  }, []), pa = x(() => {
    Se(!1), z((l) => l ?? G.at(-1) ?? null), G.length === 0 && ee(!1), M("Atomek settings closed");
  }, [G]), dt = x((l) => {
    re((h) => ({ ...h, [l]: (h[l] ?? 1) + 1 }));
  }, []), $r = x((l) => {
    l.preventDefault(), l.currentTarget.setPointerCapture?.(l.pointerId);
    const h = Hn(r), y = l.clientX, k = se, Q = (st) => {
      const Tn = k + (y - st.clientX);
      be(qt(Tn, h.secondaryMin, h.secondaryMax));
    }, ge = () => {
      window.removeEventListener("pointermove", Q), window.removeEventListener("pointerup", ge);
    };
    window.addEventListener("pointermove", Q), window.addEventListener("pointerup", ge);
  }, [se, r]), _r = x((l) => {
    l.preventDefault(), l.currentTarget.setPointerCapture?.(l.pointerId);
    const h = Hn(r), y = l.clientX, k = N, Q = (st) => {
      const Tn = k + (st.clientX - y);
      S(qt(Tn, h.primaryMin, h.primaryMax));
    }, ge = () => {
      window.removeEventListener("pointermove", Q), window.removeEventListener("pointerup", ge);
    };
    window.addEventListener("pointermove", Q), window.addEventListener("pointerup", ge);
    ...
    Kr((h) => {
      const y = [l, ...h.filter((k) => k.path !== l.path)].slice(0, 10);
      return localStorage.setItem(jr, JSON.stringify(y)), y;
    });
  }, []), Ne = x((l, h) => {
    we((y) => y.includes(l.id) ? y : [...y, l.id]), z(l.id), ee(!1), da(h ?? null), ae({ lineNumber: h ?? 1, column: 1 });
  }, []), es = x((l) => {
    const h = {
      id: `atomek-doc:${l.id}`,
      name: l.fileName,
    ...
    q((y) => Jt(y, [h])), Ne(h), I("chat"), F(!0), V(!0), M(`Opened Atomek guide: ${l.title}`);
  }, [Ne]), ts = x((l) => {
    if (!l.fileId) return;
    const h = m.find((y) => y.id === l.fileId);
    h && (Ne(h, l.range?.startLineNumber ?? 1), M(`Revealed context: ${l.label}`));
  }, [m, Ne]), Nt = x(async () => {
    if (jn(je, "open new files"))
      try {
        const l = await fi();
        if (l.length === 0) return;
        q((h) => Jt(h, l)), await Promise.all(l.map(async (h) => {
          const y = h.handle ? `file:${h.path}` : void 0;
          h.handle && y && await Va(y, h.handle), tt({ name: h.name, path: h.path, kind: "file", handleKey: y, at: Date.now() });
        })), Ne(l[0]), M(`Opened ${l.length} local file${l.length === 1 ? "" : "s"}`);
      } catch (l) {
        l.name !== "AbortError" && M(`Open file failed: ${l.message}`);
      }
  }, [je, Ne, tt]), vn = x(async () => {
    if (jn(je, "open another folder"))
      try {
        const l = await pi(), h = l.handle ? `folder:${l.name}:${Date.now()}` : null;
        l.handle && h && await Va(h, l.handle), Ae(h), Te(l), q(l.files), we([]), z(null), ee(!1), tt({ name: l.name, path: l.name, kind: "folder", handleKey: h ?? void 0, at: Date.now() }), M(`${l.handle ? "Opened local folder" : "Opened browser fallback folder"} ${l.name} (${l.files.length} text files indexed)`);
      } catch (l) {
        l.name !== "AbortError" && M(`Open folder failed: ${l.message}`);
      }
  }, [je, tt]), ns = x((l) => {
    if (!R) return;
    let h = !1;
    q((y) => y.map((k) => k.id !== R || k.content === l ? k : (h = !0, { ...k, content: l, dirty: !0 }))), h && dt(R);
  }, [R, dt]), yn = x(async () => {
    if (Y)
      try {
        const l = await An(Y);
        q((h) => h.map((y) => y.id === l.id ? l : y)), M(`Saved ${l.name}`);
      } catch (l) {
        M(`Save failed: ${l.message}`);
      }
  }, [Y]), as = x(async (l) => {
    const h = m.find((k) => k.id === l);
    if (!h) return null;
    const y = await An(h);
    return q((k) => k.map((Q) => Q.id === y.id ? y : Q)), y;
  }, [m]), ba = x(async () => {
    const l = m.filter((h) => h.dirty);
    if (l.length === 0) {
      M("No dirty files to save");
      return;
    }
    try {
      const h = await Promise.all(l.map((k) => An(k))), y = new Map(h.map((k) => [k.id, k]));
      q((k) => k.map((Q) => y.get(Q.id) ?? Q)), ke(null), M(`Saved ${h.length} dirty file${h.length === 1 ? "" : "s"}`);
    } catch (h) {
      M(`Save all failed: ${h.message}`);
    }
  }, [m]), gn = x((l) => {
    const h = m.find((y) => y.id === l);
    if (h?.dirty && !window.confirm(`${h.name} has unsaved changes. Close without saving?`)) {
      M(`Close canceled — ${h.name} has unsaved changes`);
      return;
    }
    we((y) => {
      const k = y.filter((Q) => Q !== l);
      return R === l && (z(k.at(-1) ?? null), ve(null)), k;
    });
  }, [R, m]), rs = x(() => {
    jn(je, "close all editors") && (we([]), z(null), da(null), ee(!1), M("Closed all editors"));
  }, [je]), wn = x(() => {
    const l = m.filter((y) => y.name.startsWith("Untitled")).length + 1, h = {
...
`,
    ...
    return Be(k), k.length === 0 ? (M(et.snapshot.chunks.length === 0 ? "Project index is empty — open a folder with readable files first" : "Project index found no matching context for this prompt"), h) : (y.mode !== "hybrid" && y.reason ? M(y.reason) : M(`${k.length} project context hit${k.length === 1 ? "" : "s"} · ${y.reason ?? "hybrid retrieval"}`), [
      ...h,
      ...Bo(k)
    ]);
  }, [Pt.parts, fe, Ce, e, et]), kn = x(() => {
    if (!Y && De.length === 0) {
      M("Open a file before asking Atomek to synthesize an AI artifact");
      return;
    }
    const h = [
      `Create a polished Markdown artifact from ${Y?.path ?? `${De.length} open editors`}.`,
    ...
    F(!0), I("chat"), M("Asking Atomek to synthesize an AI artifact…"), (async () => {
      const y = await nt(h), k = await ne.askAgent(h, { requestContext: y });
      !k || k.status === "error" || ne.createArtifact({
        messageId: k.id,
        title: `AI synthesis — ${Y?.name ?? "open workspace"}`,
        kind: "markdown",
        body: k.body
      }).then(() => {
        F(!0), I("outputs"), Z(!0), W("output");
      });
    })();
  }, [Y, ne, nt, De.length]), xn = x(async (l) => {
    if (l.kind === "folder") {
      const y = m.filter((k) => k.path === l.path || k.path.startsWith(`${l.path}/`));
      if (pe?.name === l.name || y.length > 0) {
        y.length > 0 && (Te((k) => k?.name === l.name ? k : { name: l.name, files: y }), q((k) => Jt(k, y))), b("explorer"), v(!0), z(null), ee(!1), tt({ ...l, at: Date.now() }), M(`Opened recent folder ${l.name}`);
        return;
      }
    }
    const h = m.find((y) => y.path === l.path || y.name === l.name);
    if (h) {
      Ne(h), M(`Opened recent ${h.name}`);
      return;
    }
    if (!l.handleKey) {
    ...
    try {
      if (l.kind === "folder") {
        ...
        const ge = await Pa(Q);
        Ae(l.handleKey), Te(ge), q(ge.files), we([]), z(null), ee(!1), tt({ ...l, at: Date.now() }), M(`Reopened ${ge.name} (${ge.files.length} text files indexed)`);
        return;
      }
      ...
      const k = await bi([y]);
      if (!k[0]) {
        M(`Recent file is not readable text: ${l.name}`);
        return;
      }
      q((Q) => Jt(Q, k)), Ne(k[0]), tt({ ...l, at: Date.now() }), M(`Reopened ${k[0].name}`);
    } catch (y) {
      M(`Open recent failed: ${y instanceof Error ? y.message : String(y)}`);
    }
  }, [m, pe?.name, Ne, tt]), Re = x((l) => {
    F(!0), I("chat"), oe(""), (async () => {
      const h = await nt(l);
...
`);
      oe((Q) => [Q.trim(), k].filter(Boolean).join(`

`)), F(!0), I("chat"), M(`Attached skill ${h.title} to chat input`);
    } catch (h) {
      M(`Failed to attach skill: ${h instanceof Error ? h.message : String(h)}`);
    }
  }, [e.skills]), ss = x((l) => {
    const h = ne.messages.findIndex((k) => k.id === l.id), y = ne.messages.slice(0, h < 0 ? void 0 : h).reverse().find((k) => k.role === "user");
    if (!y?.body.trim()) {
      M("No previous user prompt to regenerate from");
      return;
    }
    (async () => {
      const k = await nt(y.body);
      await ne.askAgent(y.body, { requestContext: k });
    })();
  }, [ne, nt]), is = x((l) => {
    ne.createArtifact({
      messageId: l.id,
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek memory",
    ...
    const h = Wn(m, Mn(l.title || l.kind)), y = {
    ...
    q((k) => [...k, y]), Ne(y), M(`Opened ${l.title} as editable file`);
  }, [m, Ne]), Nn = x(() => {
...
`), Q = {
    ...
    A((ge) => [Q, ...ge]), Z(!0), W("output"), M(`Captured manual check: ${h}`);
  }, []), ut = x((l, h) => {
    const y = hc({
      body: h,
      files: m,
      ...
      edits: y.edits.map(Vl),
      skipped: y.skipped
    };
    return y.edits.length > 1 ? (U(k), H(null), M(`Previewing AI workspace patch for ${y.edits.length} files`), !0) : y.edits.length === 1 ? (H(k.edits[0]), U(null), M(`Previewing AI patch for ${k.edits[0].fileName}`), !0) : (M(y.skipped.length > 0 ? `No applicable edit found. ${y.skipped.slice(0, 2).join(" · ")}` : "No fenced replacement block or applicable unified diff found. Ask Atomek for an edit again."), !1);
  }, [Y, g, m]), ya = x((l, h) => {
    const y = {
    ...
    A((k) => [y, ...k]), F(!0), I("outputs"), Z(!0), W("output"), M(`Saved local job output: ${l}`), (h.includes("```diff") || h.includes("--- a/")) && ut(l, h);
  }, [ut]), ls = x(() => {
    const l = de.trim();
    if (!l) return;
    oe("");
    const h = zl(l);
    (async () => {
      const y = await nt(l), k = await ne.askAgent(l, { requestContext: y });
      if (!h || !k || k.status === "error") return;
      ut(k.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek edit", k.body) || M("Edit request answered without a patch. Use Generate patch / Edit to request an applicable diff.");
    })();
  }, [ne, nt, de, ut]), ds = x(() => {
    te && (B(null), Re(Al(te)));
  }, [Re, te]), Tt = x((l) => {
    ...
    jt(y), mn(""), pn(""), la("failed"), Z(!0), W("terminal"), M(h.commands.length > 0 ? `Manual check ready: copy ${h.commands[0].command}` : "Manual check ready: enter a check command to copy");
  }, [m]), us = x((l) => {
    l.trim() && (wt(l), jt(l), M(`Manual check command copied: ${l}`));
  }, []), hs = x(() => {
    un((l) => {
      if (!l) return l;
      const h = Xc(l, hn), y = h.commands.at(-1)?.command ?? "";
      return y && jt(y), h;
    }), mn("");
  }, [hn]), ms = x(() => {
    if (!Fe || !Ht.trim()) {
    ...
    const l = Ht.trim();
    un((h) => h && Cc(h, l, Mt, fn)), pn(""), M(`Captured manual check result: ${l} (${Mt})`);
  }, [fn, Ht, Fe, Mt]), fs = x(() => {
    Fe && Re(Oc(Fe));
  }, [Re, Fe]), ps = x(() => {
    if (!O) return;
    const l = m.find((h) => h.id === O.fileId);
    if (!l) {
      M(`Cannot apply edit — ${O.fileName} is no longer open`), H(null);
      return;
    }
    l.content !== O.originalContent && !window.confirm(`${O.fileName} changed after the preview was created. Apply the AI edit anyway?`) || (q((h) => h.map((y) => y.id === O.fileId ? { ...y, content: O.proposedContent, dirty: !0 } : y)), dt(O.fileId), ke(`AI edit applied to ${l.name}. Save All to persist it to disk.`), H(null), Tt(`AI edit applied to ${l.name}`), M(`Applied AI edit to ${l.name} — unsaved; manual check ready`));
  }, [dt, m, O, Tt]), bs = x(() => {
    if (!O) return;
    const l = Wn(m, `${Mn(O.fileName)}-ai-edit`), h = {
      id: `pending-edit-${O.fileId}-${Date.now()}`,
      name: l,
      path: l,
      language: Y?.language ?? "markdown",
      content: O.proposedContent,
      dirty: !0,
      source: "generated"
    };
    q((y) => [...y, h]), Ne(h), H(null), M(`Opened proposed edit as ${l}`);
  }, [Y?.language, m, Ne, O]), vs = x(() => {
    if (!D) return;
    const l = new Map(D.edits.map((y) => [y.fileId, y]));
    m.some((y) => {
      const k = l.get(y.id);
      return k && y.content !== k.originalContent;
    }) && !window.confirm("One or more files changed after the workspace patch preview was created. Apply anyway?") || (q((y) => y.map((k) => {
      const Q = l.get(k.id);
      return Q ? { ...k, content: Q.proposedContent, dirty: !0 } : k;
    })), l.forEach((y, k) => dt(k)), ke(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}. Save All to persist changes.`), U(null), Tt(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}`), M(`Applied AI workspace patch to ${l.size} file${l.size === 1 ? "" : "s"} — unsaved; manual check ready`));
  }, [dt, m, D, Tt]), ys = x(() => {
    if (!D) return;
    const l = [...m], h = D.edits.map((y) => {
      const k = Wn(l, `${Mn(y.fileName)}-ai-edit`), Q = m.find((st) => st.id === y.fileId), ge = {
        id: `workspace-patch-${y.fileId}-${Date.now()}-${k}`,
        name: k,
        path: k,
    ...
    q((y) => [...y, ...h]), h[0] && Ne(h[0]), U(null), M(`Opened ${h.length} proposed edit file${h.length === 1 ? "" : "s"}`);
  }, [m, Ne, D]), ga = x((l) => {
    if (l === "explain") {
  ...
  return le(() => {
    const l = (h) => {
      (h.metaKey || h.ctrlKey) && (h.key.toLowerCase() === "o" && (h.preventDefault(), Nt()), h.key.toLowerCase() === "s" && (h.preventDefault(), yn()), h.key.toLowerCase() === "w" && (h.preventDefault(), R && gn(R)), h.key.toLowerCase() === "b" && (h.preventDefault(), v((k) => !k)), h.shiftKey && h.key.toLowerCase() === "f" && (h.preventDefault(), b("search"), v(!0)), (h.key.toLowerCase() === "k" || h.key.toLowerCase() === "p") && (h.preventDefault(), Ve(!0)));
    };
    return window.addEventListener("keydown", l), () => window.removeEventListener("keydown", l);
  }, [R, gn, Nt, yn]), le(() => {
    const l = (h) => {
      je.length !== 0 && (h.preventDefault(), h.returnValue = "");
    };
    ...
    if (!r) return;
    const l = Hn(r);
    S((h) => qt(h, l.primaryMin, l.primaryMax)), be((h) => qt(h, l.secondaryMin, l.secondaryMax));
  }, [r]), le(() => {
    const l = { primaryVisible: p, primaryWidth: N, secondaryVisible: J, secondaryWidth: se, markdownPreviewVisible: T };
    localStorage.setItem(Mr, JSON.stringify(l));
  }, [T, p, N, J, se]), le(() => {
    ...
    return (async () => {
      try {
        ...
        const y = await Pa(h);
        if (l) return;
        Ae(o.folder?.handleKey ?? null), Te(y), q((k) => Jl(k, y.files)), we((k) => k.filter((Q) => y.files.some((ge) => ge.id === Q) || m.some((ge) => ge.id === Q))), M(`Restored ${y.name} (${y.files.length} text files indexed)`);
      } catch (h) {
        l || M(`Workspace restore failed: ${h instanceof Error ? h.message : String(h)}`);
      }
    })(), () => {
      l = !0;
    };
    ...
    Yl({
      activity: f,
      folder: pe ? { name: pe.name, handleKey: Oe } : null,
      files: ql(m),
      openEditorIds: G,
      activeFileId: R,
      query: C,
      ...
      welcomeClosed: xe,
      secondaryTab: j,
      bottomPanelVisible: L,
      bottomPanelTab: K,
      recent: xt
    });
  }, [f, R, K, L, de, Oe, m, pe, G, C, xt, j, xe]), le(() => {
    localStorage.setItem(Vr, JSON.stringify(Ce));
  }, [Ce]), /* @__PURE__ */ u(
    "div",
    {
      ref: n,
      className: `workbench-workbench ${p ? "" : "no-primary"} ${J ? "" : "no-secondary"} ${L ? "has-bottom-panel" : ""}`,
      "data-app": "workbench-vscode-base",
      style: { "--workbench-primary-width": `${N}px`, "--workbench-secondary-width": `${se}px` },
      children: [
        /* @__PURE__ */ a(
          ll,
          {
        ...
        /* @__PURE__ */ u("main", { className: "workbench-editor-area", children: [
          /* @__PURE__ */ a("button", { className: "workbench-command-center", onClick: () => Ve(!0), children: t("app.workspace") }),
          /* @__PURE__ */ u("section", { className: "workbench-editor-stack", children: [
            ...
            /* @__PURE__ */ a(ml, { file: Y, folder: pe, showWelcome: bn }),
            He && je.length > 0 ? /* @__PURE__ */ u("div", { className: "workbench-ai-dirty-banner", children: [
              /* @__PURE__ */ a("span", { children: He }),
              /* @__PURE__ */ a("button", { onClick: () => {
                ba();
              }, children: t("shell.saveAll") }),
              /* @__PURE__ */ a("button", { onClick: () => ke(null), title: t("shell.dismiss"), children: /* @__PURE__ */ a(Ze, { size: 13 }) })
            ] }) : null,
            /* @__PURE__ */ a("div", { className: "workbench-editor-content", children: Y ? /* @__PURE__ */ u("div", { className: Y.language === "markdown" && T ? "workbench-editor-split" : "workbench-editor-single", children: [
              ...
              Y.language === "markdown" && T && /* @__PURE__ */ a(kl, { content: Y.content })
            ] }) : Wt ? /* @__PURE__ */ a(
              Xl,
              {
                host: e,
            ...
            ) : bn ? /* @__PURE__ */ a(vl, { host: e, openFile: Nt, openFolder: vn, newFile: wn, recent: xt, reopenRecent: xn, setStatus: M, openControlTower: () => {
              b("computer"), v(!0);
            }, openChat: () => {
              I("chat"), F(!0);
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek answer", l.body),
            ...
            contextScope: fe,
            setContextScope: ye,
            contextAttachments: Br,
            removeContextAttachment: Qr,
            revealContextAttachment: ts,
            projectIndexSummary: `${et.snapshot.files.length} files · ${et.snapshot.chunks.length} chunks`,
            projectIndexStale: et.isStale,
            refreshProjectIndex: () => {
              const l = et.refresh(m);
              M(`Project index refreshed: ${l.files.length} files · ${l.chunks.length} chunks`);
            },
            onResizeStart: $r,
            onClose: () => F(!1)
          }
        ...
        Xe && /* @__PURE__ */ a(
          wl,
          {
            ...
            commands: [
              ...
              { label: "File: Save All", detail: `${je.length} dirty file${je.length === 1 ? "" : "s"}`, run: () => {
                ba();
              }, disabled: je.length === 0 },
              { label: "File: Close All Editors", detail: `${De.length} open editor${De.length === 1 ? "" : "s"}`, run: rs, disabled: De.length === 0 },
              ...
              { label: "View: Toggle Bottom Panel", detail: L ? "Hide Problems/Output/Terminal panel" : "Show Problems/Output/Terminal panel", run: () => Z((l) => !l) },
              ...
              { label: "View: Toggle Markdown Preview", detail: Y?.language === "markdown" ? "Show or hide Markdown preview split" : "Available for Markdown files", run: () => V((l) => !l), disabled: Y?.language !== "markdown" },
              { label: "Atomek: Create AI Synthesis", detail: Y || De.length > 0 ? "Ask AIL to produce a saved Markdown artifact" : "Open a file first", run: kn, disabled: !Y && De.length === 0 },
              { label: "AI: Explain Active File", detail: Y ? `Ask Cortex to explain ${Y.path}` : "Open a file first", run: () => Re("Explain the active file. Focus on purpose, structure, risks, and next useful edits."), disabled: !Y },
              { label: "AI: Improve Active File", detail: Y ? `Ask Cortex for concrete edits to ${Y.path}` : "Open a file first", run: () => Re("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful."), disabled: !Y },
              ...
              { label: "AI: Plan Workspace Work", detail: De.length > 0 ? "Use open editors as bounded context" : "Open files first", run: () => Re("Create an implementation plan from the open editor context. Be specific and sequence the work."), disabled: De.length === 0 },
        ...
        /* @__PURE__ */ a(Wl, { status: Zr, file: Y ?? al, cursor: X, fileCount: m.length, dirtyCount: je.length })
      ]
    }
  );
}
function ll({ active: e, setActive: t, togglePrimary: n, openSettings: r, settingsActive: i }) {
  const s = Ke();
  return /* @__PURE__ */ u("aside", { className: "workbench-activity-bar", "aria-label": s("activity.aria"), children: [
    /* @__PURE__ */ a("button", { className: "workbench-activity-brand", title: s("activity.toggleSidebar"), "aria-label": s("activity.toggleSidebar"), onClick: n, children: /* @__PURE__ */ a(Cr, { size: 30, variant: "cream" }) }),
    /* @__PURE__ */ a(Yt, { icon: /* @__PURE__ */ a(Za, { size: 25 }), label: s("activity.explorer"), active: e === "explorer", onClick: () => t("explorer") }),
    /* @__PURE__ */ a(Yt, { icon: /* @__PURE__ */ a(Ba, { size: 25 }), label: s("activity.search"), active: e === "search", onClick: () => t("search") }),
    /* @__PURE__ */ a(Yt, { icon: /* @__PURE__ */ a(Bn, { size: 25 }), label: s("app.agentTeam"), active: e === "computer", onClick: () => t("computer") }),
...
function dl(e) {
  return e.activity === "search" ? /* @__PURE__ */ a(yl, { files: e.files, query: e.query, setQuery: e.setQuery, openWorkbenchFile: e.openWorkbenchFile, activeFileId: e.activeFileId }) : e.activity === "computer" ? /* @__PURE__ */ a(qr, { host: e.host, setStatus: e.setStatus, attachSkillToChat: e.attachSkillToChat, saveLocalJobOutput: e.saveLocalJobOutput, activeFile: e.activeFile, openEditors: e.openEditors }) : /* @__PURE__ */ a(ul, { ...e });
}
function ul(e) {
  const t = Ke(), n = !e.folder, r = he(() => hl(e.files, e.folder?.name), [e.files, e.folder?.name]), [i, s] = P(() => /* @__PURE__ */ new Set());
  le(() => {
    const c = Ir(r);
    s((f) => {
      const b = new Set(f);
...
function ca({ file: e, active: t, onOpen: n, basePath: r, depth: i = 0, label: s, detail: o }) {
  const c = r && e.path.startsWith(`${r}/`) ? e.path.slice(r.length + 1) : e.path, f = i || Math.max(0, c.split("/").length - 1);
...
function hl(e, t) {
  const n = [], r = /* @__PURE__ */ new Map(), i = (o, c, f = n) => {
    const b = r.get(o);
    if (b) return b;
    const p = { name: c, path: o, children: [] };
    return r.set(o, p), f.push(p), p;
  };
  e.forEach((o) => {
    const c = t && o.path.startsWith(`${t}/`) ? o.path.slice(t.length + 1) : o.path, f = c.split("/").filter(Boolean);
    let b = n, p = "";
    f.slice(0, -1).forEach((v) => {
      p = p ? `${p}/${v}` : v, b = i(p, v, b).children;
    }), b.push({ name: f.at(-1) ?? o.name, path: c, file: o, children: [] });
  });
  const s = (o) => o.sort((c, f) => +!!c.file - +!!f.file || c.name.localeCompare(f.name)).map((c) => ({ ...c, children: s(c.children) }));
  return s(n);
}
function Ir(e) {
...
function ml({ file: e, folder: t, showWelcome: n }) {
...
function fl(e) {
  ...
  return /* @__PURE__ */ u("div", { className: "workbench-tabs", children: [
    e.showWelcome && /* @__PURE__ */ u("button", { className: "workbench-tab active", children: [
      ...
      }, children: /* @__PURE__ */ a(Ze, { size: 13 }) })
    ] }),
    ...
    e.canPreview && /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.previewVisible ? "active" : ""}`, title: t("tabs.toggleMarkdownPreview"), onClick: e.togglePreview, children: /* @__PURE__ */ a(Un, { size: 16 }) }),
...
function bl(e) {
  ...
  return [...e?.resources ?? []].sort((n, r) => (t[n.kind] ?? 9) - (t[r.kind] ?? 9) || We(n).localeCompare(We(r))).slice(0, 8);
}
function vl({
  host: e,
  openFile: t,
  ...
  const p = Ke(), v = he(() => ({
    "repo-repair": {
      name: p("mission.default.repoRepair.name"),
      goal: p("mission.default.repoRepair.goal")
    },
    "pod-local": {
      name: p("mission.default.podLocal.name"),
      goal: p("mission.default.podLocal.goal")
    },
    "creative-production": {
      name: p("mission.default.creativeProduction.name"),
      goal: p("mission.default.creativeProduction.goal")
    },
    "research-watch": {
      name: p("mission.default.researchWatch.name"),
      goal: p("mission.default.researchWatch.goal")
    }
  }), [p]), [N, S] = P(() => p("mission.default.podLocal.name")), [j, I] = P(() => p("mission.default.podLocal.goal")), [J, F] = P(!1), [se, be] = P(!1), [L, Z] = P(null), [K, W] = P([]), [T, V] = P(!1), [xe, ee] = P(null), [pe, Te] = P(null), [Oe, Ae] = P("pod-local"), m = x(async () => {
    V(!0), Te(null);
    try {
      const [g, re] = await Promise.all([
        e.resources?.list?.() ?? Promise.resolve(null),
        e.missions?.list?.().catch(() => []) ?? Promise.resolve([])
      ]);
      Z(g ?? null), W(re), g && o(`Agent team loaded · ${g.resources.length} resources · ${g.warnings.length} warnings`);
    } catch (g) {
      const re = g instanceof Error ? g.message : String(g);
      Te(re), o(`Agent team resource load failed: ${re}`);
    } finally {
      V(!1);
    }
  }, [e.missions, e.resources, o]), q = x((g, re) => {
    try {
      e.windows.openOrFocus(g), o(`Opened ${re}`);
    } catch (fe) {
      o(`Open ${re} failed: ${fe instanceof Error ? fe.message : String(fe)}`);
    }
  }, [e.windows, o]);
  le(() => {
    m();
  ...
  const G = x(async () => {
    ...
    const g = j.trim() || "Coordinate a Tytus mission.", re = Ti(N, g), fe = lt(g, L, Oe);
    V(!0);
    try {
      const ye = await e.missions.create({
        title: re,
        goal: g
      }), Ee = {
        missionId: ye.missionId,
        title: ye.title || re,
        goal: ye.goal || g,
        rootPath: ye.rootPath,
        name: ye.rootPath.split("/").pop() || ye.missionId,
        source: "tray",
        teamPresetId: fe
      }, Pe = {
        ...
        data: { resourceCount: L?.resources.length ?? 0, missionTitle: re }
      };
      await e.missions.write({
        rootPath: ye.rootPath,
        files: [
          { path: "MISSION.md", content: Zt(Ee, L, null, [], g, fe) },
          { path: "MISSION.json", content: or(Ee, L, g, fe) },
          { path: "RESOURCES.md", content: Kt(L) },
          { path: "TASKS.md", content: sr(Ot(g, L, fe)) },
          { path: "HANDOFF.md", content: ir(Ee) },
...
` },
          { path: "AUDIT.jsonl", content: `${JSON.stringify(Pe)}
` },
...
`) }
      ...
      }), ee(ye), Lt(Ee), o(`Mission created: ${ye.rootPath}`), c();
    } catch (ye) {
      o(`Mission create failed: ${ye instanceof Error ? ye.message : String(ye)}`);
    } finally {
      V(!1);
    }
  }, [j, L, e.missions, N, c, o, Oe]), we = x((g) => {
    Ae(g);
    const re = v[g];
    J || S(re.name), se || I(re.goal);
  }, [se, J, v]), R = pl(L), z = ki(L), C = xi(L), E = bl(L), X = L?.warnings ?? [], ae = Ni(L), ie = kt(L, lt(j, L, Oe)), ve = Ot(j, L, ie.id);
  return /* @__PURE__ */ u("div", { className: "workbench-welcome workbench-control-home", children: [
    /* @__PURE__ */ u("section", { className: "workbench-control-hero-main", children: [
      /* @__PURE__ */ u("div", { className: "workbench-brand-lockup", "aria-label": "Atomek", children: [
        /* @__PURE__ */ a(Cr, { size: 74, variant: "acid" }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a(Yc, { className: "workbench-brand-wordmark" }),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-control-goal-row", children: [
        /* @__PURE__ */ u("div", { className: "workbench-control-mission-fields", children: [
          /* @__PURE__ */ u("label", { className: "workbench-control-field", children: [
            /* @__PURE__ */ a("span", { children: p("mission.name") }),
            /* @__PURE__ */ a(
              "input",
              {
                value: N,
                onChange: (g) => {
                  F(!0), S(g.target.value);
                },
                maxLength: 80,
                placeholder: p("mission.namePlaceholder")
              }
            )
          ] }),
          /* @__PURE__ */ u("label", { className: "workbench-control-field", children: [
            /* @__PURE__ */ a("span", { children: p("mission.goal") }),
            /* @__PURE__ */ a(
              "textarea",
              {
                value: j,
                onChange: (g) => {
                  be(!0), I(g.target.value);
                },
                rows: 3,
                "aria-label": p("mission.goal"),
                placeholder: p("mission.goalPlaceholder")
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-control-hero-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-primary", onClick: () => {
            G();
          }, disabled: T, children: p("mission.start") }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: c, children: p("mission.openBoard") }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: f, children: p("mission.openChat") })
        ] })
      ] }),
      /* @__PURE__ */ a("div", { className: "workbench-team-preset-strip", "aria-label": "Team presets", children: ae.map((g) => /* @__PURE__ */ u(
        "button",
        {
          className: `workbench-team-preset-card ${g.id === ie.id ? "active" : ""} ${g.readiness}`,
          onClick: () => we(g.id),
          children: [
            /* @__PURE__ */ u("div", { children: [
            ...
            /* @__PURE__ */ a("small", { children: g.assignments.map((re) => re.resourceLabel).slice(0, 3).join(" · ") })
          ]
        },
        g.id
      )) }),
      xe ? /* @__PURE__ */ u("div", { className: "workbench-control-success", children: [
        "Mission ready: ",
        /* @__PURE__ */ a("code", { children: xe.rootPath })
      ] }) : null,
      pe ? /* @__PURE__ */ a("div", { className: "workbench-inline-error", children: pe }) : null
    ] }),
    /* @__PURE__ */ u("section", { className: "workbench-control-grid", children: [
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-control-metrics", children: R.map((g) => /* @__PURE__ */ u("div", { className: "workbench-control-metric", children: [
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-agent-brand-grid", children: z.map((g) => /* @__PURE__ */ u("div", { className: `workbench-agent-brand-card ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ u("div", { children: [
            /* @__PURE__ */ a("strong", { children: g.label }),
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-doc-grid", children: _c.map((g) => /* @__PURE__ */ u("button", { className: "workbench-doc-card", onClick: () => b(g), title: g.summary, children: [
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-fabric-flow", children: C.map((g, re) => /* @__PURE__ */ u("div", { className: `workbench-fabric-node ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ a("span", { children: re + 1 }),
          /* @__PURE__ */ a("strong", { children: g.label }),
          /* @__PURE__ */ a("em", { children: g.status }),
          /* @__PURE__ */ a("p", { children: g.detail })
        ] }, g.label)) }),
        /* @__PURE__ */ u("div", { className: "workbench-fabric-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Et.sharedFiles, "Shared Files"), children: "Open shared files" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Et.podInspector, "Pod Inspector"), children: "Open pods" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Et.channels, "Channels"), children: "Open channels" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Et.settings, "Agent Settings"), children: "Open agent settings" })
        ] })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        ...
        /* @__PURE__ */ a("button", { className: "workbench-control-preset", onClick: () => I("Review this repo with local OpenCode/Claude, then ask Codex or pi for an independent review. Save all transcripts and proposed patches in the mission folder."), children: "Review + patch repo" }),
        /* @__PURE__ */ a("button", { className: "workbench-control-preset", onClick: () => I("Ask OpenClaw for independent critique, use Hermes when allocated for deep planning/copy, then run local Claude/OpenCode/Codex for implementation. Keep shared context in the mission folder and approval-gate all edits."), children: "OpenClaw/Hermes + local agent" }),
        /* @__PURE__ */ a("button", { className: "workbench-control-preset", onClick: () => I("Coordinate creative output: script, audio, visuals, render assets, and final handoff through app skills and shared folders."), children: "Creative production" })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ a("strong", { children: "Resume" }),
          /* @__PURE__ */ a("span", { children: K.length ? `${K.length} missions` : "none yet" })
        ] }),
        K.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "Create a mission once; it stays in Tytus Home/Missions and can be resumed here." }) : null,
        K.slice(0, 4).map((g) => /* @__PURE__ */ u("button", { className: "workbench-control-preset", onClick: () => {
          Lt(g), c();
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          ...
          /* @__PURE__ */ a("span", { children: L ? `${L.resources.length} discovered` : "not loaded" })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-control-resource-list", children: [
          E.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No resource graph yet. Start Tytus tray beta30 or newer, then refresh." }) : null,
          E.map((g) => /* @__PURE__ */ u("div", { className: "workbench-control-resource", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: We(g) }),
              /* @__PURE__ */ a("span", { children: na(g) })
            ] }),
            /* @__PURE__ */ a("span", { className: `workbench-computer-pill ${g.status}`, children: g.status })
          ] }, g.id))
        ] }),
        X.length ? /* @__PURE__ */ a("div", { className: "workbench-resource-warnings", children: X.slice(0, 2).map((g) => /* @__PURE__ */ u("span", { children: [
          g.code,
          ": ",
          g.message
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-task-graph home", children: ve.map((g, re) => /* @__PURE__ */ u("button", { className: `workbench-task-card ${g.status}`, onClick: () => I(g.prompt), children: [
          /* @__PURE__ */ a("span", { children: re + 1 }),
          /* @__PURE__ */ a("strong", { children: g.title }),
...
function yl({ files: e, query: t, setQuery: n, openWorkbenchFile: r, activeFileId: i }) {
  const s = Ke(), o = he(() => gl(e, t), [e, t]), c = he(() => {
    const f = /* @__PURE__ */ new Map();
    return o.forEach((b) => f.set(b.file.id, [...f.get(b.file.id) ?? [], b])), Array.from(f.values()).slice(0, 50);
  }, [o]);
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    /* @__PURE__ */ a("div", { className: "workbench-sidebar-title", children: s("search.title") }),
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ a("input", { className: "workbench-input", value: t, onChange: (f) => n(f.target.value), placeholder: s("search.placeholder"), autoFocus: !0 }),
      /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
        /* @__PURE__ */ a(on, { size: 12 }),
        " ",
        s("search.results")
      ] }),
      t.trim() ? c.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: s("search.noMatches") }) : c.map((f) => {
        const b = f[0].file;
        return /* @__PURE__ */ u("div", { className: "workbench-search-group", children: [
          /* @__PURE__ */ a(ca, { file: b, active: b.id === i, onOpen: () => r(b) }),
          f.slice(0, 5).map((p) => /* @__PURE__ */ u("button", { className: "workbench-search-hit", onClick: () => r(b, p.lineNumber), title: p.line, children: [
          ...
          f.length > 5 && /* @__PURE__ */ a("div", { className: "workbench-search-more", children: s("search.moreMatches", { count: f.length - 5 }) })
        ] }, b.id);
...
function xl(e) {
  const t = e.session ? Sc(e.session) : "pending";
...
function Pl(e) {
  return /* @__PURE__ */ u("section", { className: "workbench-bottom-panel", "aria-label": "Panel", children: [
    /* @__PURE__ */ u("div", { className: "workbench-bottom-tabs", children: [
      ...
      /* @__PURE__ */ a("span", {}),
      /* @__PURE__ */ a("button", { title: "Close Panel", onClick: e.onClose, children: /* @__PURE__ */ a(Ze, { size: 14 }) })
    ] }),
...
function Nl(e) {
  const t = Ke(), [n, r] = P(!1), [i, s] = P(""), [o, c] = P([]), f = Me(null), b = Me(null), p = Me(null), [v, N] = P({ top: 0, right: 0 }), S = he(
    () => e.chatThreads.map((T) => ({
      kind: "atomek-thread",
      id: `thread:${T.id}`,
      title: T.title,
    ...
    const V = e.chatTargets.find((xe) => xe.id === T.targetId);
    return V ? {
      kind: "pod-agent",
      id: `agent:${T.targetId}`,
      title: V.label,
      subtitle: T.preview || V.description || `${T.messageCount} messages`,
      lastActivityAt: T.lastActivityAt,
      targetId: T.targetId
    } : null;
  }).filter((T) => T !== null), [o, e.chatTargets]), I = he(() => [...S, ...j].sort((T, V) => V.lastActivityAt - T.lastActivityAt), [S, j]), J = he(() => e.selectedChatTarget.kind === "atomek-ai" && e.chatThread ? I.find((T) => T.kind === "atomek-thread" && T.thread.id === e.chatThread?.id) ?? null : e.selectedChatTarget.kind !== "atomek-ai" ? I.find((T) => T.kind === "pod-agent" && T.targetId === e.selectedChatTarget.id) ?? null : null, [I, e.selectedChatTarget, e.chatThread]), F = x((T, V) => V ? `${T.title} ${T.kind === "pod-agent" ? T.subtitle : ""}`.toLowerCase().includes(V) : !0, []), se = i.trim().toLowerCase(), be = J ? F(J, se) : !1, L = he(() => I.filter((T) => T.id !== J?.id).filter((T) => F(T, se)), [I, J, se, F]), Z = x(() => {
    c(Gi());
  }, []), K = x((T) => {
    r(!1), T.kind === "atomek-thread" ? (e.selectedChatTarget.kind !== "atomek-ai" && e.selectChatTarget(Ge.id), e.selectThread(T.thread.id)) : e.selectChatTarget(T.targetId), e.tab !== "chat" && e.setTab("chat");
  }, [e]), W = x((T) => {
    window.confirm(`Delete conversation "${T.title}"?`) && (T.kind === "atomek-thread" ? e.deleteThread(T.thread.id) : (Qi(T.targetId), Z()));
  }, [e, Z]);
  return le(() => {
    if (!n) {
      s("");
    ...
    const T = () => {
      ...
      N({
        top: pe.bottom + 6,
        right: Math.max(8, window.innerWidth - pe.right)
      });
    };
    T(), window.setTimeout(() => p.current?.focus(), 0);
    const V = (ee) => {
      const pe = ee.target;
      pe && (b.current?.contains(pe) || f.current?.contains(pe) || r(!1));
    }, xe = (ee) => {
      ee.key === "Escape" && r(!1);
    };
    return window.addEventListener("resize", T), window.addEventListener("scroll", T, !0), window.addEventListener("mousedown", V), window.addEventListener("keydown", xe), () => {
      window.removeEventListener("resize", T), window.removeEventListener("scroll", T, !0), window.removeEventListener("mousedown", V), window.removeEventListener("keydown", xe);
    };
    ...
    /* @__PURE__ */ u("div", { className: "workbench-secondary-tabs", children: [
      ...
      /* @__PURE__ */ u("div", { className: "workbench-secondary-actions", children: [
        ...
        /* @__PURE__ */ a("button", { title: t("secondary.closeChat"), onClick: e.onClose, children: /* @__PURE__ */ a(Ze, { size: 15 }) })
      ] })
    ] }),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-history-portal-list", children: [
              ...
              L.length > 0 ? /* @__PURE__ */ u(qe, { children: [
                ...
                L.map((T) => /* @__PURE__ */ u(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ a("small", { children: Kn(T.lastActivityAt) }),
                      /* @__PURE__ */ a(
                        "button",
                        {
                          className: "workbench-history-portal-delete",
              ...
              !be && L.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-history-portal-empty", children: i.trim() ? t("history.noMatches") : t("history.empty") }) : null
            ] }),
    ...
    e.tab === "chat" ? /* @__PURE__ */ a(Tl, { ...e }) : e.tab === "agents" ? /* @__PURE__ */ a(
      qr,
      {
        host: e.host,
...
function Dr({ body: e }) {
  const t = he(() => ol(e), [e]), [n, r] = P(null), i = x((s, o) => {
    (async () => await wt(o) && (r(s), window.setTimeout(() => r((f) => f === s ? null : f), 1200)))();
  }, []);
...
function Tl(e) {
  const t = Ke(), n = e.selectedChatTarget.available, r = e.selectedChatTarget.kind === "atomek-ai", i = e.chatInput.trim().length > 0 && !e.busy && n, s = Me(null), [o, c] = P(!0), [f, b] = P(!1), p = Me(null), v = Me(null), N = Me(null), S = Me(null), [j, I] = P(!1), [J, F] = P(0), se = typeof window < "u" && !!(window.SpeechRecognition || window.webkitSpeechRecognition), be = x(() => {
    const m = N.current;
    try {
      m?.stop?.();
    } catch {
    }
    N.current = null, S.current !== null && (window.clearInterval(S.current), S.current = null), I(!1), F(0);
  }, []), L = x(() => {
    if (!se || j) return;
    ...
    q.lang = navigator.language || "en-US", q.interimResults = !1, q.continuous = !1, q.onresult = (G) => {
      let we = "";
      for (let R = G.resultIndex; R < G.results.length; R += 1) {
        const z = G.results[R];
        z.isFinal && (we += z[0].transcript);
      }
      if (we) {
        const R = e.chatInput.trim().length > 0 ? `${e.chatInput} ${we}` : we;
        e.setChatInput(R);
      }
    }, q.onerror = () => {
      be();
    ...
    try {
      q.start(), I(!0), F(0), S.current = window.setInterval(() => F((G) => G + 1), 1e3);
    } catch {
      be();
    }
  }, [se, j, e, be]);
  ...
  const Z = (m) => {
    const q = Math.floor(m / 60), G = m % 60;
    return `${q.toString().padStart(1, "0")}:${G.toString().padStart(2, "0")}`;
  }, K = () => p.current?.removeAttribute("open"), W = () => v.current?.removeAttribute("open"), T = (m) => {
    e.setContextScope(m), m === "indexed-project" && e.refreshProjectIndex(), K();
  }, V = (m) => {
    e.selectChatTarget(m), W();
  }, xe = he(() => e.chatMessages.map((m) => `${m.id}:${m.status ?? ""}:${m.body.length}`).join("|"), [e.chatMessages]);
  le(() => {
    const m = s.current;
    m && (o ? (m.scrollTop = m.scrollHeight, b(!1)) : b(!0));
  }, [o, xe]);
  const ee = x(() => {
    const m = s.current;
    if (!m) return;
    const G = m.scrollHeight - m.scrollTop - m.clientHeight < 48;
    c(G), G && b(!1);
  }, []), pe = x(() => {
    const m = s.current;
    m && (m.scrollTop = m.scrollHeight, c(!0), b(!1));
  }, []), Te = x((m) => {
    wt(m.body);
  }, []), Oe = Me(null), Ae = () => Oe.current?.removeAttribute("open");
  return /* @__PURE__ */ u("div", { className: "workbench-chat-wrap", children: [
    /* @__PURE__ */ u("div", { className: "workbench-chat-threadbar", children: [
      ...
      /* @__PURE__ */ u("span", { className: "workbench-chat-thread-actions", children: [
        ...
        r && e.chatThreads.length > 0 ? /* @__PURE__ */ u("details", { ref: Oe, className: "workbench-chat-iconmenu", children: [
            ...
            e.chatThreads.map((m) => /* @__PURE__ */ u(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ a("small", { children: Kn(m.lastMessageAt ?? m.updatedAt) })
                ]
              },
              m.id
            ))
    ...
    /* @__PURE__ */ u("div", { ref: s, className: "workbench-chat-transcript", onScroll: ee, children: [
      e.chatMessages.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-chat-empty", children: /* @__PURE__ */ u("div", { children: [
        ...
        /* @__PURE__ */ a("strong", { children: m.role === "user" ? t("chat.you") : m.sourceLabel ?? "Atomek" }),
        m.status === "streaming" ? /* @__PURE__ */ u("em", { children: [
          " ",
          t("chat.streaming")
        ] }) : null,
        m.status === "error" ? /* @__PURE__ */ u("em", { children: [
          " ",
          t("chat.error")
        ] }) : null,
        /* @__PURE__ */ a("br", {}),
        /* @__PURE__ */ a(Dr, { body: m.body }),
        m.gatewayLabel ? /* @__PURE__ */ u(qe, { children: [
          /* @__PURE__ */ a("br", {}),
        ...
        m.role === "assistant" && m.status !== "streaming" && m.status !== "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Te(m), title: t("chat.copyAnswer"), "aria-label": t("chat.copyAnswer"), children: /* @__PURE__ */ a(In, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.saveMessageAsArtifact(m), title: t("chat.saveArtifact"), "aria-label": t("chat.saveArtifact"), children: /* @__PURE__ */ a(Qn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.rememberMessage(m), title: "Store in Atomek memory", "aria-label": t("chat.remember"), children: /* @__PURE__ */ a(Bs, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.previewEditFromMessage(m), disabled: e.workspaceFileCount === 0, title: t("chat.previewPatch"), "aria-label": t("chat.previewPatch"), children: /* @__PURE__ */ a(Un, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, title: t("chat.regenerate"), "aria-label": t("chat.regenerate"), children: /* @__PURE__ */ a(bt, { size: 14 }) })
        ] }) : null,
        m.role === "assistant" && m.status === "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Te(m), title: t("chat.copyError"), "aria-label": t("chat.copyError"), children: /* @__PURE__ */ a(In, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, title: t("chat.retry"), "aria-label": t("chat.retry"), children: /* @__PURE__ */ a(bt, { size: 14 }) })
        ] }) : null
      ] }, m.id)),
      f ? /* @__PURE__ */ a("button", { className: "workbench-chat-jump", onClick: pe, children: t("chat.jumpLatest") }) : null
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-chat-composer", children: [
      /* @__PURE__ */ u("div", { className: "workbench-chat-tip", children: [
        ...
        /* @__PURE__ */ a("strong", { children: io(e.contextScope) }),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-chat-box", children: [
        /* @__PURE__ */ u("div", { className: "workbench-chat-attachments", children: [
          ...
          e.contextAttachments.length === 0 ? /* @__PURE__ */ u("span", { className: "workbench-chat-chip muted", children: [
            ...
            const q = typeof m.score == "number" ? m.score.toFixed(2) : null, G = typeof m.vectorScore == "number" ? m.vectorScore.toFixed(2) : null, we = typeof m.keywordScore == "number" ? m.keywordScore.toFixed(1) : null, R = [
              m.path,
            ...
            return /* @__PURE__ */ u("span", { className: "workbench-chat-chip", title: R, children: [
              /* @__PURE__ */ a("button", { className: "workbench-chat-chip-open", onClick: () => e.revealContextAttachment(m), disabled: !m.fileId, title: t("chat.revealContext"), children: /* @__PURE__ */ a(ka, { size: 13 }) }),
              m.label,
              ...
              m.dirty ? /* @__PURE__ */ a("small", { children: t("chat.dirty") }) : null,
              m.removable ? /* @__PURE__ */ a("button", { className: "workbench-chat-chip-remove", onClick: () => e.removeContextAttachment(m), title: t("chat.removeContext"), children: /* @__PURE__ */ a(Ze, { size: 11 }) }) : null
            ] }, m.id);
          }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar atomek-input", children: [
          ...
          j ? /* @__PURE__ */ u("div", { className: "workbench-chat-recording", children: [
            /* @__PURE__ */ a("button", { className: "workbench-chat-recording-cancel", onClick: be, title: t("chat.cancelRecording"), "aria-label": t("chat.cancelRecording"), children: /* @__PURE__ */ a(Ze, { size: 14 }) }),
            /* @__PURE__ */ a("span", { className: "workbench-chat-recording-wave", "aria-hidden": "true", children: Array.from({ length: 14 }).map((m, q) => /* @__PURE__ */ a("span", { style: { animationDelay: `${q * 0.05}s` } }, q)) }),
          ...
          /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar-right", children: [
            j ? null : /* @__PURE__ */ a(
              "button",
              {
                ...
                onClick: L,
                disabled: !se || e.busy,
                title: t(se ? "chat.voiceInput" : "chat.voiceUnsupported"),
...
function Ll({ host: e, appName: t, currentVersion: n }) {
  const r = e.apps, [i, s] = P(null), [o, c] = P(!1), [f, b] = P(null), p = x(async () => {
    if (!r?.checkUpdate) {
    ...
    c(!0), b(null);
    try {
      const j = await r.checkUpdate();
      s(j), j.error && b(j.error);
    } catch (j) {
  ...
  const v = x(async () => {
    ...
    c(!0), b(null);
    try {
      const j = await r.updateSelf();
      s(j), b(j.error ?? `${t} updated. Close and reopen the app to load the new bundle.`);
    } catch (j) {
      b(j instanceof Error ? j.message : String(j));
    } finally {
      c(!1);
    }
  }, [r, t]), N = i?.latestVersion ?? n, S = !!i?.updateAvailable;
  return /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
    ...
    /* @__PURE__ */ a("div", { className: "workbench-settings-note", children: f ?? (i ? S ? "Update available." : "You are running the latest available version." : "Checking latest version…") })
  ] });
}
function Xl(e) {
  const [t, n] = P([]), [r, i] = P("Loading gateway models…"), [s, o] = P([]), [c, f] = P("Checking embedding capability…");
  le(() => {
    ...
    return (async () => {
      ...
      try {
        ...
        n(j.map((I) => ({ id: I.id, gatewayLabel: I.gatewayLabel }))), i(j.length > 0 ? `${j.length} models discovered from AIL.` : "No models discovered. You can still enter any AIL alias manually.");
      } catch (j) {
        if (N.signal.aborted) return;
        n([]), i(`Model discovery failed: ${j instanceof Error ? j.message : String(j)}`);
      }
    })(), () => N.abort();
    ...
    return (async () => {
      ...
      try {
        const I = await Nc(e.host, {
          gatewayPreference: e.chatSettings.gatewayPreference,
          signal: N.signal
        });
        if (N.signal.aborted) return;
        o(I.map((J) => ({ id: J.id, gatewayLabel: J.gatewayLabel ?? J.source ?? "AIL" }))), f(I.length > 0 ? `${I.length} embedding models discovered from AIL metadata.` : "AIL embedding API is present, but no embedding-capable model metadata was returned.");
      } catch (I) {
        if (N.signal.aborted) return;
        o([]), f(`Embedding model discovery failed: ${I instanceof Error ? I.message : String(I)}`);
      }
    })(), () => N.abort();
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-settings-tab", children: /* @__PURE__ */ u("section", { className: "workbench-settings-page", "aria-label": "Atomek Settings", children: [
    /* @__PURE__ */ u("header", { className: "workbench-settings-header", children: [
      ...
      /* @__PURE__ */ a("button", { onClick: e.onClose, title: "Close", children: /* @__PURE__ */ a(Ze, { size: 15 }) })
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-settings-body", children: [
      /* @__PURE__ */ a(Ll, { host: e.host, appName: "Atomek", currentVersion: Ia }),
...
function Er({ outputs: e, clearOutputs: t, deleteArtifact: n, runAiSynthesis: r, captureManualCheck: i, openOutputAsFile: s, previewEditFromOutput: o, canPreviewEdit: c = !1, compact: f = !1 }) {
  const b = Ke();
  return /* @__PURE__ */ u("div", { className: `workbench-panel-list ${f ? "compact" : ""}`, children: [
    ...
    e.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No outputs yet. Save an AI answer as an artifact or create an AI synthesis." }) : e.map((p) => /* @__PURE__ */ u("div", { className: "workbench-output-card", children: [
      /* @__PURE__ */ u("div", { className: "workbench-output-head", children: [
        ...
        /* @__PURE__ */ a("button", { onClick: () => void wt(p.body), children: "Copy" }),
...
function Cl({ edit: e, onApply: t, onOpenAsFile: n, onClose: r }) {
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI edit", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review", children: [
    /* @__PURE__ */ u("header", { className: "workbench-edit-review-head", children: [
      ...
      /* @__PURE__ */ a("button", { title: "Close", onClick: r, children: /* @__PURE__ */ a(Ze, { size: 16 }) })
    ] }),
...
function Ol({ patch: e, onApply: t, onOpenAsFiles: n, onClose: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI workspace patch", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review workspace", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-workspace-patch-list", children: [
      e.edits.map((s) => /* @__PURE__ */ u("article", { className: "workbench-workspace-patch-card", children: [
        ...
        /* @__PURE__ */ a("pre", { children: Il(s.proposedContent) })
      ] }, s.fileId)),
...
function Hl(e, t) {
  ...
  if (e)
    n.push("", `Active file: ${e.path}`, `Language: ${e.language}`, `Dirty: ${e.dirty ? "yes" : "no"}`, "", "Active file content:", "```" + e.language, Sl(e.content), "```");
  else if (t.length > 0) {
...
function qr({
  ...
  const [c, f] = P([]), [b, p] = P([]), [v, N] = P(null), [S, j] = P(!1), [I, J] = P(null), [F, se] = P("Review the active Atomek context. Return concise findings. If you propose edits, output a unified diff or fenced replacement blocks so Atomek can preview before applying."), [be, L] = P(null), [Z, K] = P([]), [W, T] = P(() => Ai()), [V, xe] = P([]), [ee, pe] = P([]), [Te, Oe] = P([]), Ae = Me([]), [m, q] = P("task-execute"), [G, we] = P("mission"), R = Z.find((d) => d.status === "running" || d.status === "canceling") ?? Z[0] ?? null, z = o === "dock", C = he(() => kt(v, lt(F || W?.goal || "", v, W?.teamPresetId)), [F, W?.goal, W?.teamPresetId, v]), E = he(() => Ot(F || W?.goal || "", v, C.id), [F, W?.goal, C.id, v]), X = E.find((d) => d.id === m) ?? E[1] ?? E[0] ?? null, ae = s.filter((d) => d.dirty).length, ie = i ? `${i.path} · ${i.language} · ${i.content.length.toLocaleString()} chars${i.dirty ? " · dirty" : ""}` : s.length > 0 ? `${s.length} open editor${s.length === 1 ? "" : "s"}${ae ? ` · ${ae} dirty` : ""}` : "No active file — jobs run with only your typed prompt.", ve = he(() => [
    {
  ...
  const g = x(async (d = W) => {
    ...
    try {
      ...
      return Oe(w), Ae.current = w, w;
    } catch (w) {
      return t(`Mission run history failed: ${w instanceof Error ? w.message : String(w)}`), [];
    }
  }, [e.missions, W, t]), re = x(async (d, w) => {
    if (!d) return;
    const A = [...w].sort((H, D) => Na(D).localeCompare(Na(H))).slice(0, 100), O = A.map((H) => JSON.stringify(H)).join(`
`) + (A.length ? `
` : "");
    d.rootPath && e.missions?.write ? await e.missions.write({ rootPath: d.rootPath, files: [{ path: "RUNS.jsonl", content: O }] }) : d.handle && await Dn(d.handle, "RUNS.jsonl", O), Oe(A), Ae.current = A;
  }, [e.missions]), fe = x(async (d, w = W) => {
    if (!w) return;
    const A = [
      d,
      ...Ae.current.filter((O) => O.id !== d.id)
    ];
    await re(w, A);
  }, [W, re]), ye = x(async () => {
    if (!e.local?.listTools && !e.skills?.list && !e.resources?.list) {
      f([]), p([]), N(null), J("This Tytus host build does not expose local tools, resource graph, or skill registry yet.");
      return;
    }
    j(!0), J(null);
    try {
      const [d, w, A, O] = await Promise.all([
      ...
      f(d), p(w), N(A), xe(O), W?.rootPath && g(W), t(`Agent team loaded · ${d.length} tools · ${w.length} skills · ${O.length} missions${A ? ` · ${A.resources.length} resources` : ""}`);
    } catch (d) {
      J(d instanceof Error ? d.message : String(d));
    } finally {
      j(!1);
    }
  }, [e.local, e.missions, e.resources, e.skills, g, W, t]);
  le(() => {
    ye();
  }, [ye]), le(() => {
    const d = (w) => {
      const A = w.detail;
      A?.missionId && (T(A), g(A)), ye();
    };
    return window.addEventListener(En, d), () => window.removeEventListener(En, d);
  }, [ye, g]);
  const Ee = x((d) => {
    const w = Li(d);
    T(w), Lt(w), g(w), pe([{
    ...
    }]), se(d.goal || `Continue mission ${d.title}. Review MISSION.md, TASKS.md, RESOURCES.md, and runs/ before acting.`), t(`Resumed mission: ${d.rootPath}`);
  }, [g, t]), Pe = x(async (d, w, A = []) => {
    const O = [
      ...ee,
      ...A,
      { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.pack.write", message: "Mission context pack written from Atomek" }
    ], H = lt(w || d.goal, v, d.teamPresetId), D = Ot(w || d.goal, v, H), U = [
      { path: "MISSION.md", content: Zt(d, v, i, s, w, H) },
      { path: "MISSION.json", content: or(d, v, w, H) },
      { path: "RESOURCES.md", content: Kt(v) },
      { path: "TASKS.md", content: sr(D) },
      { path: "HANDOFF.md", content: ir(d) },
      { path: "INBOX.md", content: `# Mission inbox
...
Approved handoffs, final artifacts, and user-ready summaries go here.
` },
      { path: "AUDIT.jsonl", content: O.map((ce) => JSON.stringify(ce)).join(`
`) + `
` },
      { path: "RUNS.jsonl", content: Ae.current.map((ce) => JSON.stringify(ce)).join(`
`) + (Ae.current.length ? `
` : "") },
      { path: "runs/README.md", content: `# Mission runs
...
` }
    ...
    if (d.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: d.rootPath, files: U });
    else if (d.handle) {
      await pt(d.handle, "runs"), await pt(d.handle, "outputs"), await pt(d.handle, "proposals"), await pt(d.handle, "approvals");
      for (const ce of U) await gi(d.handle, ce.path, ce.content);
    } else
      throw new Error("Mission has neither tray rootPath nor browser folder handle");
    pe(O), Lt(d);
  }, [i, e.missions, ee, s, v]), Le = x(async (d, w = {}) => {
    if (W)
      return await Pe(W, d), W;
    const A = `Atomek mission ${(/* @__PURE__ */ new Date()).toLocaleString()}`, O = d.trim() || "Coordinate Tytus resources for the current Atomek task.";
    let H = null;
    if (e.missions?.create) {
      const U = await e.missions.create({ title: A, goal: O });
      H = {
      ...
      H = {
        handle: U,
        name: U.name,
        missionId: `mission-${Date.now()}-${zi(U.name)}`,
        title: A,
        goal: O,
        source: "browser"
      };
    ...
    return T(H), Lt(H), pe([D]), await Pe(H, O, [D]), t(`Mission pack ready in ${H.rootPath ?? H.name}`), H;
  }, [e.missions, W, t, Pe]), Be = x(async (d) => {
    if (!e.local?.openTerminal) {
      t("Terminal bridge unavailable in this host build");
      return;
    }
    try {
      const w = F.trim() || `Open ${d.label} from Atomek with current context.`, A = d.kind === "ai-cli" ? await Le(w) : W;
      await e.local.openTerminal({
        toolId: d.id,
        command: d.command,
        cwd: A?.rootPath ?? Ra(i),
        prompt: A ? `Atomek mission pack ready at ${A.rootPath ?? A.name}. Read MISSION.md and RESOURCES.md. ${ie}` : `Opened from Atomek. ${ie}`
  ...
  }, [i, ie, Le, e.local, F, W, t]), te = x(async () => {
    try {
      await Le(F.trim(), { allowBrowserPicker: !0 }) || t("Mission folder setup skipped.");
    } catch (d) {
      t(`Mission folder setup failed: ${d instanceof Error ? d.message : String(d)}`);
    }
  }, [Le, F, t]), B = x(async (d, w, A, O = W, H) => {
    if (!O) return;
    const D = (/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-"), U = H ?? `runs/${D}-${d.id}.md`, ce = U.split("/").pop() || `${D}-${d.id}.md`;
    if (O.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: O.rootPath, files: [{ path: U, content: w }] });
    else if (O.handle) {
      const Se = await pt(O.handle, "runs");
      await Dn(Se, ce, w);
    }
    await Pe(O, F, [{
      ts: (/* @__PURE__ */ new Date()).toISOString(),
      kind: "local-cli.run.complete",
      message: `${d.label} exited ${A}; transcript saved to ${U}`,
      data: { toolId: d.id, exitCode: A, transcript: U }
    }]);
  }, [e.missions, F, W, Pe]), de = x(async (d) => {
    ...
    L(d.id);
    const O = `local-run-${Date.now()}-${d.id}`, H = ht();
    K((D) => [{
      id: O,
      toolId: d.id,
      label: d.label,
...
`)
      }), U = D.transcriptPath ?? (A?.rootPath ? `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id}.md` : void 0), ce = [
      ...
      fe(Se, A).catch((ue) => {
        t(`Mission run index failed: ${ue instanceof Error ? ue.message : String(ue)}`);
      }), K((ue) => ue.map(($) => $.id === O ? { ...$, jobId: D.id, transcriptPath: U } : $));
      const Ce = (ue) => {
        K(($) => $.map((_) => _.id === O ? ue(_) : _));
      };
      e.local.streamJob(D.id, {
        onLog: (ue) => {
          ce.push(ue), Ce(($) => ({ ...$, lines: ce.slice(-500) }));
        },
        onDone: (ue) => {
          ue && (ce.push(ue), Ce(($) => ({ ...$, lines: ce.slice(-500) })));
        },
        onFail: (ue) => {
          ce.push(`[FAIL] ${ue}`), Ce(($) => ({
            ...$,
          ...
          }), r(`${d.label} local job failed`, ce.join(`
`)), B(d, ce.join(`
`), -1, A, U).catch(($) => {
...
`);
      ...
      L(null), K((U) => U.map((ce) => ce.id === O ? {
        ...ce,
        status: "failed",
        finishedAt: Date.now(),
        lines: [...ce.lines, `[Atomek] Failed to start: ${D instanceof Error ? D.message : String(D)}`]
      } : ce)), t(`Local job failed to start: ${D instanceof Error ? D.message : String(D)}`);
    }
  }, [i, Le, e.local, F, s, v, r, B, X, t, fe, Pe]), oe = x(async (d) => {
    const w = Rn(d), A = wi(d);
    if (!w) {
      t(`Cannot dispatch ${We(d)}: missing pod id`);
      return;
    }
    const O = F.trim();
    if (!O) {
    ...
    let H = null;
    const D = We(d), U = `pod-run-${Date.now()}-${w}`, ce = ht(), Se = `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id.replace(/[^a-z0-9_.-]/gi, "-")}.md`;
    try {
      H = await Le(O), H && await Pe(H, O, [{
        ts: (/* @__PURE__ */ new Date()).toISOString(),
    ...
    }, ..._].slice(0, 6)), await fe(Ce, H).catch((_) => {
      t(`Mission run index failed: ${_ instanceof Error ? _.message : String(_)}`);
    });
    const ue = [], $ = (_) => {
      ue.push(_), K((ze) => ze.map((Ie) => Ie.id === U ? { ...Ie, lines: [...Ie.lines, _].slice(-500) } : Ie));
    };
    try {
...
`);
      let ze = "", Ie = !1;
      for await (const ke of e.daemon.chatAgent({
        podId: w,
        routeId: A,
        message: _,
        mode: "operator",
        ...
        if (ke.type === "profile" && $(`[Atomek] ${ke.profile === "local" ? "Local Cortex" : "Cloud Cortex"} route selected.`), ke.type === "session" && $("[Atomek] Pod-agent session established."), ke.type === "token" && (Ie || ($("[Atomek] Pod agent is responding…"), Ie = !0), ze = ln(`${ze}${ke.text}`)), ke.type === "error") {
          const Fe = qn(ke.message);
          throw new Error(Fe.message);
        }
        if (ke.type === "done") break;
      }
      if (ze = ze.trim(), !ze) throw new Error("Pod agent returned no text.");
      $(ze);
      const He = [
        `# Pod job — ${D}`,
        "",
...
`);
      K((ke) => ke.map((Fe) => Fe.id === U ? { ...Fe, status: "complete", finishedAt: Date.now(), lines: [...Fe.lines, "[Atomek] Pod task complete."].slice(-500) } : Fe)), await fe({ ...Ce, status: "complete", finishedAt: ht(), summary: `${D} completed`, transcriptPath: Se }, H), r(`${D} pod job`, He), await B({ id: d.id, label: D, kind: "pod-agent", status: d.status }, He, 0, H, Se), t(`${D} completed mission task`);
    } catch (_) {
      const ze = _ instanceof Error ? _.message : String(_);
      $(`[FAIL] ${ze}`), K((He) => He.map((ke) => ke.id === U ? { ...ke, status: "failed", finishedAt: Date.now(), lines: ke.lines.slice(-500) } : ke)), await fe({ ...Ce, status: "failed", finishedAt: ht(), exitCode: -1, summary: ze, transcriptPath: Se }, H).catch((He) => {
        t(`Mission run index failed: ${He instanceof Error ? He.message : String(He)}`);
      });
      const Ie = [`# Pod job failed — ${D}`, "", `- Pod: ${w}`, `- Error: ${ze}`, "", "```text", ue.join(`
`), "```", ""].join(`
`);
      r(`${D} pod job failed`, Ie), await B({ id: d.id, label: D, kind: "pod-agent", status: d.status }, Ie, -1, H, Se).catch((He) => {
        t(`Pod transcript save failed: ${He instanceof Error ? He.message : String(He)}`);
      }), t(`Pod task failed: ${ze}`);
    }
  }, [i, Le, e.daemon, F, s, v, r, B, X, t, fe, Pe]), Xe = x(async (d) => {
    if (!d.jobId || !e.local?.cancelJob) {
      t("Local job cancel bridge unavailable in this host build");
      return;
    }
    K((w) => w.map((A) => A.id === d.id ? { ...A, status: "canceling", lines: [...A.lines, "[Atomek] Cancel requested…"] } : A)), fe({
      id: d.id,
      jobId: d.jobId,
      toolId: d.toolId,
      label: d.label,
    ...
    try {
      ...
      K((A) => A.map((O) => O.id === d.id ? { ...O, status: "running", lines: [...O.lines, `[Atomek] Cancel failed: ${w instanceof Error ? w.message : String(w)}`] } : O)), t(`Local job cancel failed: ${w instanceof Error ? w.message : String(w)}`);
    }
  }, [e.local, t, fe]), Ve = x(async (d) => {
    const w = [
      `Use Tytus resource "${We(d)}" (${d.kind}) for the next mission step.`,
...
`);
    se(w), W && await Pe(W, w, [{
      ...
      message: `Selected resource ${We(d)}`,
      data: { resourceId: d.id, kind: d.kind, status: d.status }
    }]), t(`Selected ${We(d)} for mission`);
  }, [W, t, Pe]), Qe = x((d) => {
    const w = d.setupAction, A = w?.commandPreview ? `${w.label}: ${w.commandPreview}` : w?.deepLink ? `${w.label}: ${w.deepLink}` : w?.label ?? `${We(d)} needs setup`;
    t(A), wt(w?.commandPreview ?? w?.deepLink ?? A);
  }, [t]);
  return /* @__PURE__ */ u("aside", { className: z ? "workbench-agent-dock" : "workbench-sidebar", children: [
    z ? null : /* @__PURE__ */ a("div", { className: "workbench-sidebar-title", children: "AGENT TEAM" }),
    /* @__PURE__ */ u("div", { className: z ? "workbench-agent-dock-scroll" : "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ u("div", { className: "workbench-computer-hero", children: [
        /* @__PURE__ */ a(Bn, { size: 18 }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a("strong", { children: z ? "Mission Runs" : "OpenClaw + Hermes Team Board" }),
      ...
      I && /* @__PURE__ */ a("div", { className: "workbench-inline-error", children: I }),
      /* @__PURE__ */ u("div", { className: "workbench-team-switcher", role: "tablist", "aria-label": "Atomek agent team views", children: [
        /* @__PURE__ */ a("button", { className: G === "mission" ? "active" : "", onClick: () => we("mission"), children: "Mission" }),
        /* @__PURE__ */ a("button", { className: G === "runs" ? "active" : "", onClick: () => we("runs"), children: "Runs" }),
        /* @__PURE__ */ a("button", { className: G === "setup" ? "active" : "", onClick: () => we("setup"), children: "Setup" })
      ] }),
      G === "mission" ? /* @__PURE__ */ u(qe, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-context-card mission", children: [
          ...
          /* @__PURE__ */ a("span", { children: W ? `${W.rootPath ?? W.name} · ${W.source} · ${ee.length} audit events · transcripts saved under runs/` : "Atomek creates this automatically before launching local agents. It is the shared folder agents read/write transcripts from." }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-team-assignment-list", children: [
          /* @__PURE__ */ u("div", { className: `workbench-team-assignment-summary ${C.readiness}`, children: [
          ...
          C.assignments.map((d) => /* @__PURE__ */ u("div", { className: "workbench-team-assignment-row", children: [
            /* @__PURE__ */ u("div", { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
          ...
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => W && void Pe(W, F), disabled: !W, children: "Rewrite context files" })
        ] }),
        V.length ? /* @__PURE__ */ u(qe, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RESUME MISSION" }),
          /* @__PURE__ */ a("div", { className: "workbench-mission-list", children: V.slice(0, z ? 3 : 5).map((d) => /* @__PURE__ */ u(
            "button",
            {
              className: `workbench-mission-row ${W?.missionId === d.missionId ? "active" : ""}`,
              onClick: () => Ee(d),
              title: d.rootPath,
              children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-computer-presets", children: ve.map((d) => /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => se(d.prompt), children: d.label }, d.label)) }),
        /* @__PURE__ */ a(
          "textarea",
          {
        ...
        /* @__PURE__ */ a("div", { className: "workbench-task-graph", children: E.map((d, w) => /* @__PURE__ */ u(
          "button",
          {
      ...
      G === "runs" ? /* @__PURE__ */ u(qe, { children: [
        R ? /* @__PURE__ */ u("div", { className: "workbench-agent-run", children: [
          /* @__PURE__ */ u("header", { children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: R.label }),
              /* @__PURE__ */ u("span", { children: [
                R.status,
                typeof R.exitCode == "number" ? ` · exit ${R.exitCode}` : "",
                R.taskTitle ? ` · ${R.taskTitle}` : ""
              ] }),
              R.transcriptPath ? /* @__PURE__ */ a("span", { children: R.transcriptPath }) : null
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-agent-run-actions", children: [
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => r(`${R.label} local job`, R.lines.join(`
`)), disabled: R.lines.length === 0, children: "Save output" }),
              R.jobId && (R.status === "running" || R.status === "canceling") ? /* @__PURE__ */ u("button", { className: "workbench-button-subtle danger", onClick: () => {
                Xe(R);
              }, disabled: R.status === "canceling", children: [
                /* @__PURE__ */ a(Ga, { size: 12 }),
                " ",
                R.status === "canceling" ? "Canceling…" : "Cancel"
              ] }) : null
            ] })
          ] }),
          /* @__PURE__ */ a("pre", { className: "workbench-computer-job-log", children: R.lines.join(`
`) || "[waiting for output]" })
        ] }) : null,
        Te.length ? /* @__PURE__ */ u(qe, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RUN HISTORY" }),
          /* @__PURE__ */ a("div", { className: "workbench-run-history", children: Te.slice(0, z ? 4 : 8).map((d) => /* @__PURE__ */ u("div", { className: "workbench-run-history-row", children: [
            /* @__PURE__ */ u("div", { children: [
            ...
            /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => void wt(d.transcriptPath ?? d.id), title: "Copy transcript path or run id", children: "Copy path" })
          ] }, d.id)) })
        ] }) : null
      ] }) : null,
      G === "setup" ? /* @__PURE__ */ u(qe, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-list compact", children: [
          ...
          v?.resources.slice(0, z ? 8 : 5).map((d) => /* @__PURE__ */ u("div", { className: "workbench-resource-row", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: We(d) }),
              /* @__PURE__ */ a("span", { children: na(d) })
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-resource-row-actions", children: [
              ...
              d.kind === "pod-agent" && Rn(d) ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                oe(d);
              }, children: "Ask pod" }) : null,
              d.status === "needs-setup" || d.setupAction ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Qe(d), children: "Setup" }) : null
            ] })
          ] }, d.id))
        ] }),
          ...
          c.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
              ...
              d.kind === "ai-cli" ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                de(d);
              }, disabled: d.status !== "available" || be !== null, title: "Run this local agent as a background read-only review inside Atomek and stream output here. It cannot write files directly.", children: Ml(d, be) }) : null
            ] })
          ] }, d.id))
        ] }),
...
function Wl({ status: e, file: t, cursor: n, fileCount: r, dirtyCount: i }) {
...
function Bl({ host: e }) {
  return /* @__PURE__ */ a(Kc, { host: e, children: /* @__PURE__ */ a(cl, { host: e }) });
}
function $l(e) {
  return function() {
    return /* @__PURE__ */ a(Bl, { host: e.host });
  };
}
export {
  $l as default
