...
import { forwardRef as Qa, createElement as qn, useState as P, useRef as Re, useCallback as w, useEffect as pe, createContext as Ps, useMemo as ue, useContext as Ns, lazy as Ts, Suspense as zs } from "react";
 ...
 */
const Ls = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Xs = (e) => e.replace(
  /^([A-Z])|[\s-_]+(\w)/g,
  (t, n, r) => r ? r.toUpperCase() : n.toLowerCase()
), Xa = (e) => {
  const t = Xs(e);
  return t.charAt(0).toUpperCase() + t.slice(1);
}, $a = (...e) => e.filter((t, n, r) => !!t && t.trim() !== "" && r.indexOf(t) === n).join(" ").trim(), Cs = (e) => {
  for (const t in e)
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Is = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], Fs = ye("check", Is);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Rs = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], Xt = ye("chevron-down", Rs);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
async function yi() {
  const e = la()?.showOpenFilePicker;
  if (!e) return or(!1);
  const t = await e({ multiple: !0 }), n = await Promise.all(t.map((r) => da(r, r.name, "local-file")));
  return Jt(n.filter(Boolean));
}
async function gi() {
  const e = la()?.showDirectoryPicker;
  if (!e)
    return { name: "Browser fallback folder", files: await or(!0) };
  const t = await e({ mode: "readwrite" }), n = [];
  return await ua(t, t.name, n, 0, 320), { name: t.name, handle: t, files: Jt(n) };
}
async function wi(e) {
  const t = await Promise.all(e.map((n) => da(n, n.name, "local-file")));
  return Jt(t.filter(Boolean));
}
async function Sa(e) {
  const t = [];
  return await ua(e, e.name, t, 0, 320), { name: e.name, handle: e, files: Jt(t) };
}
async function Hn(e, t = "readwrite") {
  try {
...
async function ua(e, t, n, r, i) {
  if (!(n.length >= i || r > 8))
    for await (const s of e.values()) {
      if (n.length >= i) break;
      if (s.kind === "directory") {
        if (bi.has(s.name)) continue;
        await ua(s, `${t}/${s.name}`, n, r + 1, i);
        continue;
      }
      const o = s, l = await da(o, `${t}/${o.name}`, "local-folder");
      l && n.push(l);
    }
}
function or(e) {
...
function kt(e, t, n) {
  ...
  return /(music|song|audio|video|render|blender|remotion|juli3ta|creative)/.test(r) ? "creative-production" : /(research|watch|monitor|news|summar|scan)/.test(r) ? "research-watch" : (t?.resources ?? []).some((i) => i.kind === "pod-agent" && ur(i)) ? "pod-local" : "repo-repair";
}
function Li(e) {
  ...
  return [
    {
      ...
      resourceHint: o ? Gt(o) : "Planner agent",
      role: "planner",
    ...
    },
    {
      ...
      resourceHint: l ? Gt(l) : "Local/app implementer",
      role: "implementer",
    ...
    } : null,
    {
      ...
      resourceHint: m ? `${Gt(m)} · ${p?.resourceLabel ?? "mission folder"}` : "Reviewer + mission folder",
      role: "reviewer",
...
function Oi(e, t, n, r) {
  const i = kt(n || e.goal, t, r ?? e.teamPresetId), s = Mt(t, i), o = vn(n || e.goal, t, i);
...
const hr = ["MISSION.md", "TASKS.md", "RESOURCES.md", "HANDOFF.md"];
function mr(e, t, n, r, i, s, o = []) {
  const l = vn(i || e.goal, t, s);
  return [
    { path: "MISSION.md", content: Bn(e, t, n, r, i, s), primary: !0, editable: !0 },
    { path: "MISSION.json", content: Oi(e, t, i, s), editable: !0 },
    { path: "RESOURCES.md", content: Un(t), primary: !0, editable: !0 },
    { path: "TASKS.md", content: Xi(l), primary: !0, editable: !0 },
    { path: "HANDOFF.md", content: Ci(e), primary: !0, editable: !0 },
...
function Si(e, t) {
  return `mission:${e.missionId}:${ha(t)}`;
}
function Hi(e, t) {
...
const fr = "tytus.atomek.currentMission", Gn = "tytus.atomek.currentMissionChanged";
function Wi(e, t) {
...
function qt(e) {
  ...
  try {
    localStorage.setItem(fr, JSON.stringify(t)), window.dispatchEvent(new CustomEvent(Gn, { detail: t }));
  } catch {
  }
}
function Ii() {
...
const st = {
  ...
  available: !0
}, Ri = "atomek:selected-chat-target", yn = {
  openclaw: "OpenClaw",
  hermes: "Hermes"
}, an = /https?:\/\/(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})(?::\d+)?\S*/gi, rn = /\b(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})\b/g, sn = /\b(?:MiniMax(?:-M[\w.-]+)?|Moonshot|Kimi|DeepSeek|Qwen|Alibaba|Xiaomi|Nous|OpenRouter|Strato|Scalesys|ail-compound|switchAILocal|OpenAI-compatible|vLLM|llama\.cpp)\b/gi, on = /\b(?:route[_-]?id|pod[_-]?id|droplet[_-]?id|provider[_-]?id|publicUrl|gatewayUrl|privateUrl)\b\s*[:=]\s*[^\s,;]+/gi, cn = /\b(?:pod-agent|ail-route|strato-eu|wannolot|scalesys)[._:-][a-z0-9._:-]{4,}\b/gi, ln = /https?:\/\/[^\s)]*(?:tytus\.traylinx\.com|strato|scalesys|wannolot|droplet|gateway|route|\.internal|\.local|digitalocean|do\.com|hetzner)[^\s)]*/gi, dn = /\b(?:fe80|fc00|fd[0-9a-f]{2}):[0-9a-f:]+(?:%[a-z0-9]+)?\b/gi;
function gn(e) {
  return e.replace(an, "private gateway").replace(ln, "private gateway").replace(dn, "private gateway").replace(rn, "private gateway").replace(on, "agent runtime").replace(cn, "your Tytus pod").replace(sn, "agent runtime").replace(/\s{3,}/g, "  ");
}
function Qn(e) {
  const t = e.toLowerCase();
  return /\b(503|502|504|warm|warming|boot|starting|not ready|temporarily unavailable)\b/.test(t) ? { message: "Agent is warming up. Try again in a moment.", retryable: !0 } : /\b(timeout|timed out|aborted)\b/.test(t) ? { message: "Connection timed out. The agent may still be working. Try again.", retryable: !0 } : /\b(offline|stopped|unreachable|not found|404)\b/.test(t) ? { message: "Agent is offline. Restart the pod or pick another agent.", retryable: !0 } : { message: gn(e).trim() || "Agent chat failed. Try again or pick another agent.", retryable: !1 };
}
function pr(e) {
  return `${Ri}:${e}`;
}
function Di(e) {
  try {
    return localStorage.getItem(pr(e))?.trim() || st.id;
  } catch {
    return st.id;
  }
}
function ja(e, t) {
  try {
    localStorage.setItem(pr(e), t || st.id);
  } catch {
  }
}
function St(e, ...t) {
...
function Yi(e) {
  return e.kind !== "pod-agent" ? null : br([
    e.label,
    e.id,
...
function Zi(e) {
  const t = e.trim();
  return t.length < 2 || t.length > 44 ? !1 : an.test(t) || ln.test(t) || dn.test(t) || rn.test(t) || on.test(t) || cn.test(t) || sn.test(t) ? (an.lastIndex = 0, ln.lastIndex = 0, dn.lastIndex = 0, rn.lastIndex = 0, on.lastIndex = 0, cn.lastIndex = 0, sn.lastIndex = 0, !1) : (an.lastIndex = 0, ln.lastIndex = 0, dn.lastIndex = 0, rn.lastIndex = 0, on.lastIndex = 0, cn.lastIndex = 0, sn.lastIndex = 0, /^[\p{L}\p{N}][\p{L}\p{N} ._()'&+-]*$/u.test(t));
}
function Ki(e, t) {
  const n = St(e.metadata, "displayName", "display_name", "customName", "custom_name", "podDisplayName", "pod_display_name", "name");
  if (n) {
    const r = gn(n).replace(/\bNemoClaw\b/gi, "OpenClaw").replace(/\s+/g, " ").trim();
    if (Zi(r)) return r;
  }
  return yn[t];
}
...
function Ui(e) {
  ...
  return e.map((s) => {
    ...
    const o = s.label, l = yn[s.agentFamily];
    i[s.agentFamily] += 1;
...
function Gi(e) {
  const t = e.daemon?.state, n = t?.included ?? [], r = t?.agents ?? [], i = new Map(r.map((o) => [o.id, o])), s = n.flatMap((o) => {
    const l = o.id ?? "", p = { ...(o.agentId ? i.get(o.agentId) : void 0)?.meta ?? {}, ...o.meta ?? {} }, b = br([l, o.kind, St(p, "displayName", "display_name", "agentFamily", "agentType", "brand")].join(" "));
    return !l || !b ? [] : [{
      id: `pod-agent.${l}`,
      kind: "pod-agent",
      label: yn[b],
  ...
  return vr({ generatedAt: (/* @__PURE__ */ new Date()).toISOString(), resources: s });
}
async function Qi(e, t) {
  ...
  const r = vr(n), i = r.length > 0 ? [] : Gi(e), s = /* @__PURE__ */ new Map();
  for (const o of [st, ...r, ...i]) s.set(o.id, o);
  return [...s.values()];
}
const Zt = "atomek", Ue = "atomek:default", $i = 3e3, fa = "tytus.atomek.threadTitleOverrides", yr = "tytus.atomek.selectedThreadId", Ma = {
  available: !1,
  source: "none",
...
}, _i = (e, t = $i) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, jn = (e, t) => {
  const n = e.split(`
`).map((r) => r.replace(/^#+\s*/, "").trim()).find(Boolean);
  return n ? n.length > 80 ? `${n.slice(0, 77)}...` : n : t;
}, eo = (e) => ["briefing", "action-list", "quiz", "plan", "storyboard", "report", "local-draft", "markdown", "memory"].includes(e) ? e : "report", Wa = (e) => ({
  id: e.id,
  title: e.title,
  kind: eo(e.kind),
  body: e.body,
...
`)
  ...
  try {
    return localStorage.getItem(yr)?.trim() || null;
  } catch {
    return null;
  }
}, yt = (e) => {
...
}, mn = (e) => `${Ue}:agent-session:${e}`, fn = (e) => `${Ue}:agent-transcript:${e}`, ba = "v2", ro = (e) => `${Ue}:${Zt}:agent-session:${e}`, so = (e) => `${Ue}:${Zt}:agent-transcript:${e}`, va = (e) => `${Ue}:${Zt}:agent-session:${ba}:${e}`, pn = (e) => `${Ue}:${Zt}:agent-transcript:${ba}:${e}`, gr = 100, io = (e, t, n = !0) => {
  try {
    const r = localStorage.getItem(va(e))?.trim();
    if (r) return r;
    if (!n) return null;
    const i = localStorage.getItem(mn(e))?.trim();
    return i || t && t !== e && localStorage.getItem(mn(t))?.trim() || null;
  } catch {
    return null;
  }
}, oo = (e, t) => {
  try {
    localStorage.setItem(va(e), t);
  } catch {
  }
}, Qt = (e, t) => {
  try {
    const n = localStorage.getItem(pn(e)), r = n ? JSON.parse(n) : [], i = /* @__PURE__ */ new Map();
    for (const s of [...r, ...t]) i.set(s.id, s);
    localStorage.setItem(pn(e), JSON.stringify([...i.values()].slice(-gr)));
  } catch {
  }
}, un = (e) => {
  if (!e) return [];
  ...
  try {
    const r = un(localStorage.getItem(pn(e)));
    if (r.length > 0) return r;
    if (!n) return [];
    const i = un(localStorage.getItem(fn(e)));
    return i.length > 0 || !t || t === e ? i : un(localStorage.getItem(fn(t)));
  } catch {
    return [];
  }
};
function lo() {
  const t = `${`${Ue}:${Zt}:agent-transcript:`}${ba}:`, n = [];
  try {
    for (let r = 0; r < localStorage.length; r += 1) {
      const i = localStorage.key(r);
      if (!i || !i.startsWith(t)) continue;
      const s = un(localStorage.getItem(i));
      if (s.length === 0) continue;
      const o = s[s.length - 1], l = s.find((m) => m.role === "user");
      n.push({
        targetId: i.slice(t.length),
        lastActivityAt: typeof o?.createdAt == "number" ? o.createdAt : Date.now(),
        messageCount: s.length,
        preview: (l?.body ?? o?.body ?? "").trim().slice(0, 80)
      });
    }
  } catch {
  }
  return n.sort((r, i) => i.lastActivityAt - r.lastActivityAt);
}
function uo(e) {
  wr(e, null);
}
const wr = (e, t) => {
  try {
    localStorage.removeItem(pn(e)), localStorage.removeItem(va(e)), localStorage.removeItem(so(e)), localStorage.removeItem(ro(e)), localStorage.removeItem(fn(e)), localStorage.removeItem(mn(e)), t && t !== e && (localStorage.removeItem(fn(t)), localStorage.removeItem(mn(t)));
  } catch {
  }
}, ho = (e) => {
  const t = e.daemon;
...
function po({ host: e, requestContext: t, chatSettings: n, selectedTarget: r = st, setStatus: i }) {
  const s = e.ai, [o, l] = P(null), [m, p] = P([]), [b, y] = P([]), [N, z] = P([]), [V, R] = P([]), [Y, B] = P(Ma), [we, G] = P(!1), M = Re(!0), I = Re(null), he = w(async () => {
    if (!s) {
      B(Ma);
      return;
    }
    ...
    if (s)
      try {
        const L = Ia(await s.listThreads({ workspaceKey: Ue, status: "active" })), O = ao(), q = L.find(($) => $.id === O) ?? L[0] ?? await s.createThread({ workspaceKey: Ue, title: "Atomek chat" });
        if (!M.current) return;
  ...
  const ne = w(async () => {
    if (!s) return null;
    if (o) return o;
    const L = await s.createThread({ workspaceKey: Ue, title: "Atomek chat" });
    return M.current && (l(L), yt(L.id), p((O) => [L, ...O.filter((q) => q.id !== L.id)])), L;
  }, [s, o]), ze = w(async () => {
    if (r.kind === "pod-agent") {
      wr(r.id, r.podId), y([]), R([]), i(`Cleared ${r.label} chat`);
      return;
    }
    if (!s) return;
    const L = await s.createThread({ workspaceKey: Ue, title: "Atomek chat" });
    ...
    if (q)
      try {
        ...
        typeof S != "function" && Va(L, q), p((ge) => ge.map((be) => be.id === ce.id ? ce : be)), l((ge) => ge?.id === ce.id ? ce : ge), i(typeof S == "function" ? `Renamed chat: ${ce.title}` : `Renamed chat locally: ${ce.title}`);
      } catch (S) {
    ...
    if (s)
      try {
        await s.deleteThread(L), no(L);
        const O = m.filter((q) => q.id !== L);
        if (p(O), o?.id === L) {
          const q = O[0] ?? await s.createThread({ workspaceKey: Ue, title: "Atomek chat" });
    ...
    try {
      ...
      const q = await s.createArtifact({
        ...
        title: L.title?.trim() || jn(L.body, "Atomek artifact"),
    ...
    try {
      const O = await s.writeMemory({
        title: L.title?.trim() || jn(L.body, "Atomek memory"),
        body: L.body,
        metadata: {
          source: "atomek",
          messageId: L.messageId ?? null
    ...
    try {
      ...
      if (S.kind === "pod-agent") {
        ...
        if (y((Z) => [...Z, re, Pe]), Qt(S.id, [re, Pe]), !S.available) {
          const Z = Qn(S.description), ve = { ...Pe, body: Z.message, status: "error", error: Z.message };
          return y((Ae) => Ae.map((le) => le.id === me ? ve : le)), Qt(S.id, [ve]), i(Z.message), ve;
        }
        if (!_) {
          ...
          return y((Ae) => Ae.map((le) => le.id === me ? ve : le)), Qt(S.id, [ve]), i("Agent chat bridge unavailable"), ve;
        }
        let He = "";
        const it = (Z, ve) => (y((Ae) => Ae.map((le) => le.id === me ? Z : le)), Qt(S.id, [re, Z]), i(ve), Z);
        try {
          for await (const Z of _.chatAgent({
            podId: S.podId,
            routeId: S.routeId ?? null,
            sessionId: io(S.id, S.podId, !S.routeId),
            message: fo(q, ge),
            mode: "operator",
            target: "agent",
            ...
            if (Z.type === "session" && oo(S.id, Z.sessionId), Z.type === "token" && (He = gn(`${He}${Z.text}`), y((ve) => ve.map((Ae) => Ae.id === me ? { ...Ae, body: He, status: "streaming" } : Ae))), Z.type === "error") {
              const ve = Qn(Z.message), Ae = { ...Pe, body: ve.message, status: "error", error: ve.message };
      ...
      for await (const _ of s.sendMessage({
        ...
        if (_.type === "message_created") {
          ...
          if (!ae) continue;
          ae.role === "assistant" && (tt = ae.id), y((re) => [...re.filter((me) => me.id !== ae.id), ae]);
        }
        if (_.type === "token" && (tt = _.messageId, y((ae) => ae.some((re) => re.id === _.messageId) ? ae.map(
        ...
        if (_.type === "run_failed") {
          ...
          i(ae ? "AI response stopped" : `AI failed: ${_.error}`), tt && y((re) => re.map((me) => me.id !== tt ? me : ae ? { ...me, status: "complete", error: void 0, body: me.body || "Stopped by user." } : { ...me, status: "error", error: _.error, body: _.error }));
        }
      }
      const Ee = Ia(await s.listThreads({ workspaceKey: Ue, status: "active" }).catch(() => []));
...
const bo = (e) => `tytus-workbench:///${encodeURI(e.path)}`, vo = (e) => {
  let t = 2166136261;
  for (let n = 0; n < e.length; n += 1)
    t ^= e.charCodeAt(n), t = Math.imul(t, 16777619);
  return (t >>> 0).toString(16).padStart(8, "0");
}, yo = ({ files: e, openEditorIds: t, activeFileId: n, versions: r, activeSelection: i }) => {
...
}, go = "active-file", wo = (e) => e === "none" ? "No context" : e === "active-selection" ? "Active selection" : e === "active-file" ? "Active file" : e === "open-editors" ? "Open editors" : e === "selected-files" ? "Selected files" : "Indexed project", ko = (e, t = "file") => `${t}:${e.id}`, xo = (e, t) => [
  "selection",
  e.id,
  t.startLineNumber,
  t.startColumn,
  ...
  let i = [];
  return t.scope === "active-selection" ? r?.selection ? i = [Po(r, r.selection, !0)] : r && (i = [$t(r, !0, "Active file")]) : t.scope === "active-file" ? r && (i = [$t(r, !0, "Active file")]) : t.scope === "open-editors" ? i = e.openDocumentIds.map((s) => e.byId.get(s)).filter(Boolean).map((s) => $t(s, !0, "Open editor")) : t.scope === "selected-files" && (i = t.selectedFileIds.map((s) => e.byId.get(s)).filter(Boolean).map((s) => $t(s, !1, "Selected file"))), To(i).filter((s) => !n.has(s.id));
}, To = (e) => {
  const t = /* @__PURE__ */ new Set();
  return e.filter((n) => t.has(n.id) ? !1 : (t.add(n.id), !0));
}, zo = 4e3, Ao = 8e3, Lo = 4e3, Xo = (e, t) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, Co = (e, t, n) => {
  const r = No(e, n), i = [], s = new Map(t.map((o) => [o.id, o]));
  for (const o of r) {
    ...
    const p = [
      ...
      o.range ? `Range: ${Fa(o.range)}` : null
    ].filter(Boolean).join(`
`), b = o.kind === "selection" && o.range ? Oo(l.content, o.range) : l.content, y = o.kind === "selection" ? zo : o.label.startsWith("Open editor") ? Lo : Ao;
    i.push({
...
`));
}, Fa = (e) => `${e.startLineNumber}:${e.startColumn}-${e.endLineNumber}:${e.endColumn}`, Ra = 75e4, So = 2800, Ho = 240, jo = 80, Mo = /* @__PURE__ */ new Set([
  ".git",
  ".hg",
  ".svn",
  ".next",
  ...
  return n === 0 || e.content.length === 0 ? "empty" : n > (t.maxFileBytes ?? Ra) || e.content.length > (t.maxFileBytes ?? Ra) ? "huge" : !t.includeDirty && e.dirty ? null : Eo(e.path) ? "vendor" : qo(e) ? "binary" : null;
}, Da = (e, t = {}) => {
  const n = Date.now(), r = [], i = [], s = [];
  for (const o of e) {
    const l = o.size ?? o.content.length, m = $n(o, t);
    if (m) {
      i.push({ fileId: o.id, name: o.name, path: o.path, language: o.language, reason: m, size: l });
      continue;
    }
    const p = wt(o.content), b = Vo(o, p, n, t);
    s.push(...b), r.push({
      fileId: o.id,
      name: o.name,
      path: o.path,
...
}, Vo = (e, t = wt(e.content), n = Date.now(), r = {}) => {
  const i = Math.max(500, r.maxChunkChars ?? So), s = Math.min(Math.max(0, r.chunkOverlapChars ?? Ho), Math.floor(i / 2)), o = Math.max(1, r.maxChunksPerFile ?? jo), l = Ro(e.content), m = [];
  let p = 0, b = 0;
  for (; p < e.content.length && m.length < o; ) {
    const y = Fo(e.content, p, Math.min(e.content.length, p + i)), N = e.content.slice(p, y).trim();
    if (N.length > 0) {
      const z = Do(l, p, y);
      m.push({
...
` && t.push(n + 1);
  ...
  const r = Ea(e, t), i = Ea(e, Math.max(t, n - 1));
  return {
    startLineNumber: r + 1,
    startColumn: t - e[r] + 1,
    endLineNumber: i + 1,
  ...
  return 0;
}, Eo = (e) => e.split(/[\\/]+/).filter(Boolean).some((t) => Mo.has(t)), qo = (e) => {
  const t = e.name.includes(".") ? e.name.split(".").pop()?.toLowerCase() : void 0;
  if (t && Wo.has(t) || e.content.includes("\0")) return !0;
...
class Yo {
  ...
  options;
  constructor(t = [], n = {}) {
    this.options = { ...n }, this.snapshot = Da(t, this.options);
  }
  getSnapshot() {
  ...
  refresh(t, n = this.options) {
    return this.options = { ...n }, this.snapshot = Da(t, this.options), this.snapshot;
  }
  update(t, n = this.options) {
    return this.refresh(t, n);
  }
  staleReport(t) {
    return Jo(this.snapshot, t, this.options);
  }
  isStale(t) {
    return this.staleReport(t).stale;
  }
}
const At = (e = [], t = {}) => new Yo(e, t), Jo = (e, t, n = {}) => {
  ...
  for (const l of t)
    !i.has(l.id) && !$n(l, n) && s.push({ fileId: l.id, path: l.path, status: "new", currentHash: wt(l.content) });
  const o = e.signature !== kr(t);
  return { stale: s.length > 0, signatureChanged: o, files: s };
}, Zo = 8, Ko = 12e3, xr = (e, t, n = {}, r) => {
  const i = Go(t);
  if (i.length === 0) return [];
  const s = new Set(r?.files.map((b) => b.fileId) ?? []), o = e.chunks.filter((b) => n.includeDirty !== !1 || !b.dirty).map((b) => Qo(b, i)).filter((b) => b.score >= (n.minScore ?? 1)).sort((b, y) => y.score - b.score || b.chunk.path.localeCompare(y.chunk.path) || b.chunk.ordinal - y.chunk.ordinal), l = [], m = /* @__PURE__ */ new Set();
  let p = n.maxChars ?? Ko;
  for (const b of o) {
    if (l.length >= (n.limit ?? Zo) || p <= 0) break;
...
[...context clipped...]` : b.chunk.text;
    l.push(Bo(b, N, s.has(b.chunk.fileId))), p -= N.length;
  }
  return l;
...
`), Go = (e) => Array.from(new Set(
  ...
  const l = [];
  for (const m of t) {
    const p = Mn(n, m), b = Mn(r, m), y = Mn(i, m), N = s === m ? 1 : 0;
  ...
  const b = (s.current ?? At([], r)).staleReport(e), y = w((N, z = {}) => {
    ...
    return xr(V.getSnapshot(), N, z, V.staleReport(i.current));
  }, []);
  return { snapshot: o, staleReport: b, isStale: b.stale, refresh: m, update: p, retrieve: y };
}, ec = "tytus.atomek.semanticVector:v1", Pr = "__gateway_default__", Nr = (e) => e?.trim() || Pr, tc = (e) => {
  const t = Nr(e);
  return t === Pr ? "gateway default" : t;
}, Tr = (e, t, n) => [
  ec,
  ...
  if (!zr()) return null;
  try {
    const r = Tr(e, t, n), i = window.localStorage.getItem(r);
    if (!i) return null;
...
}, Dt = 8, rc = 12e3, sc = 180, ic = async (e, t, n, r, i = {}, s, o) => {
  const l = xr(t, n, { ...i, limit: Math.max(i.limit ?? Dt, 16) }, s), m = e.ai;
  ...
  try {
    const p = Nr(r.embeddingModel), b = await m.embedText({
      input: n,
    ...
    const N = new Map(l.map((M) => [M.chunkId, M])), z = mc(n), V = /* @__PURE__ */ new Map();
    t.chunks.filter((M) => i.includeDirty !== !1 || !M.dirty).slice(0, sc).forEach((M) => V.set(M.id, M)), l.forEach((M) => {
    ...
    for (const M of R) {
      o?.aborted;
      const I = nc(e.appId, p, M) ?? await cc(m, e.appId, p, M, r, o);
      if (!I) continue;
      I.updatedAt > Date.now() - 1e3 && (B += 1);
      const he = uc(y, I.vector);
      if (!Number.isFinite(he)) continue;
      const T = N.get(M.id)?.score ?? fc(M, z), x = hc(T) * 0.42 + Math.max(0, he) * 0.58;
    ...
    const we = new Set(s?.files.map((M) => M.fileId) ?? []), G = Y.sort((M, I) => I.score - M.score || I.keywordScore - M.keywordScore || M.chunk.path.localeCompare(I.chunk.path) || M.chunk.ordinal - I.chunk.ordinal).slice(0, Math.max(i.limit ?? Dt, 1)).map((M) => lc(M, we.has(M.chunk.fileId)));
    return {
      hits: dc(G, i.maxChars ?? rc),
      mode: "hybrid",
      reason: `Hybrid retrieval used ${tc(r.embeddingModel)} embeddings + keyword ranking.`,
      embeddedChunks: B
    };
  } catch (p) {
    return {
  ...
  return {
    ...
    text: e.chunk.text,
    snippet: pc(e.chunk.text, e.matchedTerms),
    score: e.score,
...
}, hc = (e) => Math.min(1, Math.max(0, e / 24)), mc = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), fc = (e, t) => {
  const n = `${e.path}
${e.name}
...
}, bc = /```([^\n`]*)\n([\s\S]*?)```/g, vc = /^@@\s+-(\d+)(?:,\d+)?\s+\+(\d+)(?:,\d+)?\s+@@/;
function ya(e) {
  return Array.from(e.matchAll(bc)).map((t) => Lr(t[1] ?? "", xc(t[2] ?? ""))).filter((t) => t.content.trim().length > 0);
}
function Lr(e, t) {
  const n = e.trim().split(/[\s,]+/).filter(Boolean), r = {}, i = [];
  for (const s of n) {
    const o = s.match(/^([a-z0-9_-]+)=(.+)$/i);
    o ? r[o[1].toLowerCase()] = Nc(o[2]) : i.push(s.toLowerCase());
  }
  return { lang: e.trim().toLowerCase(), flags: i, attrs: r, content: t };
}
function _e(e, t) {
  return (typeof e == "string" ? Lr(e, "").flags : e.flags).includes(t.toLowerCase());
}
function Xr(e) {
  return [...ya(e).filter((r) => _e(r, "diff") || _e(r, "patch")).map((r) => r.content), e].filter((r, i, s) => yc(r) && s.findIndex((o) => o === r) === i);
}
function yc(e) {
...
`);
    /^@@\s+-\d+/m.test(b) && s.push({ raw: b, ...Wn(b) });
  }
  return s.length > 0 ? s : [{ raw: t, ...Wn(t) }];
}
function Wn(e) {
...
function _n(e) {
  return ya(e).filter((t) => wc(t)).map((t) => ({
...
function wc(e) {
  return _e(e, "atomek-replace") || _e(e, "atomek-full") || _e(e, "full-replacement") || _e(e, "full") || _e(e, "replace");
}
function kc(e) {
...
function Tc(e) {
  ...
  for (const b of Xr(t))
    for (const y of gc(b)) {
      if (!y.path) {
        if (i) {
          const V = ea(i.content, y.raw);
          V && V !== i.content && o.set(i.id, _t({
            file: i,
            proposedContent: V,
            sourceTitle: r,
      ...
      const z = ea(N.file.content, y.raw);
  ...
  for (const b of _n(t)) {
    const y = b.path ? qa(n, b.path) : i ? { file: i, normalizedPatchPath: lt(i.path), confidence: "exact" } : null;
    if (!y) {
  ...
  const m = _n(t).some((b) => b.path);
  if (o.size === 0 && i && !m) {
    const b = zc(t, i);
    b && b.content !== i.content && o.set(i.id, _t({
      file: i,
      proposedContent: b.content,
      sourceTitle: r,
      extractionLabel: b.label,
...
const wn = (e) => typeof e == "object" && e !== null, Oc = (e) => wn(e.ai) ? e.ai : null, Sc = (e) => {
  if (!wn(e)) return null;
  const t = e.id;
  return typeof t == "string" && t.trim() ? t : null;
}, Hc = (e) => {
  const t = Sc(e);
  return !t || !wn(e) ? null : { ...e, id: t };
}, rt = (e) => typeof e == "string" ? /\bembeddings?\b|text-embedding/i.test(e) : Array.isArray(e) ? e.some(rt) : wn(e) ? Object.values(e).some(rt) : !1, jc = async (e, t) => {
  const n = Oc(e);
  if (typeof n?.listModels != "function") return [];
  const r = await n.listModels(t);
  return Array.isArray(r) ? r.map(Hc).filter((i) => !!i) : [];
}, Mc = (e) => (e.embedding ?? e.embeddings ?? e.supportsEmbedding ?? e.supportsEmbeddings) === !0 ? !0 : rt(e.capability) || rt(e.capabilities) || rt(e.modality) || rt(e.modalities) || rt(e.task) || rt(e.tasks) || rt(e.type) || rt(e.kind), Or = (e) => typeof e == "object" && e !== null, Wc = (e) => Or(e.ai) ? e.ai : null, Sr = (e) => typeof Wc(e)?.embedText == "function", Vc = async (e, t) => Sr(e) ? (await jc(e, t)).filter(Mc) : [], Ic = (e) => Or(e.ai) ? Sr(e) ? null : "host.ai.embedText is not exposed by this Tytus build." : "host.ai is not available in this Tytus build.", Fc = ["typecheck", "test", "lint", "build", "release:check", "verify", "verify:cortex"], Rc = [
...
function Yc(e) {
  const t = e.results.length > 0 ? e.results.map((r, i) => [
    ...
    `Status: ${r.status}`,
    "Output:",
    $c(r.output || "(no output pasted)", "text")
  ].join(`
`)).join(`
...
function Zc(e) {
  ...
  for (const r of t) {
    const i = Kc(r.content);
    if (!i?.scripts) continue;
    const s = jr(r.path), o = Bc(e, s, i);
    if (!o) continue;
    const l = Object.keys(i.scripts).filter((p) => typeof i.scripts?.[p] == "string"), m = Uc(l);
    for (const p of m) {
      const b = `${o} run ${p}`;
      n.push({
        id: Mr(`${s}:${b}`),
...
function Bc(e, t, n) {
  ...
  for (const [r, i] of Rc)
    if (e.some((s) => Qc(s.path) === r && jr(s.path) === t)) return i;
  return null;
}
function Uc(e) {
  const t = Fc.filter((r) => e.includes(r)), n = e.filter((r) => !t.includes(r)).filter((r) => /(^|:)(check|typecheck|test|lint|verify|build)(:|$)/i.test(r)).sort((r, i) => r.localeCompare(i));
  return [...t, ...n];
}
function Gc(e) {
  const t = /* @__PURE__ */ new Set();
...
function al({ className: e }) {
  return /* @__PURE__ */ a("img", { src: nl, alt: "ATOMEK", className: e, draggable: !1 });
}
const Vr = {
...
}, Ya = { en: Vr, es: rl }, Ja = (e) => (e || "en").toLowerCase().split("-")[0] || "en", sl = (e, t) => t ? e.replace(/\{(\w+)\}/g, (n, r) => String(t[r] ?? `{${r}}`)) : e, Ir = Ps({ locale: "en", t: (e) => Vr[e] ?? e });
function il({ host: e, children: t }) {
  const [n, r] = P(() => Ja(e.i18n?.locale));
  pe(() => e.i18n?.onLocaleChange((s) => r(Ja(s))), [e]);
  const i = ue(() => ({
    locale: n,
    t: (s, o) => {
      const l = e.i18n?.t(s, o);
      return l && l !== s ? l : sl(Ya[n]?.[s] ?? Ya.en[s] ?? s, o);
    }
  }), [e, n]);
  return /* @__PURE__ */ a(Ir.Provider, { value: i, children: t });
}
function et() {
  return Ns(Ir).t;
}
const ol = `# Tytus Resource Fabric
...
], ml = "tytus-atomek-handles", Ht = "handles", fl = 1, Fr = () => new Promise((e, t) => {
  const n = indexedDB.open(ml, fl);
  n.onupgradeneeded = () => {
    const r = n.result;
...
async function Vn(e) {
  const t = await Fr(), n = await new Promise((r, i) => {
...
const pl = Ts(() => import("./WorkbenchMonacoEditor-Dt26-2vP.js").then((e) => e.W).then((e) => ({ default: e.WorkbenchMonacoEditor }))), bl = {
  id: "welcome",
  name: "Agent Team",
  path: "Agent Team",
  language: "text",
  ...
  dirty: !1,
  source: "sample"
}, Rr = "tytus.workspace.recent", Dr = "tytus.workspace.layout", Er = "tytus.atomek.session.v2", qr = "tytus.atomek.chatAiSettings", In = "atomek:default", Ka = "0.4.35", hn = {
...
function Fn(e) {
  const t = Math.max(e || 1400, 760), n = Math.max(0, t - vl), r = n < 1180, i = r ? 200 : 240, s = r ? 280 : 300, o = r ? 360 : 420, l = Math.max(i, Math.min(r ? 340 : 420, Math.floor(n * 0.28))), m = Math.min(300, l), p = Math.floor(n * (r ? 0.5 : 0.62)), b = n - m - o, y = Math.max(s, Math.min(r ? 1e3 : 1400, p, b));
...
function xl({ host: e }) {
  const t = et(), n = Re(null), [r, i] = P(0), s = ue(() => id(), []), o = ue(() => td(), []), l = ue(() => ed(_l(), o.recent), [o.recent]), [m, p] = P(() => yl(o.activity) || "explorer"), [b, y] = P(s.primaryVisible), [N, z] = P(s.primaryWidth), [V, R] = P(o.secondaryTab ?? "chat"), [Y, B] = P(s.secondaryVisible), [we, G] = P(s.secondaryWidth), [M, I] = P(!!o.bottomPanelVisible), [he, se] = P(() => gl(o.bottomPanelTab)), [T, x] = P(s.markdownPreviewVisible), [Te, ne] = P(!!o.welcomeClosed), [ze, Me] = P(o.folder ? { name: o.folder.name, files: [] } : null), [De, We] = P(o.folder?.handleKey ?? null), [f, D] = P(() => nd(o.files)), [Q, ke] = P(() => (o.openEditorIds ?? []).filter((c) => (o.files ?? []).some((h) => h.id === c))), [ie, L] = P(() => o.activeFileId && (o.files ?? []).some((c) => c.id === o.activeFileId) ? o.activeFileId : null), [O, q] = P(o.query ?? ""), [S, $] = P({ lineNumber: 1, column: 1 }), [ce, ge] = P(null), [be, g] = P({}), [X, Xe] = P(go), [E, Ge] = P([]), [tt, Ee] = P([]), [_, ae] = P(null), [re, me] = P(o.chatInput ?? ""), [Pe, He] = P(!1), [it, Z] = P(""), [ve, Ae] = P([]), [le, Je] = P(null), [Qe, ot] = P(null), [Kt, pt] = P(!1), [nt, kn] = P(() => od()), [d, A] = P([st]), [H, C] = P(() => Di(In)), [F, ee] = P(null), [W, Le] = P(null), [xe, de] = P(""), [qe, fe] = P(""), [te, U] = P(""), [Ce, Ze] = P("failed"), [Ye, Oe] = P(null), [dt, j] = P("Ready"), [Wt, Qr] = P(() => l), Ke = Q.map((c) => f.find((h) => h.id === c)).filter(Boolean), J = ie ? f.find((c) => c.id === ie) ?? null : null, wa = ue(() => yo({ files: f, openEditorIds: Q, activeFileId: ie, versions: be, activeSelection: ce }), [ie, ce, be, f, Q]), ka = ue(() => ({
    scope: X,
    removedAttachmentIds: E,
    selectedFileIds: []
  }), [X, E]), Vt = ue(() => Co(wa, f, ka), [ka, wa, f]), ut = _o(f, { autoRefresh: !0, includeDirty: !0 }), xa = ue(() => tt.map((c) => ({
    id: c.id,
    kind: "index-hit",
    label: c.label,
    path: c.path,
    ...
    snippet: c.snippet
  })), [tt]), $r = ue(() => [...Vt.attachments, ...xa], [Vt.attachments, xa]), Pa = ue(() => d.find((c) => c.id === H) ?? st, [d, H]), oe = po({ host: e, requestContext: Vt.parts, chatSettings: nt, selectedTarget: Pa, setStatus: j }), bt = ue(
    () => [...oe.artifacts, ...ve].sort((c, h) => h.createdAt - c.createdAt),
    [oe.artifacts, ve]
  ), Bt = Kt && !J, xn = !J && !Bt && !Te, Ve = ue(() => f.filter((c) => c.dirty), [f]), _r = ue(() => {
  ...
  const es = w((c) => {
    ...
    C(h.id), ja(In, h.id), j(`Chat target: ${h.label}`);
  }, [d, j]), ts = w((c) => {
    if (c.kind === "index-hit") {
      Ee((h) => h.filter((v) => v.id !== c.id)), j(`Removed project context: ${c.label}`);
      return;
    }
    Ge((h) => h.includes(c.id) ? h : [...h, c.id]), j(`Removed chat context: ${c.label}`);
  }, []), Ut = w(() => {
    ...
    const h = Fn(r), v = c.clientX, k = we, K = (je) => {
      const vt = k + (v - je.clientX);
      G(tn(vt, h.secondaryMin, h.secondaryMax));
    }, Ne = () => {
    ...
    c.preventDefault(), c.currentTarget.setPointerCapture?.(c.pointerId);
    const h = Fn(r), v = c.clientX, k = N, K = (je) => {
      const vt = k + (je.clientX - v);
      z(tn(vt, h.primaryMin, h.primaryMax));
    }, Ne = () => {
      window.removeEventListener("pointermove", K), window.removeEventListener("pointerup", Ne);
    };
    window.addEventListener("pointermove", K), window.addEventListener("pointerup", Ne);
    ...
    Qr((h) => {
      ...
      return localStorage.setItem(Rr, JSON.stringify(v)), v;
    });
  }, []), Se = w((c, h) => {
    ke((v) => v.includes(c.id) ? v : [...v, c.id]), L(c.id), ne(!1), Oe(h ?? null), $({ lineNumber: h ?? 1, column: 1 });
  }, []), Pn = w((c, h, v = {}) => {
    const k = v.primaryOnly === !1 ? h : Mi(h), K = ji(c, k);
    ...
    if (je.length > 0 && (D((Ie) => Et(Ie, je)), v.openTabs !== !1 && (ke((Ie) => Array.from(/* @__PURE__ */ new Set([...Ie, ...je.map((Sn) => Sn.id)]))), v.activate !== !1))) {
      const Ie = je.find((Sn) => Sn.mission?.relPath === v.activatePath) ?? je[0];
    ...
    if (Rn(Ve, "open new files"))
      try {
        const c = await yi();
        if (c.length === 0) return;
        D((h) => Et(h, c)), await Promise.all(c.map(async (h) => {
          const v = h.handle ? `file:${h.path}` : void 0;
          h.handle && v && await Za(v, h.handle), ht({ name: h.name, path: h.path, kind: "file", handleKey: v, at: Date.now() });
        })), Se(c[0]), j(`Opened ${c.length} local file${c.length === 1 ? "" : "s"}`);
      } catch (c) {
        c.name !== "AbortError" && j(`Open file failed: ${c.message}`);
      }
  }, [Ve, Se, ht]), Nn = w(async () => {
    if (Rn(Ve, "open another folder"))
      try {
        const c = await gi(), h = c.handle ? `folder:${c.name}:${Date.now()}` : null;
        c.handle && h && await Za(h, c.handle), We(h), Me(c), D(c.files), ke([]), L(null), ne(!1), ht({ name: c.name, path: c.name, kind: "folder", handleKey: h ?? void 0, at: Date.now() }), j(`${c.handle ? "Opened local folder" : "Opened browser fallback folder"} ${c.name} (${c.files.length} text files indexed)`);
      } catch (c) {
    ...
    if (c.source !== "mission") return ki(c);
    ...
    Rn(Ve, "close all editors") && (ke([]), L(null), Oe(null), ne(!1), j("Closed all editors"));
  }, [Ve]), An = w(() => {
...
`,
  ...
  }, [J, oe, mt, Ke.length]), Xn = w(async (c) => {
    if (c.kind === "folder") {
    ...
    try {
      if (c.kind === "folder") {
        const K = await Vn(c.handleKey);
        if (!K || !await Hn(K, "readwrite")) {
      ...
      const v = await Vn(c.handleKey);
      if (!v || !await Hn(v, "readwrite")) {
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek memory",
    ...
    const h = En(f, Dn(c.title || c.kind)), v = {
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek edit", k.body) || j("Edit request answered without a patch. Use Generate patch / Edit to request an applicable diff.");
    ...
    Le((c) => {
      if (!c) return c;
      const h = Ec(c, xe), v = h.commands.at(-1)?.command ?? "";
      return v && U(v), h;
    }), de("");
  }, [xe]), vs = w(() => {
    if (!W || !te.trim()) {
    ...
    const c = te.trim();
    Le((h) => h && qc(h, c, Ce, qe)), fe(""), j(`Captured manual check result: ${c} (${Ce})`);
  }, [qe, te, W, Ce]), ys = w(() => {
    W && Be(Yc(W));
  }, [Be, W]), gs = w(() => {
    if (!le) return;
    ...
    if (!le) return;
    const c = En(f, `${Dn(le.fileName)}-ai-edit`), h = {
  ...
  }, [J?.language, f, Se, le]), ks = w(() => {
    if (!Qe) return;
    const c = new Map(Qe.edits.map((v) => [v.fileId, v]));
    f.some((v) => {
      const k = c.get(v.id);
    ...
    if (!Qe) return;
    const c = [...f], h = Qe.edits.map((v) => {
      const k = En(c, `${Dn(v.fileName)}-ai-edit`), K = f.find((je) => je.id === v.fileId), Ne = {
  ...
  return pe(() => {
    const c = (h) => {
      (h.metaKey || h.ctrlKey) && (h.key.toLowerCase() === "o" && (h.preventDefault(), It()), h.key.toLowerCase() === "s" && (h.preventDefault(), Tn()), h.key.toLowerCase() === "w" && (h.preventDefault(), ie && zn(ie)), h.key.toLowerCase() === "b" && (h.preventDefault(), y((k) => !k)), h.shiftKey && h.key.toLowerCase() === "f" && (h.preventDefault(), p("search"), y(!0)), (h.key.toLowerCase() === "k" || h.key.toLowerCase() === "p") && (h.preventDefault(), He(!0)));
    };
    ...
    if (!r) return;
    const c = Fn(r);
    z((h) => tn(h, c.primaryMin, c.primaryMax)), G((h) => tn(h, c.secondaryMin, c.secondaryMax));
  }, [r]), pe(() => {
    const c = { primaryVisible: b, primaryWidth: N, secondaryVisible: Y, secondaryWidth: we, markdownPreviewVisible: T };
    localStorage.setItem(Dr, JSON.stringify(c));
  }, [T, b, N, Y, we]), pe(() => {
    if (!o.folder?.handleKey) return;
    let c = !1;
    return (async () => {
      try {
        const h = await Vn(o.folder?.handleKey ?? "");
        if (!h || !await Hn(h, "readwrite") || c) return;
        const v = await Sa(h);
        if (c) return;
        We(o.folder?.handleKey ?? null), Me(v), D((k) => sd(k, v.files)), ke((k) => k.filter((K) => v.files.some((Ne) => Ne.id === K) || f.some((Ne) => Ne.id === K))), j(`Restored ${v.name} (${v.files.length} text files indexed)`);
      } catch (h) {
    ...
    localStorage.setItem(qr, JSON.stringify(nt));
  }, [nt]), /* @__PURE__ */ u(
    "div",
    {
      ref: n,
      ...
      children: [
        ...
        b && /* @__PURE__ */ u("div", { className: "workbench-primary-region", children: [
          /* @__PURE__ */ a(
            Nl,
            {
              ...
              setStatus: j,
              hasFsAccess: vi(),
              attachSkillToChat: za,
              saveLocalJobOutput: Aa,
              activeFile: J,
              openMissionFiles: Pn
            }
          ),
          /* @__PURE__ */ a("div", { className: "workbench-primary-resizer", onPointerDown: as, title: t("shell.resizeExplorer") })
        ] }),
        /* @__PURE__ */ u("main", { className: "workbench-editor-area", children: [
          ...
          /* @__PURE__ */ u("section", { className: "workbench-editor-stack", children: [
            ...
            /* @__PURE__ */ a(Al, { file: J, folder: ze, showWelcome: xn }),
            ...
            /* @__PURE__ */ a("div", { className: "workbench-editor-content", children: J ? /* @__PURE__ */ u("div", { className: J.language === "markdown" && T ? "workbench-editor-split" : "workbench-editor-single", children: [
              /* @__PURE__ */ a("div", { className: "workbench-editor-pane", children: /* @__PURE__ */ a(zs, { fallback: /* @__PURE__ */ a("div", { className: "workbench-empty-pane", children: t("shell.loadingEditor") }), children: /* @__PURE__ */ a(
                pl,
                {
                  file: J,
                  revealLine: Ye,
              ...
              J.language === "markdown" && T && /* @__PURE__ */ a(Ml, { content: J.content })
            ] }) : Bt ? /* @__PURE__ */ a(
              ql,
              {
                host: e,
            ...
            ) : xn ? /* @__PURE__ */ a(Ol, { host: e, openFile: It, openFolder: Nn, newFile: An, recent: Wt, reopenRecent: Xn, setStatus: j, openControlTower: () => {
              p("computer"), y(!0);
            }, openChat: () => {
              R("chat"), B(!0);
            }, openEmbeddedDoc: rs, openMissionFiles: Pn }) : /* @__PURE__ */ u("div", { className: "workbench-no-editor", children: [
              /* @__PURE__ */ a(bn, { size: 34 }),
            ...
            M && /* @__PURE__ */ a(
              Vl,
              {
                ...
                copyManualCheckCommand: ps,
                addManualCheckCommand: bs,
                recordManualCheckResult: vs,
                askAgentFromManualChecks: ys,
                onClose: () => I(!1)
              }
            )
          ] })
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek answer", c.body),
            ...
            contextScope: X,
            setContextScope: Xe,
            contextAttachments: $r,
            removeContextAttachment: ts,
            revealContextAttachment: ss,
        ...
        Pe && /* @__PURE__ */ a(
          jl,
          {
            ...
            activeFile: J,
            commands: [
              { label: "File: New File", detail: "Create an untitled Markdown file", run: An },
              ...
              { label: "File: Close All Editors", detail: `${Ke.length} open editor${Ke.length === 1 ? "" : "s"}`, run: cs, disabled: Ke.length === 0 },
              ...
              { label: "Atomek: Open Settings", detail: "Open settings as an editor tab", run: Ut },
              ...
              { label: "Atomek: Create AI Synthesis", detail: J || Ke.length > 0 ? "Ask AIL to produce a saved Markdown artifact" : "Open a file first", run: Ln, disabled: !J && Ke.length === 0 },
              ...
              { label: "AI: Draft Editable Replacement", detail: J ? `Ask Cortex for a full-file replacement for ${J.path}` : "Open a file first", run: () => La("edit"), disabled: !J },
              ...
              { label: "AI: Save Active File as Artifact", detail: J ? "Persist active file in host.ai artifacts" : "Open a file first", run: hs, disabled: !J },
              { label: "AI: Capture Manual Check Output", detail: "Paste check output as an auditable local artifact; no shell execution", run: On },
              { label: "AI: Open Latest Artifact as File", detail: bt[0] ? `Create editable file from ${bt[0].title}` : "No outputs yet", run: () => bt[0] && Cn(bt[0]), disabled: bt.length === 0 }
            ],
            openWorkbenchFile: Se,
            onClose: () => He(!1)
          }
        ...
        /* @__PURE__ */ a(Gl, { status: dt, file: J ?? bl, cursor: S, fileCount: f.length, dirtyCount: Ve.length })
      ]
    }
  );
}
function Pl({ active: e, setActive: t, togglePrimary: n, openSettings: r, settingsActive: i }) {
  const s = et();
  return /* @__PURE__ */ u("aside", { className: "workbench-activity-bar", "aria-label": s("activity.aria"), children: [
    /* @__PURE__ */ a("button", { className: "workbench-activity-brand", title: s("activity.toggleSidebar"), "aria-label": s("activity.toggleSidebar"), onClick: n, children: /* @__PURE__ */ a(Wr, { size: 30, variant: "cream" }) }),
    /* @__PURE__ */ a(nn, { icon: /* @__PURE__ */ a(ia, { size: 25 }), label: s("activity.explorer"), active: e === "explorer", onClick: () => t("explorer") }),
    /* @__PURE__ */ a(nn, { icon: /* @__PURE__ */ a(nr, { size: 25 }), label: s("activity.search"), active: e === "search", onClick: () => t("search") }),
    /* @__PURE__ */ a(nn, { icon: /* @__PURE__ */ a(na, { size: 25 }), label: s("app.agentTeam"), active: e === "computer", onClick: () => t("computer") }),
    /* @__PURE__ */ a("div", { className: "workbench-activity-spacer" }),
    /* @__PURE__ */ a(nn, { icon: /* @__PURE__ */ a(di, { size: 23 }), label: s("app.settings"), active: i, onClick: r })
  ] });
}
function nn({ icon: e, label: t, active: n, onClick: r }) {
  return /* @__PURE__ */ a("button", { className: `workbench-activity-button ${n ? "active" : ""}`, title: t, "aria-label": t, onClick: r, children: e });
}
function Nl(e) {
  return e.activity === "search" ? /* @__PURE__ */ a(Sl, { files: e.files, query: e.query, setQuery: e.setQuery, openWorkbenchFile: e.openWorkbenchFile, activeFileId: e.activeFileId }) : e.activity === "computer" ? /* @__PURE__ */ a(Ur, { host: e.host, setStatus: e.setStatus, attachSkillToChat: e.attachSkillToChat, saveLocalJobOutput: e.saveLocalJobOutput, openMissionFiles: e.openMissionFiles, activeFile: e.activeFile, openEditors: e.openEditors }) : /* @__PURE__ */ a(Tl, { ...e });
}
function Tl(e) {
  const t = et(), n = !e.folder, r = ue(() => zl(e.files, e.folder?.name), [e.files, e.folder?.name]), [i, s] = P(() => /* @__PURE__ */ new Set()), [o, l] = P(!0);
  pe(() => {
    const p = Yr(r);
    s((b) => {
      const y = new Set(b);
  ...
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      n ? /* @__PURE__ */ u($e, { children: [
        ...
        e.openEditors.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: t("explorer.noOpenEditors") }) : e.openEditors.map((p) => /* @__PURE__ */ a(ga, { file: p, active: p.id === e.activeFileId, onOpen: () => e.openWorkbenchFile(p), label: p.name, detail: p.path }, p.id)),
        /* @__PURE__ */ u(
          "button",
          {
            type: "button",
        ...
        o ? r.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: t("explorer.noReadableFiles") }) : Jr(r, e.activeFileId, e.openWorkbenchFile, i, m, t) : null
      ] }),
      ...
      e.recent.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: t("explorer.noRecentFolders") }) : e.recent.map((p) => /* @__PURE__ */ u("button", { className: "workbench-tree-row", onClick: () => {
        ...
        p.kind === "file" ? /* @__PURE__ */ a(ra, { size: 14 }) : /* @__PURE__ */ a(tr, { size: 14 }),
        /* @__PURE__ */ a("span", { className: "workbench-row-name", children: p.name })
      ] }, `${p.path}-${p.at}`))
    ] })
  ] });
}
function ga({ file: e, active: t, onOpen: n, basePath: r, depth: i = 0, label: s, detail: o }) {
...
function Yr(e) {
  return e.flatMap((t) => t.file ? [] : [t.path, ...Yr(t.children)]);
}
function Jr(e, t, n, r, i, s, o = 0) {
  return e.map((l) => {
    if (l.file)
      return /* @__PURE__ */ a(ga, { file: l.file, active: l.file.id === t, onOpen: () => n(l.file), depth: o, label: l.name }, l.file.id);
    ...
    return /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ u("button", { className: "workbench-folder-row", style: { "--workbench-depth": o }, onClick: () => i(l.path), title: s(m ? "explorer.collapseFolder" : "explorer.expandFolder", { name: l.name }), children: [
        ...
        m ? /* @__PURE__ */ a(oa, { size: 14 }) : /* @__PURE__ */ a(tr, { size: 14 }),
      ...
      m ? Jr(l.children, t, n, r, i, s, o + 1) : null
    ] }, l.path);
  });
}
function Al({ file: e, folder: t, showWelcome: n }) {
  const r = et(), i = n ? [r("app.agentTeam")] : e?.path.split("/").filter(Boolean) ?? [], s = t && i[0] === t.name ? i.slice(1) : i;
...
function Ll(e) {
  ...
  return /* @__PURE__ */ u("div", { className: "workbench-tabs", children: [
    ...
    e.canPreview && /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.previewVisible ? "active" : ""}`, title: t("tabs.toggleMarkdownPreview"), onClick: e.togglePreview, children: /* @__PURE__ */ a(aa, { size: 16 }) }),
    /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.secondaryVisible ? "active" : ""}`, title: t("tabs.toggleChat"), onClick: e.toggleSecondary, children: /* @__PURE__ */ a(ri, { size: 16 }) })
  ] });
}
function Xl(e) {
...
function Ol({
  ...
  const ke = w(async () => {
    ...
    const g = R.trim() || "Coordinate a Tytus mission.", X = Wi(z, g), Xe = kt(g, I, We);
    Te(!0);
    try {
...
`]
      ...
      await e.missions.write({
        rootPath: E.rootPath,
        files: Ee
      }), ze(E), qt(Ge), b(Ge, Ee), o(`Mission created: ${E.rootPath}`), l();
    } catch (E) {
  ...
  }, [G, B, N]), L = Xl(I), O = Ti(I), q = zi(I), S = Cl(I), $ = I?.warnings ?? [], ce = Li(I), ge = Mt(I, kt(R, I, We)), be = vn(R, I, ge.id);
  return /* @__PURE__ */ u("div", { className: "workbench-welcome workbench-control-home", children: [
    /* @__PURE__ */ u("section", { className: "workbench-control-hero-main", children: [
      /* @__PURE__ */ u("div", { className: "workbench-brand-lockup", "aria-label": "Atomek", children: [
        /* @__PURE__ */ a(Wr, { size: 74, variant: "acid" }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a(al, { className: "workbench-brand-wordmark" }),
    ...
    /* @__PURE__ */ u("section", { className: "workbench-control-grid", children: [
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-doc-grid", children: hl.map((g) => /* @__PURE__ */ u("button", { className: "workbench-doc-card", onClick: () => p(g), title: g.summary, children: [
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-fabric-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(en.sharedFiles, "Shared Files"), children: "Open shared files" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(en.podInspector, "Pod Inspector"), children: "Open pods" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(en.channels, "Channels"), children: "Open channels" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(en.settings, "Agent Settings"), children: "Open agent settings" })
        ] })
      ] }),
...
function Sl({ files: e, query: t, setQuery: n, openWorkbenchFile: r, activeFileId: i }) {
  const s = et(), o = ue(() => Hl(e, t), [e, t]), l = ue(() => {
    ...
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      ...
      t.trim() ? l.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: s("search.noMatches") }) : l.map((m) => {
        ...
        return /* @__PURE__ */ u("div", { className: "workbench-search-group", children: [
          /* @__PURE__ */ a(ga, { file: p, active: p.id === i, onOpen: () => r(p) }),
...
function jl(e) {
  const t = e.query.trim().toLowerCase(), n = e.files.slice(0, 80).map((i) => ({
    label: i.path,
    detail: `Open ${sr(i.language)} file`,
...
function Wl(e) {
  const t = e.session ? Jc(e.session) : "pending";
  return /* @__PURE__ */ u("div", { className: "workbench-manual-check-panel", children: [
    ...
    e.session ? /* @__PURE__ */ u($e, { children: [
...
function Vl(e) {
  return /* @__PURE__ */ u("section", { className: "workbench-bottom-panel", "aria-label": "Panel", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-bottom-body", children: [
      ...
      e.tab === "output" && /* @__PURE__ */ a(Br, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, compact: !0 })
    ] })
  ] });
}
function Il(e) {
  const t = et(), [n, r] = P(!1), [i, s] = P(""), [o, l] = P([]), m = Re(null), p = Re(null), b = Re(null), [y, N] = P({ top: 0, right: 0 }), z = ue(
    () => e.chatThreads.map((T) => ({
      kind: "atomek-thread",
      id: `thread:${T.id}`,
      title: T.title,
    ...
    window.confirm(`Delete conversation "${T.title}"?`) && (T.kind === "atomek-thread" ? e.deleteThread(T.thread.id) : (uo(T.targetId), I()));
  }, [e, I]);
  return pe(() => {
    if (!n) {
      s("");
    ...
    /* @__PURE__ */ u("div", { className: "workbench-secondary-tabs", children: [
      ...
      /* @__PURE__ */ u("div", { className: "workbench-secondary-actions", children: [
        /* @__PURE__ */ a("button", { title: t("secondary.newChat"), onClick: e.newChat, children: /* @__PURE__ */ a(Jn, { size: 15 }) }),
        /* @__PURE__ */ a(
          "button",
          {
            ref: m,
            ...
            children: /* @__PURE__ */ a(_a, { size: 15 })
          }
        ),
        /* @__PURE__ */ a("button", { title: t("secondary.chatSettings"), onClick: e.openSettings, children: /* @__PURE__ */ a(er, { size: 16 }) }),
        /* @__PURE__ */ a("button", { title: t("secondary.closeChat"), onClick: e.onClose, children: /* @__PURE__ */ a(at, { size: 15 }) })
      ] })
    ] }),
    n && typeof document < "u" ? As(
      /* @__PURE__ */ u(
        "div",
        {
          ref: p,
          ...
          children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-history-portal-list", children: [
                ...
                /* @__PURE__ */ u(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ a("small", { children: ta(Y.lastActivityAt) }),
                      /* @__PURE__ */ a(
                        "button",
                        {
                          ...
                          children: /* @__PURE__ */ a(Oa, { size: 13 })
                        }
                      )
                    ]
                  }
              ...
              M.length > 0 ? /* @__PURE__ */ u($e, { children: [
                ...
                M.map((T) => /* @__PURE__ */ u(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ a("small", { children: ta(T.lastActivityAt) }),
                      /* @__PURE__ */ a(
                        "button",
                        {
                          className: "workbench-history-portal-delete",
    ...
    e.tab === "chat" ? /* @__PURE__ */ a(Fl, { ...e }) : e.tab === "agents" ? /* @__PURE__ */ a(
      Ur,
      {
        host: e.host,
    ...
    ) : /* @__PURE__ */ a(Br, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, previewEditFromOutput: e.previewEditFromOutput, canPreviewEdit: e.canPreviewEdit })
  ] });
}
function Zr({ body: e }) {
  const t = ue(() => kl(e), [e]), [n, r] = P(null), i = w((s, o) => {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-rich-body", children: t.map((s) => {
      ...
      return /* @__PURE__ */ u("div", { className: "workbench-rich-code", children: [
        /* @__PURE__ */ u("div", { className: "workbench-rich-code-head", children: [
          ...
          /* @__PURE__ */ u("button", { onClick: () => i(s.key, s.body), title: "Copy code block", children: [
            o ? /* @__PURE__ */ a(Fs, { size: 12 }) : /* @__PURE__ */ a(Yn, { size: 12 }),
            o ? "Copied" : "Copy"
          ] })
        ] }),
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: cr(s.body) }
      },
      s.key
    );
  }) });
...
function Fl(e) {
  const t = et(), n = e.selectedChatTarget.available, r = e.selectedChatTarget.kind === "atomek-ai", i = e.chatInput.trim().length > 0 && !e.busy && n, s = Re(null), [o, l] = P(!0), [m, p] = P(!1), b = Re(null), y = Re(null), N = Re(null), z = Re(null), [V, R] = P(!1), [Y, B] = P(0), we = typeof window < "u" && !!(window.SpeechRecognition || window.webkitSpeechRecognition), G = w(() => {
    const f = N.current;
    try {
      f?.stop?.();
    } catch {
  ...
  return /* @__PURE__ */ u("div", { className: "workbench-chat-wrap", children: [
      ...
      /* @__PURE__ */ u("span", { className: "workbench-chat-thread-actions", children: [
        /* @__PURE__ */ a(
          "button",
          {
            ...
            children: /* @__PURE__ */ a(Jn, { size: 15 })
          }
        ),
        r && e.chatThreads.length > 0 ? /* @__PURE__ */ u("details", { ref: De, className: "workbench-chat-iconmenu", children: [
          /* @__PURE__ */ a("summary", { className: "workbench-chat-iconbtn", title: t("chat.history"), "aria-label": t("chat.history"), children: /* @__PURE__ */ a(_a, { size: 15 }) }),
            ...
            e.chatThreads.map((f) => /* @__PURE__ */ u(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ a("small", { children: ta(f.lastMessageAt ?? f.updatedAt) })
                ]
              },
              f.id
            ))
        ...
        r ? /* @__PURE__ */ u("details", { className: "workbench-chat-iconmenu", children: [
          /* @__PURE__ */ a("summary", { className: "workbench-chat-iconbtn", title: t("chat.actions"), "aria-label": t("chat.actions"), children: /* @__PURE__ */ a(er, { size: 15 }) }),
    ...
    /* @__PURE__ */ u("div", { ref: s, className: "workbench-chat-transcript", onScroll: ne, children: [
      e.chatMessages.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-chat-empty", children: /* @__PURE__ */ u("div", { children: [
        ...
        /* @__PURE__ */ a("br", {}),
        /* @__PURE__ */ a(Zr, { body: f.body }),
        f.gatewayLabel ? /* @__PURE__ */ u($e, { children: [
          /* @__PURE__ */ a("br", {}),
        ...
        f.role === "assistant" && f.status !== "streaming" && f.status !== "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Me(f), title: t("chat.copyAnswer"), "aria-label": t("chat.copyAnswer"), children: /* @__PURE__ */ a(Yn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.saveMessageAsArtifact(f), title: t("chat.saveArtifact"), "aria-label": t("chat.saveArtifact"), children: /* @__PURE__ */ a(sa, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.rememberMessage(f), title: "Store in Atomek memory", "aria-label": t("chat.remember"), children: /* @__PURE__ */ a($s, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.previewEditFromMessage(f), disabled: e.workspaceFileCount === 0, title: t("chat.previewPatch"), "aria-label": t("chat.previewPatch"), children: /* @__PURE__ */ a(aa, { size: 14 }) }),
        ...
        f.role === "assistant" && f.status === "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Me(f), title: t("chat.copyError"), "aria-label": t("chat.copyError"), children: /* @__PURE__ */ a(Yn, { size: 14 }) }),
    ...
    /* @__PURE__ */ u("div", { className: "workbench-chat-composer", children: [
      /* @__PURE__ */ u("div", { className: "workbench-chat-tip", children: [
        ...
        /* @__PURE__ */ a("em", { children: e.selectedChatTarget.kind === "atomek-ai" ? Ba(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description })
      ] }),
      /* @__PURE__ */ u("div", { className: "workbench-chat-box", children: [
        /* @__PURE__ */ u("div", { className: "workbench-chat-attachments", children: [
          ...
          e.contextScope === "indexed-project" ? /* @__PURE__ */ u($e, { children: [
          ...
          e.contextAttachments.length === 0 ? /* @__PURE__ */ u("span", { className: "workbench-chat-chip muted", children: [
            ...
            return /* @__PURE__ */ u("span", { className: "workbench-chat-chip", title: ie, children: [
              /* @__PURE__ */ a("button", { className: "workbench-chat-chip-open", onClick: () => e.revealContextAttachment(f), disabled: !f.fileId, title: t("chat.revealContext"), children: /* @__PURE__ */ a(Ca, { size: 13 }) }),
              f.label,
        ...
        /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar atomek-input", children: [
          /* @__PURE__ */ u("details", { ref: b, className: "workbench-chat-attach", children: [
            /* @__PURE__ */ a("summary", { title: t("chat.addContext"), "aria-label": t("chat.addContext"), children: /* @__PURE__ */ a(Jn, { size: 16 }) }),
          ...
          ] }) : /* @__PURE__ */ a("span", { className: "workbench-chat-route-summary", children: e.selectedChatTarget.kind === "atomek-ai" ? Ba(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
          /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar-right", children: [
            V ? null : /* @__PURE__ */ a(
              "button",
              {
                ...
                children: /* @__PURE__ */ a(ni, { size: 16 })
              }
            ),
            ...
            e.busy ? /* @__PURE__ */ a("button", { className: "workbench-chat-send stop", onClick: e.stopChat, title: t("chat.stop"), "aria-label": t("chat.stop"), children: /* @__PURE__ */ a(rr, { size: 14 }) }) : /* @__PURE__ */ a("button", { className: `workbench-chat-send ${i ? "ready" : ""}`, onClick: e.askAgent, title: t("chat.send"), disabled: !i, "aria-label": t("chat.sendMessage"), children: /* @__PURE__ */ a(js, { size: 18 }) })
          ] })
        ] })
      ] })
    ] })
...
function Ba(e, t, n) {
  e.model;
  const i = [e.gatewayPreference === "auto" ? t : Kr(e.gatewayPreference)];
...
function El({ host: e, appName: t, currentVersion: n }) {
...
function ql(e) {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-settings-tab", children: /* @__PURE__ */ u("section", { className: "workbench-settings-page", "aria-label": "Atomek Settings", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-settings-body", children: [
      /* @__PURE__ */ a(El, { host: e.host, appName: "Atomek", currentVersion: Ka }),
      /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-settings-note", children: [
          "Current request: ",
          Kr(e.chatSettings.gatewayPreference),
    ...
    /* @__PURE__ */ u("footer", { className: "workbench-settings-footer", children: [
      /* @__PURE__ */ a("button", { onClick: () => e.onChange(hn), children: "Reset" }),
      /* @__PURE__ */ a("button", { onClick: e.onClose, children: "Close tab" })
    ] })
  ] }) });
}
function Br({ outputs: e, clearOutputs: t, deleteArtifact: n, runAiSynthesis: r, captureManualCheck: i, openOutputAsFile: s, previewEditFromOutput: o, canPreviewEdit: l = !1, compact: m = !1 }) {
  const p = et();
    ...
    e.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No outputs yet. Save an AI answer as an artifact or create an AI synthesis." }) : e.map((b) => /* @__PURE__ */ u("div", { className: "workbench-output-card", children: [
      /* @__PURE__ */ u("div", { className: "workbench-output-head", children: [
        ...
        o ? /* @__PURE__ */ a(
          "button",
          {
            className: Ua(b.body) ? "workbench-output-edit-cta" : void 0,
            onClick: () => o(b),
            disabled: !l,
            children: Ua(b.body) ? "Preview/apply edit" : "Preview edit"
          }
        ) : null,
        b.source === "ai" ? /* @__PURE__ */ a("button", { onClick: () => n(b.id), children: p("chat.delete") }) : null
      ] }),
      /* @__PURE__ */ a(Zr, { body: b.body })
    ] }, b.id))
  ] });
}
function Yl({ edit: e, onApply: t, onOpenAsFile: n, onClose: r }) {
...
function Jl({ patch: e, onApply: t, onOpenAsFiles: n, onClose: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI workspace patch", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review workspace", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-workspace-patch-list", children: [
      e.edits.map((s) => /* @__PURE__ */ u("article", { className: "workbench-workspace-patch-card", children: [
        ...
        /* @__PURE__ */ a("pre", { children: $l(s.proposedContent) })
      ] }, s.fileId)),
...
function Kl(e, t) {
  ...
  if (e)
    n.push("", `Active file: ${e.path}`, `Language: ${e.language}`, `Dirty: ${e.dirty ? "yes" : "no"}`, "", "Active file content:", "```" + e.language, Zl(e.content), "```");
  else if (t.length > 0) {
...
function Ur({
  ...
  const m = et(), [p, b] = P([]), [y, N] = P([]), [z, V] = P(null), [R, Y] = P(!1), [B, we] = P(null), [G, M] = P("Review the active Atomek context. Return concise findings. If you propose edits, output a unified diff or fenced replacement blocks so Atomek can preview before applying."), [I, he] = P(null), [se, T] = P([]), [x, Te] = P(() => Ii()), [ne, ze] = P([]), [Me, De] = P([]), [We, f] = P([]), [D, Q] = P([]), ke = Re([]), [ie, L] = P("task-execute"), [O, q] = P("mission"), S = se.find((d) => d.status === "running" || d.status === "canceling") ?? se[0] ?? null, $ = se.some((d) => d.status === "running" || d.status === "canceling"), ce = l === "dock", ge = x?.goal || G || "", be = ue(() => Mt(z, kt(ge, z, x?.teamPresetId)), [x?.teamPresetId, ge, z]), g = ue(() => vn(ge, z, be.id), [ge, be.id, z]), X = g.find((d) => d.id === ie) ?? g[1] ?? g[0] ?? null, Xe = ue(() => X ? be.assignments.find((d) => d.role === X.role) ?? be.assignments.find((d) => d.role === "implementer") ?? be.assignments[0] ?? null : null, [be.assignments, X]), E = ue(() => !Xe || !z ? null : z.resources.find((d) => d.id === Xe.resourceId) ?? null, [z, Xe]), Ge = ue(() => new Map(D.map((d) => [d.path, d])), [D]), tt = w((d) => {
    if (!x) {
  ...
  }, [x, Ge, i, t]), Ee = o.filter((d) => d.dirty).length, _ = s ? `${s.path} · ${s.language} · ${s.content.length.toLocaleString()} chars${s.dirty ? " · dirty" : ""}` : o.length > 0 ? `${o.length} open editor${o.length === 1 ? "" : "s"}${Ee ? ` · ${Ee} dirty` : ""}` : "No active file — jobs run with only your typed prompt.", ae = ue(() => [
    {
  ...
  const re = w(async (d = x) => {
    ...
    if (!d) return;
    const H = [...A].sort((F, ee) => Ha(ee).localeCompare(Ha(F))).slice(0, 100), C = H.map((F) => JSON.stringify(F)).join(`
`) + (H.length ? `
` : "");
    d.rootPath && e.missions?.write ? await e.missions.write({ rootPath: d.rootPath, files: [{ path: "RUNS.jsonl", content: C }] }) : d.handle && await Zn(d.handle, "RUNS.jsonl", C), f(H), ke.current = H;
  ...
  pe(() => {
    ...
    return window.addEventListener(Gn, d), () => window.removeEventListener(Gn, d);
  }, [He, re]);
  const it = w((d) => {
    const A = Fi(d);
    Te(A), Q([]), qt(A), re(A), De([{
    ...
    ], ee = kt(A || d.goal, z, d.teamPresetId), W = mr(d, z, s, o, A, ee, [
...
` : "") } : de), Le = new Set(o.filter((de) => de.source === "mission" && de.dirty && de.mission?.missionId === d.missionId).map((de) => de.mission?.relPath).filter(Boolean)), xe = W.filter((de) => !Le.has(de.path));
    if (d.rootPath && e.missions?.write)
      ...
      for (const de of xe) await lr(d.handle, de.path, de.content);
    } else
    ...
    if (e.missions?.create) {
      ...
      F = {
        handle: W,
        name: W.name,
        missionId: `mission-${Date.now()}-${Vi(W.name)}`,
        title: H,
        goal: C,
        source: "browser"
      };
  ...
  }, [e.missions, G, x, Z]), Qe = w(async (d, A) => {
...
`);
      ...
      for await (const Oe of e.daemon.chatAgent({
        ...
        if (Oe.type === "profile" && te(`[Atomek] ${Oe.profile === "local" ? "Local Cortex" : "Cloud Cortex"} route selected.`), Oe.type === "session" && te("[Atomek] Pod-agent session established."), Oe.type === "token" && (Ze || (te("[Atomek] Pod agent is responding…"), Ze = !0), Ce = gn(`${Ce}${Oe.text}`)), Oe.type === "error") {
          const dt = Qn(Oe.message);
...
`);
  ...
  }, [s, ve, e.daemon, G, o, z, r, Je, X, t, Pe, Z]), Kt = w(async (d) => {
...
`);
  ...
  }, [n, $, x, Ae, Qe, ot, Xe, E, X, t, nt, y, p, pt, Z]);
  return /* @__PURE__ */ u("aside", { className: ce ? "workbench-agent-dock" : "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ u("div", { className: ce ? "workbench-agent-dock-scroll" : "workbench-sidebar-scroll", children: [
      ...
      O === "mission" ? /* @__PURE__ */ u($e, { children: [
        ...
        ne.length ? /* @__PURE__ */ u($e, { children: [
...
`) || "[waiting for output]" })
        ...
        We.length ? /* @__PURE__ */ u($e, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-list compact", children: [
          ...
          z?.resources.slice(0, ce ? 8 : 5).map((d) => /* @__PURE__ */ u("div", { className: "workbench-resource-row", children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-resource-row-actions", children: [
              ...
              d.kind === "pod-agent" && Kn(d) ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                ot(d);
              }, children: "Ask pod" }) : null,
              d.status === "needs-setup" || d.setupAction ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => nt(d), children: "Setup" }) : null
            ] })
          ] }, d.id))
        ] }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-list", children: [
          ...
          p.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
                Ae(d);
              }, disabled: d.status !== "available", title: "Launch this tool in a fresh Tytus Terminal with mission context and execute it immediately.", children: Bl(d) }),
              d.kind === "ai-cli" ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                Qe(d);
              }, disabled: d.status !== "available" || I !== null, title: "Run this local agent as a background read-only review inside Atomek and stream output here. It cannot write files directly.", children: Ul(d, I) }) : null
            ] })
          ] }, d.id))
        ] }),
...
function Gl({ status: e, file: t, cursor: n, fileCount: r, dirtyCount: i }) {
  const s = et(), o = e === "Ready" ? s("app.ready") : e;
  return /* @__PURE__ */ u("footer", { className: "workbench-statusbar", children: [
    ...
    /* @__PURE__ */ a("span", { children: sr(t.language) })
  ] });
}
function Rn(e, t) {
...
function od() {
  try {
    ...
    const t = JSON.parse(e);
    return {
      gatewayPreference: t.gatewayPreference === "remote" || t.gatewayPreference === "local" || t.gatewayPreference === "auto" ? t.gatewayPreference : hn.gatewayPreference,
...
function cd({ host: e }) {
  return /* @__PURE__ */ a(il, { host: e, children: /* @__PURE__ */ a(xl, { host: e }) });
}
function hd(e) {
  return function() {
    return /* @__PURE__ */ a(cd, { host: e.host });
  };
}
export {
  hd as default
